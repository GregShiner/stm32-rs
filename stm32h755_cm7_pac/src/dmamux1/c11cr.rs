...
pub type R = crate::R<C11crSpec>;
#[doc = "Register `C11CR` writer"]
pub type W = crate::W<C11crSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Input DMA request line selected"]
    #[inline(always)]
    pub fn dmareq_id(&mut self) -> DmareqIdW<C11crSpec> {
        DmareqIdW::new(self, 0)
    }
    #[doc = "Bit 8 - Interrupt enable at synchronization event overrun"]
    #[inline(always)]
    pub fn soie(&mut self) -> SoieW<C11crSpec> {
        SoieW::new(self, 8)
    }
    #[doc = "Bit 9 - Event generation enable/disable"]
    #[inline(always)]
    pub fn ege(&mut self) -> EgeW<C11crSpec> {
        EgeW::new(self, 9)
    }
    #[doc = "Bit 16 - Synchronous operating mode enable/disable"]
    #[inline(always)]
    pub fn se(&mut self) -> SeW<C11crSpec> {
        SeW::new(self, 16)
    }
    #[doc = "Bits 17:18 - Synchronization event type selector Defines the synchronization event on the selected synchronization input:"]
    #[inline(always)]
    pub fn spol(&mut self) -> SpolW<C11crSpec> {
        SpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests to forward Defines the number of DMA requests forwarded before output event is generated. In synchronous mode, it also defines the number of DMA requests to forward after a synchronization event, then stop forwarding. The actual number of DMA requests forwarded is NBREQ+1. Note: This field can only be written when both SE and EGE bits are reset."]
    #[inline(always)]
    pub fn nbreq(&mut self) -> NbreqW<C11crSpec> {
        NbreqW::new(self, 19)
    }
    #[doc = "Bits 24:28 - Synchronization input selected"]
    #[inline(always)]
    pub fn sync_id(&mut self) -> SyncIdW<C11crSpec> {
        SyncIdW::new(self, 24)
    }
}
#[doc = "DMAMux - DMA request line multiplexer channel x control register\n\nYou can [`read`](crate::Reg::read) this register and get [`c11cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c11cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C11crSpec;
impl crate::RegisterSpec for C11crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c11cr::R`](R) reader structure"]
impl crate::Readable for C11crSpec {}
#[doc = "`write(|w| ..)` method takes [`c11cr::W`](W) writer structure"]
impl crate::Writable for C11crSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C11CR to value 0"]
impl crate::Resettable for C11crSpec {}

...
pub type R = crate::R<Eefdr2Spec>;
#[doc = "Register `EEFDR2` writer"]
pub type W = crate::W<Eefdr2Spec>;
...
impl W {
    #[doc = "Bit 0 - External Event 6 latch"]
    #[inline(always)]
    pub fn ee6ltch(&mut self) -> Ee6ltchW<Eefdr2Spec> {
        Ee6ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 6 filter"]
    #[inline(always)]
    pub fn ee6fltr(&mut self) -> Ee6fltrW<Eefdr2Spec> {
        Ee6fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 7 latch"]
    #[inline(always)]
    pub fn ee7ltch(&mut self) -> Ee7ltchW<Eefdr2Spec> {
        Ee7ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 7 filter"]
    #[inline(always)]
    pub fn ee7fltr(&mut self) -> Ee7fltrW<Eefdr2Spec> {
        Ee7fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 8 latch"]
    #[inline(always)]
    pub fn ee8ltch(&mut self) -> Ee8ltchW<Eefdr2Spec> {
        Ee8ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 8 filter"]
    #[inline(always)]
    pub fn ee8fltr(&mut self) -> Ee8fltrW<Eefdr2Spec> {
        Ee8fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 9 latch"]
    #[inline(always)]
    pub fn ee9ltch(&mut self) -> Ee9ltchW<Eefdr2Spec> {
        Ee9ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 9 filter"]
    #[inline(always)]
    pub fn ee9fltr(&mut self) -> Ee9fltrW<Eefdr2Spec> {
        Ee9fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 10 latch"]
    #[inline(always)]
    pub fn ee10ltch(&mut self) -> Ee10ltchW<Eefdr2Spec> {
        Ee10ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 10 filter"]
    #[inline(always)]
    pub fn ee10fltr(&mut self) -> Ee10fltrW<Eefdr2Spec> {
        Ee10fltrW::new(self, 25)
    }
}
#[doc = "Timerx External Event Filtering Register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`eefdr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eefdr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eefdr2Spec;
impl crate::RegisterSpec for Eefdr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eefdr2::R`](R) reader structure"]
impl crate::Readable for Eefdr2Spec {}
#[doc = "`write(|w| ..)` method takes [`eefdr2::W`](W) writer structure"]
impl crate::Writable for Eefdr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EEFDR2 to value 0"]
impl crate::Resettable for Eefdr2Spec {}

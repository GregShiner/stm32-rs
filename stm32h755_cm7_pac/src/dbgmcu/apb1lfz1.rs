...
pub type R = crate::R<Apb1lfz1Spec>;
#[doc = "Register `APB1LFZ1` writer"]
pub type W = crate::W<Apb1lfz1Spec>;
...
impl W {
    #[doc = "Bit 0 - TIM2 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim2(&mut self) -> DbgTim2W<Apb1lfz1Spec> {
        DbgTim2W::new(self, 0)
    }
    #[doc = "Bit 1 - TIM3 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim3(&mut self) -> DbgTim3W<Apb1lfz1Spec> {
        DbgTim3W::new(self, 1)
    }
    #[doc = "Bit 2 - TIM4 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim4(&mut self) -> DbgTim4W<Apb1lfz1Spec> {
        DbgTim4W::new(self, 2)
    }
    #[doc = "Bit 3 - TIM5 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim5(&mut self) -> DbgTim5W<Apb1lfz1Spec> {
        DbgTim5W::new(self, 3)
    }
    #[doc = "Bit 4 - TIM6 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim6(&mut self) -> DbgTim6W<Apb1lfz1Spec> {
        DbgTim6W::new(self, 4)
    }
    #[doc = "Bit 5 - TIM7 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim7(&mut self) -> DbgTim7W<Apb1lfz1Spec> {
        DbgTim7W::new(self, 5)
    }
    #[doc = "Bit 6 - TIM12 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim12(&mut self) -> DbgTim12W<Apb1lfz1Spec> {
        DbgTim12W::new(self, 6)
    }
    #[doc = "Bit 7 - TIM13 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim13(&mut self) -> DbgTim13W<Apb1lfz1Spec> {
        DbgTim13W::new(self, 7)
    }
    #[doc = "Bit 8 - TIM14 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim14(&mut self) -> DbgTim14W<Apb1lfz1Spec> {
        DbgTim14W::new(self, 8)
    }
    #[doc = "Bit 9 - LPTIM1 stop in debug"]
    #[inline(always)]
    pub fn dbg_lptim1(&mut self) -> DbgLptim1W<Apb1lfz1Spec> {
        DbgLptim1W::new(self, 9)
    }
    #[doc = "Bit 11 - WWDG2 stop in debug"]
    #[inline(always)]
    pub fn dbg_wwdg2(&mut self) -> DbgWwdg2W<Apb1lfz1Spec> {
        DbgWwdg2W::new(self, 11)
    }
    #[doc = "Bit 21 - I2C1 SMBUS timeout stop in debug"]
    #[inline(always)]
    pub fn dbg_i2c1(&mut self) -> DbgI2c1W<Apb1lfz1Spec> {
        DbgI2c1W::new(self, 21)
    }
    #[doc = "Bit 22 - I2C2 SMBUS timeout stop in debug"]
    #[inline(always)]
    pub fn dbg_i2c2(&mut self) -> DbgI2c2W<Apb1lfz1Spec> {
        DbgI2c2W::new(self, 22)
    }
    #[doc = "Bit 23 - I2C3 SMBUS timeout stop in debug"]
    #[inline(always)]
    pub fn dbg_i2c3(&mut self) -> DbgI2c3W<Apb1lfz1Spec> {
...
pub struct Apb1lfz1Spec;
impl crate::RegisterSpec for Apb1lfz1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb1lfz1::R`](R) reader structure"]
impl crate::Readable for Apb1lfz1Spec {}
#[doc = "`write(|w| ..)` method takes [`apb1lfz1::W`](W) writer structure"]
impl crate::Writable for Apb1lfz1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB1LFZ1 to value 0"]
impl crate::Resettable for Apb1lfz1Spec {}

...
pub type R = crate::R<Apb4fz2Spec>;
#[doc = "Register `APB4FZ2` writer"]
pub type W = crate::W<Apb4fz2Spec>;
...
impl W {
    #[doc = "Bit 7 - I2C4 SMBUS timeout stop in debug"]
    #[inline(always)]
    pub fn dbg_i2c4(&mut self) -> DbgI2c4W<Apb4fz2Spec> {
        DbgI2c4W::new(self, 7)
    }
    #[doc = "Bit 9 - LPTIM2 stop in debug"]
    #[inline(always)]
    pub fn dbg_lptim2(&mut self) -> DbgLptim2W<Apb4fz2Spec> {
        DbgLptim2W::new(self, 9)
    }
    #[doc = "Bit 10 - LPTIM2 stop in debug"]
    #[inline(always)]
    pub fn dbg_lptim3(&mut self) -> DbgLptim3W<Apb4fz2Spec> {
        DbgLptim3W::new(self, 10)
    }
    #[doc = "Bit 11 - LPTIM4 stop in debug"]
    #[inline(always)]
    pub fn dbg_lptim4(&mut self) -> DbgLptim4W<Apb4fz2Spec> {
        DbgLptim4W::new(self, 11)
    }
    #[doc = "Bit 12 - LPTIM5 stop in debug"]
    #[inline(always)]
    pub fn dbg_lptim5(&mut self) -> DbgLptim5W<Apb4fz2Spec> {
        DbgLptim5W::new(self, 12)
    }
    #[doc = "Bit 16 - RTC stop in debug"]
    #[inline(always)]
    pub fn dbg_rtc(&mut self) -> DbgRtcW<Apb4fz2Spec> {
        DbgRtcW::new(self, 16)
    }
    #[doc = "Bit 18 - LS watchdog for D1 stop in debug"]
    #[inline(always)]
    pub fn dbg_wdglsd1(&mut self) -> DbgWdglsd1W<Apb4fz2Spec> {
        DbgWdglsd1W::new(self, 18)
    }
    #[doc = "Bit 19 - LS watchdog for D2 stop in debug"]
    #[inline(always)]
    pub fn dbg_wdglsd2(&mut self) -> DbgWdglsd2W<Apb4fz2Spec> {
        DbgWdglsd2W::new(self, 19)
    }
}
#[doc = "DBGMCU APB4 peripheral freeze register CPU2\n\nYou can [`read`](crate::Reg::read) this register and get [`apb4fz2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb4fz2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Apb4fz2Spec;
impl crate::RegisterSpec for Apb4fz2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb4fz2::R`](R) reader structure"]
impl crate::Readable for Apb4fz2Spec {}
#[doc = "`write(|w| ..)` method takes [`apb4fz2::W`](W) writer structure"]
impl crate::Writable for Apb4fz2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB4FZ2 to value 0"]
impl crate::Resettable for Apb4fz2Spec {}

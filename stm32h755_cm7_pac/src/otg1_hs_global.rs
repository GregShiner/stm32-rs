...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn otg_hs_grxstsr_device(&self) -> &OtgHsGrxstsrDevice {
    ...
    #[inline(always)]
    pub const fn otg_hs_grxstsp_device(&self) -> &OtgHsGrxstspDevice {
    ...
    #[inline(always)]
    pub const fn otg_hs_dieptxf0_device(&self) -> &OtgHsDieptxf0Device {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(40).cast() }
    }
    #[doc = "0x28 - OTG_HS nonperiodic transmit FIFO size register (host mode)"]
    #[inline(always)]
    pub const fn otg_hs_hnptxfsiz_host(&self) -> &OtgHsHnptxfsizHost {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(40).cast() }
    }
    ...
    #[inline(always)]
    pub const fn otg_hs_glpmcfg(&self) -> &OtgHsGlpmcfg {
        &self.otg_hs_glpmcfg
    }
    ...
    #[doc = "0x120 - "]
    #[inline(always)]
    pub const fn otg_dieptxf8(&self) -> &OtgDieptxf8 {
        &self.otg_dieptxf8
    }
}
...
#[doc = "OTG_HS_HNPTXFSIZ_Host (rw) register accessor: OTG_HS nonperiodic transmit FIFO size register (host mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hnptxfsiz_host::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hnptxfsiz_host::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_hs_hnptxfsiz_host`] module"]
#[doc(alias = "OTG_HS_HNPTXFSIZ_Host")]
pub type OtgHsHnptxfsizHost = crate::Reg<otg_hs_hnptxfsiz_host::OtgHsHnptxfsizHostSpec>;
#[doc = "OTG_HS nonperiodic transmit FIFO size register (host mode)"]
pub mod otg_hs_hnptxfsiz_host;
#[doc = "OTG_HS_DIEPTXF0_Device (rw) register accessor: Endpoint 0 transmit FIFO size (peripheral mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_dieptxf0_device::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_dieptxf0_device::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_hs_dieptxf0_device`] module"]
#[doc(alias = "OTG_HS_DIEPTXF0_Device")]
pub type OtgHsDieptxf0Device = crate::Reg<otg_hs_dieptxf0_device::OtgHsDieptxf0DeviceSpec>;
...
#[doc = "OTG_DIEPTXF8 (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`otg_dieptxf8::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_dieptxf8::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_dieptxf8`] module"]
#[doc(alias = "OTG_DIEPTXF8")]
pub type OtgDieptxf8 = crate::Reg<otg_dieptxf8::OtgDieptxf8Spec>;
#[doc = ""]
pub mod otg_dieptxf8;
#[doc = "OTG_HS_GRXSTSR_Device (r) register accessor: OTG_HS Receive status debug read register (peripheral mode mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_grxstsr_device::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_hs_grxstsr_device`] module"]
#[doc(alias = "OTG_HS_GRXSTSR_Device")]
pub type OtgHsGrxstsrDevice = crate::Reg<otg_hs_grxstsr_device::OtgHsGrxstsrDeviceSpec>;
#[doc = "OTG_HS Receive status debug read register (peripheral mode mode)"]
pub mod otg_hs_grxstsr_device;
#[doc = "OTG_HS_GRXSTSP_Device (r) register accessor: OTG_HS status read and pop register (peripheral mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_grxstsp_device::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_hs_grxstsp_device`] module"]
#[doc(alias = "OTG_HS_GRXSTSP_Device")]
pub type OtgHsGrxstspDevice = crate::Reg<otg_hs_grxstsp_device::OtgHsGrxstspDeviceSpec>;
#[doc = "OTG_HS status read and pop register (peripheral mode)"]
pub mod otg_hs_grxstsp_device;
#[doc = "OTG_HS_GLPMCFG (rw) register accessor: OTG core LPM configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_glpmcfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_glpmcfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_hs_glpmcfg`] module"]
#[doc(alias = "OTG_HS_GLPMCFG")]
pub type OtgHsGlpmcfg = crate::Reg<otg_hs_glpmcfg::OtgHsGlpmcfgSpec>;

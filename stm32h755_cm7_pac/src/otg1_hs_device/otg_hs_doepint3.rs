...
pub type R = crate::R<OtgHsDoepint3Spec>;
#[doc = "Register `OTG_HS_DOEPINT3` writer"]
pub type W = crate::W<OtgHsDoepint3Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDoepint3Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDoepint3Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    pub fn stup(&mut self) -> StupW<OtgHsDoepint3Spec> {
        StupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    pub fn otepdis(&mut self) -> OtepdisW<OtgHsDoepint3Spec> {
        OtepdisW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2bstupW<OtgHsDoepint3Spec> {
        B2bstupW::new(self, 6)
    }
    #[doc = "Bit 14 - NYET interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsDoepint3Spec> {
        NyetW::new(self, 14)
    }
}
...
pub struct OtgHsDoepint3Spec;
impl crate::RegisterSpec for OtgHsDoepint3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doepint3::R`](R) reader structure"]
impl crate::Readable for OtgHsDoepint3Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doepint3::W`](W) writer structure"]
impl crate::Writable for OtgHsDoepint3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPINT3 to value 0"]
impl crate::Resettable for OtgHsDoepint3Spec {}

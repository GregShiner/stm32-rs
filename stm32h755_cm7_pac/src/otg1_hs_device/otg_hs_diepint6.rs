...
#[doc = "OTG device endpoint-6 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_diepint6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_diepint6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]

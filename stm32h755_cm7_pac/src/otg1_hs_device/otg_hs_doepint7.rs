#[doc = "Register `OTG_HS_DOEPINT7` reader"]
pub type R = crate::R<OtgHsDoepint7Spec>;
#[doc = "Register `OTG_HS_DOEPINT7` writer"]
pub type W = crate::W<OtgHsDoepint7Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDoepint7Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDoepint7Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    pub fn stup(&mut self) -> StupW<OtgHsDoepint7Spec> {
        StupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    pub fn otepdis(&mut self) -> OtepdisW<OtgHsDoepint7Spec> {
        OtepdisW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2bstupW<OtgHsDoepint7Spec> {
        B2bstupW::new(self, 6)
    }
    #[doc = "Bit 14 - NYET interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsDoepint7Spec> {
        NyetW::new(self, 14)
    }
}
#[doc = "OTG_HS device endpoint-7 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_doepint7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_doepint7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDoepint7Spec;
impl crate::RegisterSpec for OtgHsDoepint7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doepint7::R`](R) reader structure"]
impl crate::Readable for OtgHsDoepint7Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doepint7::W`](W) writer structure"]
impl crate::Writable for OtgHsDoepint7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPINT7 to value 0"]
impl crate::Resettable for OtgHsDoepint7Spec {}

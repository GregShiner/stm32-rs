#[doc = "Register `OTG_HS_DIEPINT3` reader"]
pub type R = crate::R<OtgHsDiepint3Spec>;
#[doc = "Register `OTG_HS_DIEPINT3` writer"]
pub type W = crate::W<OtgHsDiepint3Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDiepint3Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDiepint3Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    pub fn toc(&mut self) -> TocW<OtgHsDiepint3Spec> {
        TocW::new(self, 3)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    pub fn ittxfe(&mut self) -> IttxfeW<OtgHsDiepint3Spec> {
        IttxfeW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    pub fn inepne(&mut self) -> InepneW<OtgHsDiepint3Spec> {
        InepneW::new(self, 6)
    }
    #[doc = "Bit 8 - Transmit Fifo Underrun"]
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TxfifoudrnW<OtgHsDiepint3Spec> {
        TxfifoudrnW::new(self, 8)
    }
    #[doc = "Bit 9 - Buffer not available interrupt"]
    #[inline(always)]
    pub fn bna(&mut self) -> BnaW<OtgHsDiepint3Spec> {
        BnaW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet dropped status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<OtgHsDiepint3Spec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble error interrupt"]
    #[inline(always)]
    pub fn berr(&mut self) -> BerrW<OtgHsDiepint3Spec> {
        BerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<OtgHsDiepint3Spec> {
        NakW::new(self, 13)
    }
}
...
pub struct OtgHsDiepint3Spec;
impl crate::RegisterSpec for OtgHsDiepint3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_diepint3::R`](R) reader structure"]
impl crate::Readable for OtgHsDiepint3Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_diepint3::W`](W) writer structure"]
impl crate::Writable for OtgHsDiepint3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPINT3 to value 0"]
impl crate::Resettable for OtgHsDiepint3Spec {}

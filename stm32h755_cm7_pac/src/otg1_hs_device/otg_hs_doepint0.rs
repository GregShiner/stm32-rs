#[doc = "Register `OTG_HS_DOEPINT0` reader"]
pub type R = crate::R<OtgHsDoepint0Spec>;
#[doc = "Register `OTG_HS_DOEPINT0` writer"]
pub type W = crate::W<OtgHsDoepint0Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDoepint0Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDoepint0Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    pub fn stup(&mut self) -> StupW<OtgHsDoepint0Spec> {
        StupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    pub fn otepdis(&mut self) -> OtepdisW<OtgHsDoepint0Spec> {
        OtepdisW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2bstupW<OtgHsDoepint0Spec> {
        B2bstupW::new(self, 6)
    }
    #[doc = "Bit 14 - NYET interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsDoepint0Spec> {
        NyetW::new(self, 14)
    }
}
#[doc = "OTG_HS device endpoint-0 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_doepint0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_doepint0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDoepint0Spec;
impl crate::RegisterSpec for OtgHsDoepint0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doepint0::R`](R) reader structure"]
impl crate::Readable for OtgHsDoepint0Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doepint0::W`](W) writer structure"]
impl crate::Writable for OtgHsDoepint0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPINT0 to value 0x80"]
impl crate::Resettable for OtgHsDoepint0Spec {

#[doc = "Register `OTG_HS_DOEPTSIZ3` reader"]
pub type R = crate::R<OtgHsDoeptsiz3Spec>;
#[doc = "Register `OTG_HS_DOEPTSIZ3` writer"]
pub type W = crate::W<OtgHsDoeptsiz3Spec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer size"]
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XfrsizW<OtgHsDoeptsiz3Spec> {
        XfrsizW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<OtgHsDoeptsiz3Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Received data PID/SETUP packet count"]
    #[inline(always)]
    pub fn rxdpid_stupcnt(&mut self) -> RxdpidStupcntW<OtgHsDoeptsiz3Spec> {
...
pub struct OtgHsDoeptsiz3Spec;
impl crate::RegisterSpec for OtgHsDoeptsiz3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doeptsiz3::R`](R) reader structure"]
impl crate::Readable for OtgHsDoeptsiz3Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doeptsiz3::W`](W) writer structure"]
impl crate::Writable for OtgHsDoeptsiz3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPTSIZ3 to value 0"]
impl crate::Resettable for OtgHsDoeptsiz3Spec {}

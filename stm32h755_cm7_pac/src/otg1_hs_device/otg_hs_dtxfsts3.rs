#[doc = "Register `OTG_HS_DTXFSTS3` reader"]
pub type R = crate::R<OtgHsDtxfsts3Spec>;
...
pub struct OtgHsDtxfsts3Spec;
impl crate::RegisterSpec for OtgHsDtxfsts3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_dtxfsts3::R`](R) reader structure"]
impl crate::Readable for OtgHsDtxfsts3Spec {}
#[doc = "`reset()` method sets OTG_HS_DTXFSTS3 to value 0"]
impl crate::Resettable for OtgHsDtxfsts3Spec {}

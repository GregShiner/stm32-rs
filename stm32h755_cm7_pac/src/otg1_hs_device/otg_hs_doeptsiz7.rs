#[doc = "Register `OTG_HS_DOEPTSIZ7` reader"]
pub type R = crate::R<OtgHsDoeptsiz7Spec>;
#[doc = "Register `OTG_HS_DOEPTSIZ7` writer"]
pub type W = crate::W<OtgHsDoeptsiz7Spec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer size"]
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XfrsizW<OtgHsDoeptsiz7Spec> {
        XfrsizW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<OtgHsDoeptsiz7Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Received data PID/SETUP packet count"]
    #[inline(always)]
    pub fn rxdpid_stupcnt(&mut self) -> RxdpidStupcntW<OtgHsDoeptsiz7Spec> {
...
pub struct OtgHsDoeptsiz7Spec;
impl crate::RegisterSpec for OtgHsDoeptsiz7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doeptsiz7::R`](R) reader structure"]
impl crate::Readable for OtgHsDoeptsiz7Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doeptsiz7::W`](W) writer structure"]
impl crate::Writable for OtgHsDoeptsiz7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPTSIZ7 to value 0"]
impl crate::Resettable for OtgHsDoeptsiz7Spec {}

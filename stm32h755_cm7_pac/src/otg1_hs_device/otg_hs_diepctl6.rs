#[doc = "Register `OTG_HS_DIEPCTL6` reader"]
pub type R = crate::R<OtgHsDiepctl6Spec>;
#[doc = "Register `OTG_HS_DIEPCTL6` writer"]
pub type W = crate::W<OtgHsDiepctl6Spec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum packet size"]
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MpsizW<OtgHsDiepctl6Spec> {
        MpsizW::new(self, 0)
    }
    #[doc = "Bit 15 - USB active endpoint"]
    #[inline(always)]
    pub fn usbaep(&mut self) -> UsbaepW<OtgHsDiepctl6Spec> {
        UsbaepW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    pub fn eptyp(&mut self) -> EptypW<OtgHsDiepctl6Spec> {
        EptypW::new(self, 18)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<OtgHsDiepctl6Spec> {
        StallW::new(self, 21)
    }
    #[doc = "Bits 22:25 - TxFIFO number"]
    #[inline(always)]
    pub fn txfnum(&mut self) -> TxfnumW<OtgHsDiepctl6Spec> {
        TxfnumW::new(self, 22)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    pub fn cnak(&mut self) -> CnakW<OtgHsDiepctl6Spec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    pub fn snak(&mut self) -> SnakW<OtgHsDiepctl6Spec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - Set DATA0 PID"]
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> Sd0pidSevnfrmW<OtgHsDiepctl6Spec> {
        Sd0pidSevnfrmW::new(self, 28)
    }
    #[doc = "Bit 29 - Set odd frame"]
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SoddfrmW<OtgHsDiepctl6Spec> {
        SoddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    pub fn epdis(&mut self) -> EpdisW<OtgHsDiepctl6Spec> {
        EpdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    pub fn epena(&mut self) -> EpenaW<OtgHsDiepctl6Spec> {
        EpenaW::new(self, 31)
    }
}
#[doc = "OTG device endpoint-6 control register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_diepctl6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_diepctl6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDiepctl6Spec;
impl crate::RegisterSpec for OtgHsDiepctl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_diepctl6::R`](R) reader structure"]
impl crate::Readable for OtgHsDiepctl6Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_diepctl6::W`](W) writer structure"]
impl crate::Writable for OtgHsDiepctl6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPCTL6 to value 0"]
impl crate::Resettable for OtgHsDiepctl6Spec {}

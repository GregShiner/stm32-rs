#[doc = "Register `OTG_HS_GRXSTSR_Device` reader"]
pub type R = crate::R<OtgHsGrxstsrDeviceSpec>;
...
#[doc = "OTG_HS Receive status debug read register (peripheral mode mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_grxstsr_device::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsGrxstsrDeviceSpec;
impl crate::RegisterSpec for OtgHsGrxstsrDeviceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_grxstsr_device::R`](R) reader structure"]
impl crate::Readable for OtgHsGrxstsrDeviceSpec {}
#[doc = "`reset()` method sets OTG_HS_GRXSTSR_Device to value 0"]
impl crate::Resettable for OtgHsGrxstsrDeviceSpec {}

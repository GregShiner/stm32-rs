...
pub type R = crate::R<OtgHsDieptxf5Spec>;
#[doc = "Register `OTG_HS_DIEPTXF5` writer"]
pub type W = crate::W<OtgHsDieptxf5Spec>;
...
impl W {
    #[doc = "Bits 0:15 - IN endpoint FIFOx transmit RAM start address"]
    #[inline(always)]
    pub fn ineptxsa(&mut self) -> IneptxsaW<OtgHsDieptxf5Spec> {
        IneptxsaW::new(self, 0)
    }
    #[doc = "Bits 16:31 - IN endpoint TxFIFO depth"]
    #[inline(always)]
    pub fn ineptxfd(&mut self) -> IneptxfdW<OtgHsDieptxf5Spec> {
...
pub struct OtgHsDieptxf5Spec;
impl crate::RegisterSpec for OtgHsDieptxf5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_dieptxf5::R`](R) reader structure"]
impl crate::Readable for OtgHsDieptxf5Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_dieptxf5::W`](W) writer structure"]
impl crate::Writable for OtgHsDieptxf5Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPTXF5 to value 0x0200_0c00"]
impl crate::Resettable for OtgHsDieptxf5Spec {

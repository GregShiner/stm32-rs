...
pub type R = crate::R<Setb1rSpec>;
#[doc = "Register `SETB1R` writer"]
pub type W = crate::W<Setb1rSpec>;
...
impl W {
    #[doc = "Bit 0 - Software Set trigger"]
    #[inline(always)]
    pub fn sst(&mut self) -> SstW<Setb1rSpec> {
        SstW::new(self, 0)
    }
    #[doc = "Bit 1 - Timer A resynchronizaton"]
    #[inline(always)]
    pub fn resync(&mut self) -> ResyncW<Setb1rSpec> {
        ResyncW::new(self, 1)
    }
    #[doc = "Bit 2 - Timer A Period"]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<Setb1rSpec> {
        PerW::new(self, 2)
    }
    #[doc = "Bit 3 - Timer A compare 1"]
    #[inline(always)]
    pub fn cmp1(&mut self) -> Cmp1W<Setb1rSpec> {
        Cmp1W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer A compare 2"]
    #[inline(always)]
    pub fn cmp2(&mut self) -> Cmp2W<Setb1rSpec> {
        Cmp2W::new(self, 4)
    }
    #[doc = "Bit 5 - Timer A compare 3"]
    #[inline(always)]
    pub fn cmp3(&mut self) -> Cmp3W<Setb1rSpec> {
        Cmp3W::new(self, 5)
    }
    #[doc = "Bit 6 - Timer A compare 4"]
    #[inline(always)]
    pub fn cmp4(&mut self) -> Cmp4W<Setb1rSpec> {
        Cmp4W::new(self, 6)
    }
    #[doc = "Bit 7 - Master Period"]
    #[inline(always)]
    pub fn mstper(&mut self) -> MstperW<Setb1rSpec> {
        MstperW::new(self, 7)
    }
    #[doc = "Bit 8 - Master Compare 1"]
    #[inline(always)]
    pub fn mstcmp1(&mut self) -> Mstcmp1W<Setb1rSpec> {
        Mstcmp1W::new(self, 8)
    }
    #[doc = "Bit 9 - Master Compare 2"]
    #[inline(always)]
    pub fn mstcmp2(&mut self) -> Mstcmp2W<Setb1rSpec> {
        Mstcmp2W::new(self, 9)
    }
    #[doc = "Bit 10 - Master Compare 3"]
    #[inline(always)]
    pub fn mstcmp3(&mut self) -> Mstcmp3W<Setb1rSpec> {
        Mstcmp3W::new(self, 10)
    }
    #[doc = "Bit 11 - Master Compare 4"]
    #[inline(always)]
    pub fn mstcmp4(&mut self) -> Mstcmp4W<Setb1rSpec> {
        Mstcmp4W::new(self, 11)
    }
    #[doc = "Bit 12 - Timer Event 1"]
    #[inline(always)]
    pub fn timevnt1(&mut self) -> Timevnt1W<Setb1rSpec> {
        Timevnt1W::new(self, 12)
    }
    #[doc = "Bit 13 - Timer Event 2"]
    #[inline(always)]
    pub fn timevnt2(&mut self) -> Timevnt2W<Setb1rSpec> {
        Timevnt2W::new(self, 13)
    }
    #[doc = "Bit 14 - Timer Event 3"]
    #[inline(always)]
    pub fn timevnt3(&mut self) -> Timevnt3W<Setb1rSpec> {
        Timevnt3W::new(self, 14)
    }
    #[doc = "Bit 15 - Timer Event 4"]
    #[inline(always)]
    pub fn timevnt4(&mut self) -> Timevnt4W<Setb1rSpec> {
        Timevnt4W::new(self, 15)
    }
    #[doc = "Bit 16 - Timer Event 5"]
    #[inline(always)]
    pub fn timevnt5(&mut self) -> Timevnt5W<Setb1rSpec> {
        Timevnt5W::new(self, 16)
    }
    #[doc = "Bit 17 - Timer Event 6"]
    #[inline(always)]
    pub fn timevnt6(&mut self) -> Timevnt6W<Setb1rSpec> {
        Timevnt6W::new(self, 17)
    }
    #[doc = "Bit 18 - Timer Event 7"]
    #[inline(always)]
    pub fn timevnt7(&mut self) -> Timevnt7W<Setb1rSpec> {
        Timevnt7W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer Event 8"]
    #[inline(always)]
    pub fn timevnt8(&mut self) -> Timevnt8W<Setb1rSpec> {
        Timevnt8W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer Event 9"]
    #[inline(always)]
    pub fn timevnt9(&mut self) -> Timevnt9W<Setb1rSpec> {
        Timevnt9W::new(self, 20)
    }
    #[doc = "Bit 21 - External Event 1"]
    #[inline(always)]
    pub fn extevnt1(&mut self) -> Extevnt1W<Setb1rSpec> {
        Extevnt1W::new(self, 21)
    }
    #[doc = "Bit 22 - External Event 2"]
    #[inline(always)]
    pub fn extevnt2(&mut self) -> Extevnt2W<Setb1rSpec> {
        Extevnt2W::new(self, 22)
    }
    #[doc = "Bit 23 - External Event 3"]
    #[inline(always)]
    pub fn extevnt3(&mut self) -> Extevnt3W<Setb1rSpec> {
        Extevnt3W::new(self, 23)
    }
    #[doc = "Bit 24 - External Event 4"]
    #[inline(always)]
    pub fn extevnt4(&mut self) -> Extevnt4W<Setb1rSpec> {
        Extevnt4W::new(self, 24)
    }
    #[doc = "Bit 25 - External Event 5"]
    #[inline(always)]
    pub fn extevnt5(&mut self) -> Extevnt5W<Setb1rSpec> {
        Extevnt5W::new(self, 25)
    }
    #[doc = "Bit 26 - External Event 6"]
    #[inline(always)]
    pub fn extevnt6(&mut self) -> Extevnt6W<Setb1rSpec> {
        Extevnt6W::new(self, 26)
    }
    #[doc = "Bit 27 - External Event 7"]
    #[inline(always)]
    pub fn extevnt7(&mut self) -> Extevnt7W<Setb1rSpec> {
        Extevnt7W::new(self, 27)
    }
    #[doc = "Bit 28 - External Event 8"]
    #[inline(always)]
    pub fn extevnt8(&mut self) -> Extevnt8W<Setb1rSpec> {
        Extevnt8W::new(self, 28)
    }
    #[doc = "Bit 29 - External Event 9"]
    #[inline(always)]
    pub fn extevnt9(&mut self) -> Extevnt9W<Setb1rSpec> {
        Extevnt9W::new(self, 29)
    }
    #[doc = "Bit 30 - External Event 10"]
    #[inline(always)]
    pub fn extevnt10(&mut self) -> Extevnt10W<Setb1rSpec> {
        Extevnt10W::new(self, 30)
    }
    #[doc = "Bit 31 - Registers update (transfer preload to active)"]
    #[inline(always)]
    pub fn update(&mut self) -> UpdateW<Setb1rSpec> {
        UpdateW::new(self, 31)
    }
}
...
pub struct Setb1rSpec;
impl crate::RegisterSpec for Setb1rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`setb1r::R`](R) reader structure"]
impl crate::Readable for Setb1rSpec {}
#[doc = "`write(|w| ..)` method takes [`setb1r::W`](W) writer structure"]
impl crate::Writable for Setb1rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SETB1R to value 0"]
impl crate::Resettable for Setb1rSpec {}

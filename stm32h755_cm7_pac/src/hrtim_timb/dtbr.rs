...
pub type R = crate::R<DtbrSpec>;
#[doc = "Register `DTBR` writer"]
pub type W = crate::W<DtbrSpec>;
...
impl W {
    #[doc = "Bits 0:8 - Deadtime Rising value"]
    #[inline(always)]
    pub fn dtrx(&mut self) -> DtrxW<DtbrSpec> {
        DtrxW::new(self, 0)
    }
    #[doc = "Bit 9 - Sign Deadtime Rising value"]
    #[inline(always)]
    pub fn sdtrx(&mut self) -> SdtrxW<DtbrSpec> {
        SdtrxW::new(self, 9)
    }
    #[doc = "Bits 10:12 - Deadtime Prescaler"]
    #[inline(always)]
    pub fn dtprsc(&mut self) -> DtprscW<DtbrSpec> {
        DtprscW::new(self, 10)
    }
    #[doc = "Bit 14 - Deadtime Rising Sign Lock"]
    #[inline(always)]
    pub fn dtrslkx(&mut self) -> DtrslkxW<DtbrSpec> {
        DtrslkxW::new(self, 14)
    }
    #[doc = "Bit 15 - Deadtime Rising Lock"]
    #[inline(always)]
    pub fn dtrlkx(&mut self) -> DtrlkxW<DtbrSpec> {
        DtrlkxW::new(self, 15)
    }
    #[doc = "Bits 16:24 - Deadtime Falling value"]
    #[inline(always)]
    pub fn dtfx(&mut self) -> DtfxW<DtbrSpec> {
        DtfxW::new(self, 16)
    }
    #[doc = "Bit 25 - Sign Deadtime Falling value"]
    #[inline(always)]
    pub fn sdtfx(&mut self) -> SdtfxW<DtbrSpec> {
        SdtfxW::new(self, 25)
    }
    #[doc = "Bit 30 - Deadtime Falling Sign Lock"]
    #[inline(always)]
    pub fn dtfslkx(&mut self) -> DtfslkxW<DtbrSpec> {
        DtfslkxW::new(self, 30)
    }
    #[doc = "Bit 31 - Deadtime Falling Lock"]
    #[inline(always)]
    pub fn dtflkx(&mut self) -> DtflkxW<DtbrSpec> {
        DtflkxW::new(self, 31)
    }
}
#[doc = "Timerx Deadtime Register\n\nYou can [`read`](crate::Reg::read) this register and get [`dtbr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dtbr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DtbrSpec;
impl crate::RegisterSpec for DtbrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dtbr::R`](R) reader structure"]
impl crate::Readable for DtbrSpec {}
#[doc = "`write(|w| ..)` method takes [`dtbr::W`](W) writer structure"]
impl crate::Writable for DtbrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DTBR to value 0"]
impl crate::Resettable for DtbrSpec {}

...
pub type R = crate::R<TimbisrSpec>;
...
#[doc = "Timerx Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timbisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TimbisrSpec;
impl crate::RegisterSpec for TimbisrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timbisr::R`](R) reader structure"]
impl crate::Readable for TimbisrSpec {}
#[doc = "`reset()` method sets TIMBISR to value 0"]
impl crate::Resettable for TimbisrSpec {}

...
pub type R = crate::R<TimbcrSpec>;
#[doc = "Register `TIMBCR` writer"]
pub type W = crate::W<TimbcrSpec>;
...
impl W {
    #[doc = "Bits 0:2 - HRTIM Timer x Clock prescaler"]
    #[inline(always)]
    pub fn ck_pscx(&mut self) -> CkPscxW<TimbcrSpec> {
        CkPscxW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    pub fn cont(&mut self) -> ContW<TimbcrSpec> {
        ContW::new(self, 3)
    }
    #[doc = "Bit 4 - Re-triggerable mode"]
    #[inline(always)]
    pub fn retrig(&mut self) -> RetrigW<TimbcrSpec> {
        RetrigW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode enable"]
    #[inline(always)]
    pub fn half(&mut self) -> HalfW<TimbcrSpec> {
        HalfW::new(self, 5)
    }
    #[doc = "Bit 6 - Push-Pull mode enable"]
    #[inline(always)]
    pub fn pshpll(&mut self) -> PshpllW<TimbcrSpec> {
        PshpllW::new(self, 6)
    }
    #[doc = "Bit 10 - Synchronization Resets Timer x"]
    #[inline(always)]
    pub fn syncrstx(&mut self) -> SyncrstxW<TimbcrSpec> {
        SyncrstxW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization Starts Timer x"]
    #[inline(always)]
    pub fn syncstrtx(&mut self) -> SyncstrtxW<TimbcrSpec> {
        SyncstrtxW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Delayed CMP2 mode"]
    #[inline(always)]
    pub fn delcmp2(&mut self) -> Delcmp2W<TimbcrSpec> {
        Delcmp2W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Delayed CMP4 mode"]
    #[inline(always)]
    pub fn delcmp4(&mut self) -> Delcmp4W<TimbcrSpec> {
        Delcmp4W::new(self, 14)
    }
    #[doc = "Bit 17 - Timer x Repetition update"]
    #[inline(always)]
    pub fn tx_repu(&mut self) -> TxRepuW<TimbcrSpec> {
        TxRepuW::new(self, 17)
    }
    #[doc = "Bit 18 - Timerx reset update"]
    #[inline(always)]
    pub fn tx_rstu(&mut self) -> TxRstuW<TimbcrSpec> {
        TxRstuW::new(self, 18)
    }
    #[doc = "Bit 20 - TBU"]
    #[inline(always)]
    pub fn tbu(&mut self) -> TbuW<TimbcrSpec> {
        TbuW::new(self, 20)
    }
    #[doc = "Bit 21 - TCU"]
    #[inline(always)]
    pub fn tcu(&mut self) -> TcuW<TimbcrSpec> {
        TcuW::new(self, 21)
    }
    #[doc = "Bit 22 - TDU"]
    #[inline(always)]
    pub fn tdu(&mut self) -> TduW<TimbcrSpec> {
        TduW::new(self, 22)
    }
    #[doc = "Bit 23 - TEU"]
    #[inline(always)]
    pub fn teu(&mut self) -> TeuW<TimbcrSpec> {
        TeuW::new(self, 23)
    }
    #[doc = "Bit 24 - Master Timer update"]
    #[inline(always)]
    pub fn mstu(&mut self) -> MstuW<TimbcrSpec> {
        MstuW::new(self, 24)
    }
    #[doc = "Bits 25:26 - AC Synchronization"]
    #[inline(always)]
    pub fn dacsync(&mut self) -> DacsyncW<TimbcrSpec> {
        DacsyncW::new(self, 25)
    }
    #[doc = "Bit 27 - Preload enable"]
    #[inline(always)]
    pub fn preen(&mut self) -> PreenW<TimbcrSpec> {
        PreenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update Gating"]
    #[inline(always)]
    pub fn updgat(&mut self) -> UpdgatW<TimbcrSpec> {
        UpdgatW::new(self, 28)
    }
}
...
pub struct TimbcrSpec;
impl crate::RegisterSpec for TimbcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timbcr::R`](R) reader structure"]
impl crate::Readable for TimbcrSpec {}
#[doc = "`write(|w| ..)` method takes [`timbcr::W`](W) writer structure"]
impl crate::Writable for TimbcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMBCR to value 0"]
impl crate::Resettable for TimbcrSpec {}

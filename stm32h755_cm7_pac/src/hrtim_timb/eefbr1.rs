...
pub type R = crate::R<Eefbr1Spec>;
#[doc = "Register `EEFBR1` writer"]
pub type W = crate::W<Eefbr1Spec>;
...
impl W {
    #[doc = "Bit 0 - External Event 1 latch"]
    #[inline(always)]
    pub fn ee1ltch(&mut self) -> Ee1ltchW<Eefbr1Spec> {
        Ee1ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 1 filter"]
    #[inline(always)]
    pub fn ee1fltr(&mut self) -> Ee1fltrW<Eefbr1Spec> {
        Ee1fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 2 latch"]
    #[inline(always)]
    pub fn ee2ltch(&mut self) -> Ee2ltchW<Eefbr1Spec> {
        Ee2ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 2 filter"]
    #[inline(always)]
    pub fn ee2fltr(&mut self) -> Ee2fltrW<Eefbr1Spec> {
        Ee2fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 3 latch"]
    #[inline(always)]
    pub fn ee3ltch(&mut self) -> Ee3ltchW<Eefbr1Spec> {
        Ee3ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 3 filter"]
    #[inline(always)]
    pub fn ee3fltr(&mut self) -> Ee3fltrW<Eefbr1Spec> {
        Ee3fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 4 latch"]
    #[inline(always)]
    pub fn ee4ltch(&mut self) -> Ee4ltchW<Eefbr1Spec> {
        Ee4ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 4 filter"]
    #[inline(always)]
    pub fn ee4fltr(&mut self) -> Ee4fltrW<Eefbr1Spec> {
        Ee4fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 5 latch"]
    #[inline(always)]
    pub fn ee5ltch(&mut self) -> Ee5ltchW<Eefbr1Spec> {
        Ee5ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 5 filter"]
    #[inline(always)]
    pub fn ee5fltr(&mut self) -> Ee5fltrW<Eefbr1Spec> {
        Ee5fltrW::new(self, 25)
    }
}
#[doc = "Timerx External Event Filtering Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`eefbr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eefbr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eefbr1Spec;
impl crate::RegisterSpec for Eefbr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eefbr1::R`](R) reader structure"]
impl crate::Readable for Eefbr1Spec {}
#[doc = "`write(|w| ..)` method takes [`eefbr1::W`](W) writer structure"]
impl crate::Writable for Eefbr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EEFBR1 to value 0"]
impl crate::Resettable for Eefbr1Spec {}

#[doc = "Register `OTG_HS_HCINT3` reader"]
pub type R = crate::R<OtgHsHcint3Spec>;
#[doc = "Register `OTG_HS_HCINT3` writer"]
pub type W = crate::W<OtgHsHcint3Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsHcint3Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted"]
    #[inline(always)]
    pub fn chh(&mut self) -> ChhW<OtgHsHcint3Spec> {
        ChhW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<OtgHsHcint3Spec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL response received interrupt"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<OtgHsHcint3Spec> {
        StallW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<OtgHsHcint3Spec> {
        NakW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<OtgHsHcint3Spec> {
        AckW::new(self, 5)
    }
    #[doc = "Bit 6 - Response received interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsHcint3Spec> {
        NyetW::new(self, 6)
    }
    #[doc = "Bit 7 - Transaction error"]
    #[inline(always)]
    pub fn txerr(&mut self) -> TxerrW<OtgHsHcint3Spec> {
        TxerrW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    pub fn bberr(&mut self) -> BberrW<OtgHsHcint3Spec> {
        BberrW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun"]
    #[inline(always)]
    pub fn frmor(&mut self) -> FrmorW<OtgHsHcint3Spec> {
        FrmorW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error"]
    #[inline(always)]
    pub fn dterr(&mut self) -> DterrW<OtgHsHcint3Spec> {
        DterrW::new(self, 10)
    }
}
#[doc = "OTG_HS host channel-3 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcint3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcint3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcint3Spec;
impl crate::RegisterSpec for OtgHsHcint3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcint3::R`](R) reader structure"]
impl crate::Readable for OtgHsHcint3Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcint3::W`](W) writer structure"]
impl crate::Writable for OtgHsHcint3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCINT3 to value 0"]
impl crate::Resettable for OtgHsHcint3Spec {}

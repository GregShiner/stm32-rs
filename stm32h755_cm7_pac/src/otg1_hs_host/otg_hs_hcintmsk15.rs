...
pub type R = crate::R<OtgHsHcintmsk15Spec>;
#[doc = "Register `OTG_HS_HCINTMSK15` writer"]
pub type W = crate::W<OtgHsHcintmsk15Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed mask"]
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XfrcmW<OtgHsHcintmsk15Spec> {
        XfrcmW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted mask"]
    #[inline(always)]
    pub fn chhm(&mut self) -> ChhmW<OtgHsHcintmsk15Spec> {
        ChhmW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<OtgHsHcintmsk15Spec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<OtgHsHcintmsk15Spec> {
        StallW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt mask"]
    #[inline(always)]
    pub fn nakm(&mut self) -> NakmW<OtgHsHcintmsk15Spec> {
        NakmW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt mask"]
    #[inline(always)]
    pub fn ackm(&mut self) -> AckmW<OtgHsHcintmsk15Spec> {
        AckmW::new(self, 5)
    }
    #[doc = "Bit 6 - Response received interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsHcintmsk15Spec> {
        NyetW::new(self, 6)
    }
    #[doc = "Bit 7 - Transaction error"]
    #[inline(always)]
    pub fn txerrm(&mut self) -> TxerrmW<OtgHsHcintmsk15Spec> {
        TxerrmW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    pub fn bberrm(&mut self) -> BberrmW<OtgHsHcintmsk15Spec> {
        BberrmW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    pub fn frmorm(&mut self) -> FrmormW<OtgHsHcintmsk15Spec> {
        FrmormW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    pub fn dterrm(&mut self) -> DterrmW<OtgHsHcintmsk15Spec> {
        DterrmW::new(self, 10)
    }
}
#[doc = "OTG_HS host channel-15 interrupt mask register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcintmsk15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcintmsk15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcintmsk15Spec;
impl crate::RegisterSpec for OtgHsHcintmsk15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcintmsk15::R`](R) reader structure"]
impl crate::Readable for OtgHsHcintmsk15Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcintmsk15::W`](W) writer structure"]
impl crate::Writable for OtgHsHcintmsk15Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCINTMSK15 to value 0"]
impl crate::Resettable for OtgHsHcintmsk15Spec {}

#[doc = "Register `OTG_HS_HCINTMSK14` reader"]
pub type R = crate::R<OtgHsHcintmsk14Spec>;
#[doc = "Register `OTG_HS_HCINTMSK14` writer"]
pub type W = crate::W<OtgHsHcintmsk14Spec>;
...
#[doc = "Field `NAKM` reader - NAKM response received interrupt mask"]
pub type NakmR = crate::BitReader;
#[doc = "Field `NAKM` writer - NAKM response received interrupt mask"]
pub type NakmW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACKM` reader - ACKM response received/transmitted interrupt mask"]
pub type AckmR = crate::BitReader;
#[doc = "Field `ACKM` writer - ACKM response received/transmitted interrupt mask"]
...
impl W {
    #[doc = "Bit 0 - Transfer completed mask"]
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XfrcmW<OtgHsHcintmsk14Spec> {
        XfrcmW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted mask"]
    #[inline(always)]
    pub fn chhm(&mut self) -> ChhmW<OtgHsHcintmsk14Spec> {
        ChhmW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<OtgHsHcintmsk14Spec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    pub fn stallm(&mut self) -> StallmW<OtgHsHcintmsk14Spec> {
        StallmW::new(self, 3)
    }
    #[doc = "Bit 4 - NAKM response received interrupt mask"]
    #[inline(always)]
    pub fn nakm(&mut self) -> NakmW<OtgHsHcintmsk14Spec> {
        NakmW::new(self, 4)
    }
    #[doc = "Bit 5 - ACKM response received/transmitted interrupt mask"]
    #[inline(always)]
    pub fn ackm(&mut self) -> AckmW<OtgHsHcintmsk14Spec> {
        AckmW::new(self, 5)
    }
    #[doc = "Bit 6 - Response received interrupt"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsHcintmsk14Spec> {
        NyetW::new(self, 6)
    }
    #[doc = "Bit 7 - Transaction error"]
    #[inline(always)]
    pub fn txerrm(&mut self) -> TxerrmW<OtgHsHcintmsk14Spec> {
        TxerrmW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    pub fn bberrm(&mut self) -> BberrmW<OtgHsHcintmsk14Spec> {
        BberrmW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    pub fn frmorm(&mut self) -> FrmormW<OtgHsHcintmsk14Spec> {
        FrmormW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    pub fn dterrm(&mut self) -> DterrmW<OtgHsHcintmsk14Spec> {
        DterrmW::new(self, 10)
    }
}
#[doc = "OTG_HS host channel-14 interrupt mask register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcintmsk14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcintmsk14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcintmsk14Spec;
impl crate::RegisterSpec for OtgHsHcintmsk14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcintmsk14::R`](R) reader structure"]
impl crate::Readable for OtgHsHcintmsk14Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcintmsk14::W`](W) writer structure"]
impl crate::Writable for OtgHsHcintmsk14Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCINTMSK14 to value 0"]
impl crate::Resettable for OtgHsHcintmsk14Spec {}

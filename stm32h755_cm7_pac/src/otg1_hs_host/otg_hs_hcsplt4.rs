#[doc = "Register `OTG_HS_HCSPLT4` reader"]
pub type R = crate::R<OtgHsHcsplt4Spec>;
#[doc = "Register `OTG_HS_HCSPLT4` writer"]
pub type W = crate::W<OtgHsHcsplt4Spec>;
...
impl W {
    #[doc = "Bits 0:6 - Port address"]
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PrtaddrW<OtgHsHcsplt4Spec> {
        PrtaddrW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Hub address"]
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HubaddrW<OtgHsHcsplt4Spec> {
        HubaddrW::new(self, 7)
    }
    #[doc = "Bits 14:15 - XACTPOS"]
    #[inline(always)]
    pub fn xactpos(&mut self) -> XactposW<OtgHsHcsplt4Spec> {
        XactposW::new(self, 14)
    }
    #[doc = "Bit 16 - Do complete split"]
    #[inline(always)]
    pub fn complsplt(&mut self) -> ComplspltW<OtgHsHcsplt4Spec> {
        ComplspltW::new(self, 16)
    }
    #[doc = "Bit 31 - Split enable"]
    #[inline(always)]
    pub fn spliten(&mut self) -> SplitenW<OtgHsHcsplt4Spec> {
...
pub struct OtgHsHcsplt4Spec;
impl crate::RegisterSpec for OtgHsHcsplt4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcsplt4::R`](R) reader structure"]
impl crate::Readable for OtgHsHcsplt4Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcsplt4::W`](W) writer structure"]
impl crate::Writable for OtgHsHcsplt4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCSPLT4 to value 0"]
impl crate::Resettable for OtgHsHcsplt4Spec {}

...
pub type R = crate::R<OptsrCurSpec>;
#[doc = "Register `OPTSR_CUR` writer"]
pub type W = crate::W<OptsrCurSpec>;
...
impl W {
    #[doc = "Bit 0 - Option byte change ongoing flag"]
    #[inline(always)]
    pub fn opt_busy(&mut self) -> OptBusyW<OptsrCurSpec> {
        OptBusyW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Brownout level option status bit"]
    #[inline(always)]
    pub fn bor_lev(&mut self) -> BorLevW<OptsrCurSpec> {
        BorLevW::new(self, 2)
    }
    #[doc = "Bit 4 - IWDG1 control option status bit"]
    #[inline(always)]
    pub fn iwdg1_hw(&mut self) -> Iwdg1HwW<OptsrCurSpec> {
        Iwdg1HwW::new(self, 4)
    }
    #[doc = "Bit 6 - D1 DStop entry reset option status bit"]
    #[inline(always)]
    pub fn n_rst_stop_d1(&mut self) -> NRstStopD1W<OptsrCurSpec> {
        NRstStopD1W::new(self, 6)
    }
    #[doc = "Bit 7 - D1 DStandby entry reset option status bit"]
    #[inline(always)]
    pub fn n_rst_stby_d1(&mut self) -> NRstStbyD1W<OptsrCurSpec> {
        NRstStbyD1W::new(self, 7)
    }
    #[doc = "Bits 8:15 - Readout protection level option status byte"]
    #[inline(always)]
    pub fn rdp(&mut self) -> RdpW<OptsrCurSpec> {
        RdpW::new(self, 8)
    }
    #[doc = "Bit 17 - IWDG Stop mode freeze option status bit"]
    #[inline(always)]
    pub fn fz_iwdg_stop(&mut self) -> FzIwdgStopW<OptsrCurSpec> {
        FzIwdgStopW::new(self, 17)
    }
    #[doc = "Bit 18 - IWDG Standby mode freeze option status bit"]
    #[inline(always)]
    pub fn fz_iwdg_sdby(&mut self) -> FzIwdgSdbyW<OptsrCurSpec> {
        FzIwdgSdbyW::new(self, 18)
    }
    #[doc = "Bits 19:20 - DTCM RAM size option status"]
    #[inline(always)]
    pub fn st_ram_size(&mut self) -> StRamSizeW<OptsrCurSpec> {
        StRamSizeW::new(self, 19)
    }
    #[doc = "Bit 21 - Security enable option status bit"]
    #[inline(always)]
    pub fn security(&mut self) -> SecurityW<OptsrCurSpec> {
        SecurityW::new(self, 21)
    }
    #[doc = "Bit 26 - User option bit 1"]
    #[inline(always)]
    pub fn rss1(&mut self) -> Rss1W<OptsrCurSpec> {
        Rss1W::new(self, 26)
    }
    #[doc = "Bit 28 - Device personalization status bit"]
    #[inline(always)]
    pub fn perso_ok(&mut self) -> PersoOkW<OptsrCurSpec> {
        PersoOkW::new(self, 28)
    }
    #[doc = "Bit 29 - I/O high-speed at low-voltage status bit (PRODUCT_BELOW_25V)"]
    #[inline(always)]
    pub fn io_hslv(&mut self) -> IoHslvW<OptsrCurSpec> {
        IoHslvW::new(self, 29)
    }
    #[doc = "Bit 30 - Option byte change error flag"]
    #[inline(always)]
    pub fn optchangeerr(&mut self) -> OptchangeerrW<OptsrCurSpec> {
        OptchangeerrW::new(self, 30)
    }
    #[doc = "Bit 31 - Bank swapping option status bit"]
    #[inline(always)]
    pub fn swap_bank_opt(&mut self) -> SwapBankOptW<OptsrCurSpec> {
        SwapBankOptW::new(self, 31)
    }
}
#[doc = "FLASH option status register\n\nYou can [`read`](crate::Reg::read) this register and get [`optsr_cur::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`optsr_cur::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OptsrCurSpec;
impl crate::RegisterSpec for OptsrCurSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`optsr_cur::R`](R) reader structure"]
impl crate::Readable for OptsrCurSpec {}
#[doc = "`write(|w| ..)` method takes [`optsr_cur::W`](W) writer structure"]
impl crate::Writable for OptsrCurSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPTSR_CUR to value 0"]
impl crate::Resettable for OptsrCurSpec {}

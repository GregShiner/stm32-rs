...
pub type R = crate::R<BootCurrSpec>;
...
pub struct BootCurrSpec;
impl crate::RegisterSpec for BootCurrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`boot_curr::R`](R) reader structure"]
impl crate::Readable for BootCurrSpec {}
#[doc = "`reset()` method sets BOOT_CURR to value 0"]
impl crate::Resettable for BootCurrSpec {}

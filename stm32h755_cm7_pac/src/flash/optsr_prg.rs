...
pub type R = crate::R<OptsrPrgSpec>;
#[doc = "Register `OPTSR_PRG` writer"]
pub type W = crate::W<OptsrPrgSpec>;
...
impl W {
    #[doc = "Bits 2:3 - BOR reset level option configuration bits"]
    #[inline(always)]
    pub fn bor_lev(&mut self) -> BorLevW<OptsrPrgSpec> {
        BorLevW::new(self, 2)
    }
    #[doc = "Bit 4 - IWDG1 option configuration bit"]
    #[inline(always)]
    pub fn iwdg1_hw(&mut self) -> Iwdg1HwW<OptsrPrgSpec> {
        Iwdg1HwW::new(self, 4)
    }
    #[doc = "Bit 6 - Option byte erase after D1 DStop option configuration bit"]
    #[inline(always)]
    pub fn n_rst_stop_d1(&mut self) -> NRstStopD1W<OptsrPrgSpec> {
        NRstStopD1W::new(self, 6)
    }
    #[doc = "Bit 7 - Option byte erase after D1 DStandby option configuration bit"]
    #[inline(always)]
    pub fn n_rst_stby_d1(&mut self) -> NRstStbyD1W<OptsrPrgSpec> {
        NRstStbyD1W::new(self, 7)
    }
    #[doc = "Bits 8:15 - Readout protection level option configuration byte"]
    #[inline(always)]
    pub fn rdp(&mut self) -> RdpW<OptsrPrgSpec> {
        RdpW::new(self, 8)
    }
    #[doc = "Bit 17 - IWDG Stop mode freeze option configuration bit"]
    #[inline(always)]
    pub fn fz_iwdg_stop(&mut self) -> FzIwdgStopW<OptsrPrgSpec> {
        FzIwdgStopW::new(self, 17)
    }
    #[doc = "Bit 18 - IWDG Standby mode freeze option configuration bit"]
    #[inline(always)]
    pub fn fz_iwdg_sdby(&mut self) -> FzIwdgSdbyW<OptsrPrgSpec> {
        FzIwdgSdbyW::new(self, 18)
    }
    #[doc = "Bits 19:20 - DTCM size select option configuration bits"]
    #[inline(always)]
    pub fn st_ram_size(&mut self) -> StRamSizeW<OptsrPrgSpec> {
        StRamSizeW::new(self, 19)
    }
    #[doc = "Bit 21 - Security option configuration bit"]
    #[inline(always)]
    pub fn security(&mut self) -> SecurityW<OptsrPrgSpec> {
        SecurityW::new(self, 21)
    }
    #[doc = "Bit 26 - User option configuration bit 1"]
    #[inline(always)]
    pub fn rss1(&mut self) -> Rss1W<OptsrPrgSpec> {
        Rss1W::new(self, 26)
    }
    #[doc = "Bit 27 - User option configuration bit 2"]
    #[inline(always)]
    pub fn rss2(&mut self) -> Rss2W<OptsrPrgSpec> {
        Rss2W::new(self, 27)
    }
    #[doc = "Bit 29 - I/O high-speed at low-voltage (PRODUCT_BELOW_25V)"]
    #[inline(always)]
    pub fn io_hslv(&mut self) -> IoHslvW<OptsrPrgSpec> {
        IoHslvW::new(self, 29)
    }
    #[doc = "Bit 31 - Bank swapping option configuration bit"]
    #[inline(always)]
    pub fn swap_bank_opt(&mut self) -> SwapBankOptW<OptsrPrgSpec> {
...
pub struct OptsrPrgSpec;
impl crate::RegisterSpec for OptsrPrgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`optsr_prg::R`](R) reader structure"]
impl crate::Readable for OptsrPrgSpec {}
#[doc = "`write(|w| ..)` method takes [`optsr_prg::W`](W) writer structure"]
impl crate::Writable for OptsrPrgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPTSR_PRG to value 0"]
impl crate::Resettable for OptsrPrgSpec {}

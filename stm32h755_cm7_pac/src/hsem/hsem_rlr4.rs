...
pub type R = crate::R<HsemRlr4Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr4Spec;
impl crate::RegisterSpec for HsemRlr4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr4::R`](R) reader structure"]
impl crate::Readable for HsemRlr4Spec {}
#[doc = "`reset()` method sets HSEM_RLR4 to value 0"]
impl crate::Resettable for HsemRlr4Spec {}

...
pub type R = crate::R<HsemRlr25Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr25::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr25Spec;
impl crate::RegisterSpec for HsemRlr25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr25::R`](R) reader structure"]
impl crate::Readable for HsemRlr25Spec {}
#[doc = "`reset()` method sets HSEM_RLR25 to value 0"]
impl crate::Resettable for HsemRlr25Spec {}

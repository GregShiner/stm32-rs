...
pub type R = crate::R<HsemRlr9Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr9::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr9Spec;
impl crate::RegisterSpec for HsemRlr9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr9::R`](R) reader structure"]
impl crate::Readable for HsemRlr9Spec {}
#[doc = "`reset()` method sets HSEM_RLR9 to value 0"]
impl crate::Resettable for HsemRlr9Spec {}

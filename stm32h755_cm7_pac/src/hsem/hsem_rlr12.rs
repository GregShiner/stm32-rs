...
pub type R = crate::R<HsemRlr12Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr12Spec;
impl crate::RegisterSpec for HsemRlr12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr12::R`](R) reader structure"]
impl crate::Readable for HsemRlr12Spec {}
#[doc = "`reset()` method sets HSEM_RLR12 to value 0"]
impl crate::Resettable for HsemRlr12Spec {}

...
pub type R = crate::R<HsemRlr6Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr6Spec;
impl crate::RegisterSpec for HsemRlr6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr6::R`](R) reader structure"]
impl crate::Readable for HsemRlr6Spec {}
#[doc = "`reset()` method sets HSEM_RLR6 to value 0"]
impl crate::Resettable for HsemRlr6Spec {}

...
pub type R = crate::R<HsemRlr11Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr11Spec;
impl crate::RegisterSpec for HsemRlr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr11::R`](R) reader structure"]
impl crate::Readable for HsemRlr11Spec {}
#[doc = "`reset()` method sets HSEM_RLR11 to value 0"]
impl crate::Resettable for HsemRlr11Spec {}

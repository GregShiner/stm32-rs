...
pub type R = crate::R<HsemRlr23Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr23::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr23Spec;
impl crate::RegisterSpec for HsemRlr23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr23::R`](R) reader structure"]
impl crate::Readable for HsemRlr23Spec {}
#[doc = "`reset()` method sets HSEM_RLR23 to value 0"]
impl crate::Resettable for HsemRlr23Spec {}

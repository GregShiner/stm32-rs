...
pub type R = crate::R<HsemRlr2Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr2Spec;
impl crate::RegisterSpec for HsemRlr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr2::R`](R) reader structure"]
impl crate::Readable for HsemRlr2Spec {}
#[doc = "`reset()` method sets HSEM_RLR2 to value 0"]
impl crate::Resettable for HsemRlr2Spec {}

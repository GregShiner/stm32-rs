...
pub type R = crate::R<HsemRlr21Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr21::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr21Spec;
impl crate::RegisterSpec for HsemRlr21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr21::R`](R) reader structure"]
impl crate::Readable for HsemRlr21Spec {}
#[doc = "`reset()` method sets HSEM_RLR21 to value 0"]
impl crate::Resettable for HsemRlr21Spec {}

...
pub type R = crate::R<HsemRlr13Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr13::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr13Spec;
impl crate::RegisterSpec for HsemRlr13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr13::R`](R) reader structure"]
impl crate::Readable for HsemRlr13Spec {}
#[doc = "`reset()` method sets HSEM_RLR13 to value 0"]
impl crate::Resettable for HsemRlr13Spec {}

...
pub type R = crate::R<HsemRlr8Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr8Spec;
impl crate::RegisterSpec for HsemRlr8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr8::R`](R) reader structure"]
impl crate::Readable for HsemRlr8Spec {}
#[doc = "`reset()` method sets HSEM_RLR8 to value 0"]
impl crate::Resettable for HsemRlr8Spec {}

...
pub type R = crate::R<HsemRlr14Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr14::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr14Spec;
impl crate::RegisterSpec for HsemRlr14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr14::R`](R) reader structure"]
impl crate::Readable for HsemRlr14Spec {}
#[doc = "`reset()` method sets HSEM_RLR14 to value 0"]
impl crate::Resettable for HsemRlr14Spec {}

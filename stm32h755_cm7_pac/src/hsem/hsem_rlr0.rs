...
pub type R = crate::R<HsemRlr0Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr0Spec;
impl crate::RegisterSpec for HsemRlr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr0::R`](R) reader structure"]
impl crate::Readable for HsemRlr0Spec {}
#[doc = "`reset()` method sets HSEM_RLR0 to value 0"]
impl crate::Resettable for HsemRlr0Spec {}

...
pub type R = crate::R<HsemRlr22Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr22::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr22Spec;
impl crate::RegisterSpec for HsemRlr22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr22::R`](R) reader structure"]
impl crate::Readable for HsemRlr22Spec {}
#[doc = "`reset()` method sets HSEM_RLR22 to value 0"]
impl crate::Resettable for HsemRlr22Spec {}

...
pub type R = crate::R<HsemRlr27Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr27::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr27Spec;
impl crate::RegisterSpec for HsemRlr27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr27::R`](R) reader structure"]
impl crate::Readable for HsemRlr27Spec {}
#[doc = "`reset()` method sets HSEM_RLR27 to value 0"]
impl crate::Resettable for HsemRlr27Spec {}

...
pub type R = crate::R<HsemRlr1Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr1Spec;
impl crate::RegisterSpec for HsemRlr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr1::R`](R) reader structure"]
impl crate::Readable for HsemRlr1Spec {}
#[doc = "`reset()` method sets HSEM_RLR1 to value 0"]
impl crate::Resettable for HsemRlr1Spec {}

...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tim16_af1(&self) -> &Tim16Af1 {
        &self.tim16_af1
    }
    #[doc = "0x68 - TIM16 input selection register"]
    #[inline(always)]
    pub const fn tim16_tisel(&self) -> &Tim16Tisel {
        &self.tim16_tisel
    }
}

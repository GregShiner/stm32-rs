...
pub type R = crate::R<C1Apb1hlpenrSpec>;
#[doc = "Register `C1_APB1HLPENR` writer"]
pub type W = crate::W<C1Apb1hlpenrSpec>;
...
impl W {
    #[doc = "Bit 1 - Clock Recovery System peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn crslpen(&mut self) -> CrslpenW<C1Apb1hlpenrSpec> {
        CrslpenW::new(self, 1)
    }
    #[doc = "Bit 2 - SWPMI Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn swplpen(&mut self) -> SwplpenW<C1Apb1hlpenrSpec> {
        SwplpenW::new(self, 2)
    }
    #[doc = "Bit 4 - OPAMP peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn opamplpen(&mut self) -> OpamplpenW<C1Apb1hlpenrSpec> {
        OpamplpenW::new(self, 4)
    }
    #[doc = "Bit 5 - MDIOS peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn mdioslpen(&mut self) -> MdioslpenW<C1Apb1hlpenrSpec> {
        MdioslpenW::new(self, 5)
    }
    #[doc = "Bit 8 - FDCAN Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn fdcanlpen(&mut self) -> FdcanlpenW<C1Apb1hlpenrSpec> {
...
pub struct C1Apb1hlpenrSpec;
impl crate::RegisterSpec for C1Apb1hlpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_apb1hlpenr::R`](R) reader structure"]
impl crate::Readable for C1Apb1hlpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_apb1hlpenr::W`](W) writer structure"]
impl crate::Writable for C1Apb1hlpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_APB1HLPENR to value 0"]
impl crate::Resettable for C1Apb1hlpenrSpec {}

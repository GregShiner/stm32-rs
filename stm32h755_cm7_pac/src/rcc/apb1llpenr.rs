...
pub type R = crate::R<Apb1llpenrSpec>;
#[doc = "Register `APB1LLPENR` writer"]
pub type W = crate::W<Apb1llpenrSpec>;
...
impl W {
    #[doc = "Bit 0 - TIM2 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim2lpen(&mut self) -> Tim2lpenW<Apb1llpenrSpec> {
        Tim2lpenW::new(self, 0)
    }
    #[doc = "Bit 1 - TIM3 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim3lpen(&mut self) -> Tim3lpenW<Apb1llpenrSpec> {
        Tim3lpenW::new(self, 1)
    }
    #[doc = "Bit 2 - TIM4 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim4lpen(&mut self) -> Tim4lpenW<Apb1llpenrSpec> {
        Tim4lpenW::new(self, 2)
    }
    #[doc = "Bit 3 - TIM5 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim5lpen(&mut self) -> Tim5lpenW<Apb1llpenrSpec> {
        Tim5lpenW::new(self, 3)
    }
    #[doc = "Bit 4 - TIM6 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim6lpen(&mut self) -> Tim6lpenW<Apb1llpenrSpec> {
        Tim6lpenW::new(self, 4)
    }
    #[doc = "Bit 5 - TIM7 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim7lpen(&mut self) -> Tim7lpenW<Apb1llpenrSpec> {
        Tim7lpenW::new(self, 5)
    }
    #[doc = "Bit 6 - TIM12 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim12lpen(&mut self) -> Tim12lpenW<Apb1llpenrSpec> {
        Tim12lpenW::new(self, 6)
    }
    #[doc = "Bit 7 - TIM13 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim13lpen(&mut self) -> Tim13lpenW<Apb1llpenrSpec> {
        Tim13lpenW::new(self, 7)
    }
    #[doc = "Bit 8 - TIM14 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim14lpen(&mut self) -> Tim14lpenW<Apb1llpenrSpec> {
        Tim14lpenW::new(self, 8)
    }
    #[doc = "Bit 9 - LPTIM1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lptim1lpen(&mut self) -> Lptim1lpenW<Apb1llpenrSpec> {
        Lptim1lpenW::new(self, 9)
    }
    #[doc = "Bit 14 - SPI2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi2lpen(&mut self) -> Spi2lpenW<Apb1llpenrSpec> {
        Spi2lpenW::new(self, 14)
    }
    #[doc = "Bit 15 - SPI3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi3lpen(&mut self) -> Spi3lpenW<Apb1llpenrSpec> {
        Spi3lpenW::new(self, 15)
    }
    #[doc = "Bit 16 - SPDIFRX Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spdifrxlpen(&mut self) -> SpdifrxlpenW<Apb1llpenrSpec> {
        SpdifrxlpenW::new(self, 16)
    }
    #[doc = "Bit 17 - USART2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart2lpen(&mut self) -> Usart2lpenW<Apb1llpenrSpec> {
        Usart2lpenW::new(self, 17)
    }
    #[doc = "Bit 18 - USART3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart3lpen(&mut self) -> Usart3lpenW<Apb1llpenrSpec> {
        Usart3lpenW::new(self, 18)
    }
    #[doc = "Bit 19 - UART4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn uart4lpen(&mut self) -> Uart4lpenW<Apb1llpenrSpec> {
        Uart4lpenW::new(self, 19)
    }
    #[doc = "Bit 20 - UART5 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn uart5lpen(&mut self) -> Uart5lpenW<Apb1llpenrSpec> {
        Uart5lpenW::new(self, 20)
    }
    #[doc = "Bit 21 - I2C1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn i2c1lpen(&mut self) -> I2c1lpenW<Apb1llpenrSpec> {
        I2c1lpenW::new(self, 21)
    }
    #[doc = "Bit 22 - I2C2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn i2c2lpen(&mut self) -> I2c2lpenW<Apb1llpenrSpec> {
        I2c2lpenW::new(self, 22)
    }
    #[doc = "Bit 23 - I2C3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn i2c3lpen(&mut self) -> I2c3lpenW<Apb1llpenrSpec> {
        I2c3lpenW::new(self, 23)
    }
    #[doc = "Bit 27 - HDMI-CEC Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn hdmiceclpen(&mut self) -> HdmiceclpenW<Apb1llpenrSpec> {
        HdmiceclpenW::new(self, 27)
    }
    #[doc = "Bit 29 - DAC1/2 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn dac12lpen(&mut self) -> Dac12lpenW<Apb1llpenrSpec> {
        Dac12lpenW::new(self, 29)
    }
    #[doc = "Bit 30 - USART7 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart7lpen(&mut self) -> Usart7lpenW<Apb1llpenrSpec> {
        Usart7lpenW::new(self, 30)
    }
    #[doc = "Bit 31 - USART8 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart8lpen(&mut self) -> Usart8lpenW<Apb1llpenrSpec> {
...
pub struct Apb1llpenrSpec;
impl crate::RegisterSpec for Apb1llpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb1llpenr::R`](R) reader structure"]
impl crate::Readable for Apb1llpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`apb1llpenr::W`](W) writer structure"]
impl crate::Writable for Apb1llpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB1LLPENR to value 0"]
impl crate::Resettable for Apb1llpenrSpec {}

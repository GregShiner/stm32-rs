...
pub type R = crate::R<C1Ahb2lpenrSpec>;
#[doc = "Register `C1_AHB2LPENR` writer"]
pub type W = crate::W<C1Ahb2lpenrSpec>;
...
impl W {
    #[doc = "Bit 0 - CAMITF peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn camitflpen(&mut self) -> CamitflpenW<C1Ahb2lpenrSpec> {
        CamitflpenW::new(self, 0)
    }
    #[doc = "Bit 4 - CRYPT peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn cryptlpen(&mut self) -> CryptlpenW<C1Ahb2lpenrSpec> {
        CryptlpenW::new(self, 4)
    }
    #[doc = "Bit 5 - HASH peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn hashlpen(&mut self) -> HashlpenW<C1Ahb2lpenrSpec> {
        HashlpenW::new(self, 5)
    }
    #[doc = "Bit 6 - RNG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn rnglpen(&mut self) -> RnglpenW<C1Ahb2lpenrSpec> {
        RnglpenW::new(self, 6)
    }
    #[doc = "Bit 9 - SDMMC2 and SDMMC2 Delay Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sdmmc2lpen(&mut self) -> Sdmmc2lpenW<C1Ahb2lpenrSpec> {
        Sdmmc2lpenW::new(self, 9)
    }
    #[doc = "Bit 29 - SRAM1 Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sram1lpen(&mut self) -> Sram1lpenW<C1Ahb2lpenrSpec> {
        Sram1lpenW::new(self, 29)
    }
    #[doc = "Bit 30 - SRAM2 Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sram2lpen(&mut self) -> Sram2lpenW<C1Ahb2lpenrSpec> {
        Sram2lpenW::new(self, 30)
    }
    #[doc = "Bit 31 - SRAM3 Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sram3lpen(&mut self) -> Sram3lpenW<C1Ahb2lpenrSpec> {
        Sram3lpenW::new(self, 31)
    }
}
#[doc = "RCC AHB2 Sleep Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`c1_ahb2lpenr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1_ahb2lpenr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C1Ahb2lpenrSpec;
impl crate::RegisterSpec for C1Ahb2lpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_ahb2lpenr::R`](R) reader structure"]
impl crate::Readable for C1Ahb2lpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_ahb2lpenr::W`](W) writer structure"]
impl crate::Writable for C1Ahb2lpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_AHB2LPENR to value 0"]
impl crate::Resettable for C1Ahb2lpenrSpec {}

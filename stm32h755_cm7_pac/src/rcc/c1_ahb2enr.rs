...
pub type R = crate::R<C1Ahb2enrSpec>;
#[doc = "Register `C1_AHB2ENR` writer"]
pub type W = crate::W<C1Ahb2enrSpec>;
...
impl W {
    #[doc = "Bit 0 - CAMITF peripheral clock enable"]
    #[inline(always)]
    pub fn camitfen(&mut self) -> CamitfenW<C1Ahb2enrSpec> {
        CamitfenW::new(self, 0)
    }
    #[doc = "Bit 4 - CRYPT peripheral clock enable"]
    #[inline(always)]
    pub fn crypten(&mut self) -> CryptenW<C1Ahb2enrSpec> {
        CryptenW::new(self, 4)
    }
    #[doc = "Bit 5 - HASH peripheral clock enable"]
    #[inline(always)]
    pub fn hashen(&mut self) -> HashenW<C1Ahb2enrSpec> {
        HashenW::new(self, 5)
    }
    #[doc = "Bit 6 - RNG peripheral clocks enable"]
    #[inline(always)]
    pub fn rngen(&mut self) -> RngenW<C1Ahb2enrSpec> {
        RngenW::new(self, 6)
    }
    #[doc = "Bit 9 - SDMMC2 and SDMMC2 delay clock enable"]
    #[inline(always)]
    pub fn sdmmc2en(&mut self) -> Sdmmc2enW<C1Ahb2enrSpec> {
        Sdmmc2enW::new(self, 9)
    }
    #[doc = "Bit 29 - SRAM1 block enable"]
    #[inline(always)]
    pub fn sram1en(&mut self) -> Sram1enW<C1Ahb2enrSpec> {
        Sram1enW::new(self, 29)
    }
    #[doc = "Bit 30 - SRAM2 block enable"]
    #[inline(always)]
    pub fn sram2en(&mut self) -> Sram2enW<C1Ahb2enrSpec> {
        Sram2enW::new(self, 30)
    }
    #[doc = "Bit 31 - SRAM3 block enable"]
    #[inline(always)]
    pub fn sram3en(&mut self) -> Sram3enW<C1Ahb2enrSpec> {
...
pub struct C1Ahb2enrSpec;
impl crate::RegisterSpec for C1Ahb2enrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_ahb2enr::R`](R) reader structure"]
impl crate::Readable for C1Ahb2enrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_ahb2enr::W`](W) writer structure"]
impl crate::Writable for C1Ahb2enrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_AHB2ENR to value 0"]
impl crate::Resettable for C1Ahb2enrSpec {}

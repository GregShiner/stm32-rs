...
pub type R = crate::R<C1Ahb3lpenrSpec>;
#[doc = "Register `C1_AHB3LPENR` writer"]
pub type W = crate::W<C1Ahb3lpenrSpec>;
...
impl W {
    #[doc = "Bit 0 - MDMA Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn mdmalpen(&mut self) -> MdmalpenW<C1Ahb3lpenrSpec> {
        MdmalpenW::new(self, 0)
    }
    #[doc = "Bit 4 - DMA2D Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn dma2dlpen(&mut self) -> Dma2dlpenW<C1Ahb3lpenrSpec> {
        Dma2dlpenW::new(self, 4)
    }
    #[doc = "Bit 5 - JPGDEC Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn jpgdeclpen(&mut self) -> JpgdeclpenW<C1Ahb3lpenrSpec> {
        JpgdeclpenW::new(self, 5)
    }
    #[doc = "Bit 8 - FLITF Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn flitflpen(&mut self) -> FlitflpenW<C1Ahb3lpenrSpec> {
        FlitflpenW::new(self, 8)
    }
    #[doc = "Bit 12 - FMC Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn fmclpen(&mut self) -> FmclpenW<C1Ahb3lpenrSpec> {
        FmclpenW::new(self, 12)
    }
    #[doc = "Bit 14 - QUADSPI and QUADSPI Delay Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn qspilpen(&mut self) -> QspilpenW<C1Ahb3lpenrSpec> {
        QspilpenW::new(self, 14)
    }
    #[doc = "Bit 16 - SDMMC1 and SDMMC1 Delay Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sdmmc1lpen(&mut self) -> Sdmmc1lpenW<C1Ahb3lpenrSpec> {
        Sdmmc1lpenW::new(self, 16)
    }
    #[doc = "Bit 28 - D1DTCM1 Block Clock Enable During CSleep mode"]
    #[inline(always)]
    pub fn d1dtcm1lpen(&mut self) -> D1dtcm1lpenW<C1Ahb3lpenrSpec> {
        D1dtcm1lpenW::new(self, 28)
    }
    #[doc = "Bit 29 - D1 DTCM2 Block Clock Enable During CSleep mode"]
    #[inline(always)]
    pub fn dtcm2lpen(&mut self) -> Dtcm2lpenW<C1Ahb3lpenrSpec> {
        Dtcm2lpenW::new(self, 29)
    }
    #[doc = "Bit 30 - D1ITCM Block Clock Enable During CSleep mode"]
    #[inline(always)]
    pub fn itcmlpen(&mut self) -> ItcmlpenW<C1Ahb3lpenrSpec> {
        ItcmlpenW::new(self, 30)
    }
    #[doc = "Bit 31 - AXISRAM Block Clock Enable During CSleep mode"]
    #[inline(always)]
    pub fn axisramlpen(&mut self) -> AxisramlpenW<C1Ahb3lpenrSpec> {
...
pub struct C1Ahb3lpenrSpec;
impl crate::RegisterSpec for C1Ahb3lpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_ahb3lpenr::R`](R) reader structure"]
impl crate::Readable for C1Ahb3lpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_ahb3lpenr::W`](W) writer structure"]
impl crate::Writable for C1Ahb3lpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_AHB3LPENR to value 0"]
impl crate::Resettable for C1Ahb3lpenrSpec {}

...
pub type R = crate::R<RsterSpec>;
#[doc = "Register `RSTER` writer"]
pub type W = crate::W<RsterSpec>;
...
impl R {
    ...
    pub fn timdcmp1(&self) -> Timdcmp1R {
        Timdcmp1R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - Timer D Compare 2"]
    #[inline(always)]
    pub fn timdcmp2(&self) -> Timdcmp2R {
        Timdcmp2R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Timer D Compare 4"]
    #[inline(always)]
    pub fn timdcmp4(&self) -> Timdcmp4R {
        Timdcmp4R::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - Timer A Update reset"]
    #[inline(always)]
    pub fn updt(&mut self) -> UpdtW<RsterSpec> {
        UpdtW::new(self, 1)
    }
    #[doc = "Bit 2 - Timer A compare 2 reset"]
    #[inline(always)]
    pub fn cmp2(&mut self) -> Cmp2W<RsterSpec> {
        Cmp2W::new(self, 2)
    }
    #[doc = "Bit 3 - Timer A compare 4 reset"]
    #[inline(always)]
    pub fn cmp4(&mut self) -> Cmp4W<RsterSpec> {
        Cmp4W::new(self, 3)
    }
    #[doc = "Bit 4 - Master timer Period"]
    #[inline(always)]
    pub fn mstper(&mut self) -> MstperW<RsterSpec> {
        MstperW::new(self, 4)
    }
    #[doc = "Bit 5 - Master compare 1"]
    #[inline(always)]
    pub fn mstcmp1(&mut self) -> Mstcmp1W<RsterSpec> {
        Mstcmp1W::new(self, 5)
    }
    #[doc = "Bit 6 - Master compare 2"]
    #[inline(always)]
    pub fn mstcmp2(&mut self) -> Mstcmp2W<RsterSpec> {
        Mstcmp2W::new(self, 6)
    }
    #[doc = "Bit 7 - Master compare 3"]
    #[inline(always)]
    pub fn mstcmp3(&mut self) -> Mstcmp3W<RsterSpec> {
        Mstcmp3W::new(self, 7)
    }
    #[doc = "Bit 8 - Master compare 4"]
    #[inline(always)]
    pub fn mstcmp4(&mut self) -> Mstcmp4W<RsterSpec> {
        Mstcmp4W::new(self, 8)
    }
    #[doc = "Bit 9 - External Event 1"]
    #[inline(always)]
    pub fn extevnt1(&mut self) -> Extevnt1W<RsterSpec> {
        Extevnt1W::new(self, 9)
    }
    #[doc = "Bit 10 - External Event 2"]
    #[inline(always)]
    pub fn extevnt2(&mut self) -> Extevnt2W<RsterSpec> {
        Extevnt2W::new(self, 10)
    }
    #[doc = "Bit 11 - External Event 3"]
    #[inline(always)]
    pub fn extevnt3(&mut self) -> Extevnt3W<RsterSpec> {
        Extevnt3W::new(self, 11)
    }
    #[doc = "Bit 12 - External Event 4"]
    #[inline(always)]
    pub fn extevnt4(&mut self) -> Extevnt4W<RsterSpec> {
        Extevnt4W::new(self, 12)
    }
    #[doc = "Bit 13 - External Event 5"]
    #[inline(always)]
    pub fn extevnt5(&mut self) -> Extevnt5W<RsterSpec> {
        Extevnt5W::new(self, 13)
    }
    #[doc = "Bit 14 - External Event 6"]
    #[inline(always)]
    pub fn extevnt6(&mut self) -> Extevnt6W<RsterSpec> {
        Extevnt6W::new(self, 14)
    }
    #[doc = "Bit 15 - External Event 7"]
    #[inline(always)]
    pub fn extevnt7(&mut self) -> Extevnt7W<RsterSpec> {
        Extevnt7W::new(self, 15)
    }
    #[doc = "Bit 16 - External Event 8"]
    #[inline(always)]
    pub fn extevnt8(&mut self) -> Extevnt8W<RsterSpec> {
        Extevnt8W::new(self, 16)
    }
    #[doc = "Bit 17 - External Event 9"]
    #[inline(always)]
    pub fn extevnt9(&mut self) -> Extevnt9W<RsterSpec> {
        Extevnt9W::new(self, 17)
    }
    #[doc = "Bit 18 - External Event 10"]
    #[inline(always)]
    pub fn extevnt10(&mut self) -> Extevnt10W<RsterSpec> {
        Extevnt10W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer A Compare 1"]
    #[inline(always)]
    pub fn timacmp1(&mut self) -> Timacmp1W<RsterSpec> {
        Timacmp1W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer A Compare 2"]
    #[inline(always)]
    pub fn timacmp2(&mut self) -> Timacmp2W<RsterSpec> {
        Timacmp2W::new(self, 20)
    }
    #[doc = "Bit 21 - Timer A Compare 4"]
    #[inline(always)]
    pub fn timacmp4(&mut self) -> Timacmp4W<RsterSpec> {
        Timacmp4W::new(self, 21)
    }
    #[doc = "Bit 22 - Timer B Compare 1"]
    #[inline(always)]
    pub fn timbcmp1(&mut self) -> Timbcmp1W<RsterSpec> {
        Timbcmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer B Compare 2"]
    #[inline(always)]
    pub fn timbcmp2(&mut self) -> Timbcmp2W<RsterSpec> {
        Timbcmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer B Compare 4"]
    #[inline(always)]
    pub fn timbcmp4(&mut self) -> Timbcmp4W<RsterSpec> {
        Timbcmp4W::new(self, 24)
    }
    #[doc = "Bit 25 - Timer C Compare 1"]
    #[inline(always)]
    pub fn timccmp1(&mut self) -> Timccmp1W<RsterSpec> {
        Timccmp1W::new(self, 25)
    }
    #[doc = "Bit 26 - Timer C Compare 2"]
    #[inline(always)]
    pub fn timccmp2(&mut self) -> Timccmp2W<RsterSpec> {
        Timccmp2W::new(self, 26)
    }
    #[doc = "Bit 27 - Timer C Compare 4"]
    #[inline(always)]
    pub fn timccmp4(&mut self) -> Timccmp4W<RsterSpec> {
        Timccmp4W::new(self, 27)
    }
    #[doc = "Bit 28 - Timer D Compare 1"]
    #[inline(always)]
    pub fn timdcmp1(&mut self) -> Timdcmp1W<RsterSpec> {
        Timdcmp1W::new(self, 28)
    }
    #[doc = "Bit 29 - Timer D Compare 2"]
    #[inline(always)]
    pub fn timdcmp2(&mut self) -> Timdcmp2W<RsterSpec> {
        Timdcmp2W::new(self, 29)
    }
    #[doc = "Bit 30 - Timer D Compare 4"]
    #[inline(always)]
    pub fn timdcmp4(&mut self) -> Timdcmp4W<RsterSpec> {
        Timdcmp4W::new(self, 30)
    }
}
#[doc = "TimerA Reset Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rster::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rster::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RsterSpec;
impl crate::RegisterSpec for RsterSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rster::R`](R) reader structure"]
impl crate::Readable for RsterSpec {}
#[doc = "`write(|w| ..)` method takes [`rster::W`](W) writer structure"]
impl crate::Writable for RsterSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RSTER to value 0"]
impl crate::Resettable for RsterSpec {}

...
pub type R = crate::R<Cpt2ecrSpec>;
#[doc = "Register `CPT2ECR` writer"]
pub type W = crate::W<Cpt2ecrSpec>;
...
impl W {
    #[doc = "Bit 0 - Software Capture"]
    #[inline(always)]
    pub fn swcpt(&mut self) -> SwcptW<Cpt2ecrSpec> {
        SwcptW::new(self, 0)
    }
    #[doc = "Bit 1 - Update Capture"]
    #[inline(always)]
    pub fn udpcpt(&mut self) -> UdpcptW<Cpt2ecrSpec> {
        UdpcptW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event 1 Capture"]
    #[inline(always)]
    pub fn exev1cpt(&mut self) -> Exev1cptW<Cpt2ecrSpec> {
        Exev1cptW::new(self, 2)
    }
    #[doc = "Bit 3 - External Event 2 Capture"]
    #[inline(always)]
    pub fn exev2cpt(&mut self) -> Exev2cptW<Cpt2ecrSpec> {
        Exev2cptW::new(self, 3)
    }
    #[doc = "Bit 4 - External Event 3 Capture"]
    #[inline(always)]
    pub fn exev3cpt(&mut self) -> Exev3cptW<Cpt2ecrSpec> {
        Exev3cptW::new(self, 4)
    }
    #[doc = "Bit 5 - External Event 4 Capture"]
    #[inline(always)]
    pub fn exev4cpt(&mut self) -> Exev4cptW<Cpt2ecrSpec> {
        Exev4cptW::new(self, 5)
    }
    #[doc = "Bit 6 - External Event 5 Capture"]
    #[inline(always)]
    pub fn exev5cpt(&mut self) -> Exev5cptW<Cpt2ecrSpec> {
        Exev5cptW::new(self, 6)
    }
    #[doc = "Bit 7 - External Event 6 Capture"]
    #[inline(always)]
    pub fn exev6cpt(&mut self) -> Exev6cptW<Cpt2ecrSpec> {
        Exev6cptW::new(self, 7)
    }
    #[doc = "Bit 8 - External Event 7 Capture"]
    #[inline(always)]
    pub fn exev7cpt(&mut self) -> Exev7cptW<Cpt2ecrSpec> {
        Exev7cptW::new(self, 8)
    }
    #[doc = "Bit 9 - External Event 8 Capture"]
    #[inline(always)]
    pub fn exev8cpt(&mut self) -> Exev8cptW<Cpt2ecrSpec> {
        Exev8cptW::new(self, 9)
    }
    #[doc = "Bit 10 - External Event 9 Capture"]
    #[inline(always)]
    pub fn exev9cpt(&mut self) -> Exev9cptW<Cpt2ecrSpec> {
        Exev9cptW::new(self, 10)
    }
    #[doc = "Bit 11 - External Event 10 Capture"]
    #[inline(always)]
    pub fn exev10cpt(&mut self) -> Exev10cptW<Cpt2ecrSpec> {
        Exev10cptW::new(self, 11)
    }
    #[doc = "Bit 12 - Timer A output 1 Set"]
    #[inline(always)]
    pub fn ta1set(&mut self) -> Ta1setW<Cpt2ecrSpec> {
        Ta1setW::new(self, 12)
    }
    #[doc = "Bit 13 - Timer A output 1 Reset"]
    #[inline(always)]
    pub fn ta1rst(&mut self) -> Ta1rstW<Cpt2ecrSpec> {
        Ta1rstW::new(self, 13)
    }
    #[doc = "Bit 14 - Timer A Compare 1"]
    #[inline(always)]
    pub fn tacmp1(&mut self) -> Tacmp1W<Cpt2ecrSpec> {
        Tacmp1W::new(self, 14)
    }
    #[doc = "Bit 15 - Timer A Compare 2"]
    #[inline(always)]
    pub fn tacmp2(&mut self) -> Tacmp2W<Cpt2ecrSpec> {
        Tacmp2W::new(self, 15)
    }
    #[doc = "Bit 16 - Timer B output 1 Set"]
    #[inline(always)]
    pub fn tb1set(&mut self) -> Tb1setW<Cpt2ecrSpec> {
        Tb1setW::new(self, 16)
    }
    #[doc = "Bit 17 - Timer B output 1 Reset"]
    #[inline(always)]
    pub fn tb1rst(&mut self) -> Tb1rstW<Cpt2ecrSpec> {
        Tb1rstW::new(self, 17)
    }
    #[doc = "Bit 18 - Timer B Compare 1"]
    #[inline(always)]
    pub fn tbcmp1(&mut self) -> Tbcmp1W<Cpt2ecrSpec> {
        Tbcmp1W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer B Compare 2"]
    #[inline(always)]
    pub fn tbcmp2(&mut self) -> Tbcmp2W<Cpt2ecrSpec> {
        Tbcmp2W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer C output 1 Set"]
    #[inline(always)]
    pub fn tc1set(&mut self) -> Tc1setW<Cpt2ecrSpec> {
        Tc1setW::new(self, 20)
    }
    #[doc = "Bit 21 - Timer C output 1 Reset"]
    #[inline(always)]
    pub fn tc1rst(&mut self) -> Tc1rstW<Cpt2ecrSpec> {
        Tc1rstW::new(self, 21)
    }
    #[doc = "Bit 22 - Timer C Compare 1"]
    #[inline(always)]
    pub fn tccmp1(&mut self) -> Tccmp1W<Cpt2ecrSpec> {
        Tccmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer C Compare 2"]
    #[inline(always)]
    pub fn tccmp2(&mut self) -> Tccmp2W<Cpt2ecrSpec> {
        Tccmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
    pub fn td1set(&mut self) -> Td1setW<Cpt2ecrSpec> {
        Td1setW::new(self, 24)
    }
    #[doc = "Bit 25 - Timer D output 1 Reset"]
    #[inline(always)]
    pub fn td1rst(&mut self) -> Td1rstW<Cpt2ecrSpec> {
        Td1rstW::new(self, 25)
    }
    #[doc = "Bit 26 - Timer D Compare 1"]
    #[inline(always)]
    pub fn tdcmp1(&mut self) -> Tdcmp1W<Cpt2ecrSpec> {
        Tdcmp1W::new(self, 26)
    }
    #[doc = "Bit 27 - Timer D Compare 2"]
    #[inline(always)]
    pub fn tdcmp2(&mut self) -> Tdcmp2W<Cpt2ecrSpec> {
        Tdcmp2W::new(self, 27)
    }
}
#[doc = "CPT2xCR\n\nYou can [`read`](crate::Reg::read) this register and get [`cpt2ecr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpt2ecr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpt2ecrSpec;
impl crate::RegisterSpec for Cpt2ecrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpt2ecr::R`](R) reader structure"]
impl crate::Readable for Cpt2ecrSpec {}
#[doc = "`write(|w| ..)` method takes [`cpt2ecr::W`](W) writer structure"]
impl crate::Writable for Cpt2ecrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CPT2ECR to value 0"]
impl crate::Resettable for Cpt2ecrSpec {}

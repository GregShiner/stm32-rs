...
pub type R = crate::R<TimeisrSpec>;
...
#[doc = "Timerx Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timeisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TimeisrSpec;
impl crate::RegisterSpec for TimeisrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timeisr::R`](R) reader structure"]
impl crate::Readable for TimeisrSpec {}
#[doc = "`reset()` method sets TIMEISR to value 0"]
impl crate::Resettable for TimeisrSpec {}

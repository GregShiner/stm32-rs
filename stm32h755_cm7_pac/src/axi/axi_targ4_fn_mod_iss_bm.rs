...
pub type R = crate::R<AxiTarg4FnModIssBmSpec>;
#[doc = "Register `AXI_TARG4_FN_MOD_ISS_BM` writer"]
pub type W = crate::W<AxiTarg4FnModIssBmSpec>;
...
impl W {
    #[doc = "Bit 0 - READ_ISS_OVERRIDE"]
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> ReadIssOverrideW<AxiTarg4FnModIssBmSpec> {
        ReadIssOverrideW::new(self, 0)
    }
    #[doc = "Bit 1 - Switch matrix write issuing override for target"]
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WriteIssOverrideW<AxiTarg4FnModIssBmSpec> {
        WriteIssOverrideW::new(self, 1)
    }
}
#[doc = "AXI interconnect - TARG x bus matrix issuing functionality register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_targ4_fn_mod_iss_bm::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_targ4_fn_mod_iss_bm::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AxiTarg4FnModIssBmSpec;
impl crate::RegisterSpec for AxiTarg4FnModIssBmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_targ4_fn_mod_iss_bm::R`](R) reader structure"]
impl crate::Readable for AxiTarg4FnModIssBmSpec {}
#[doc = "`write(|w| ..)` method takes [`axi_targ4_fn_mod_iss_bm::W`](W) writer structure"]
impl crate::Writable for AxiTarg4FnModIssBmSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AXI_TARG4_FN_MOD_ISS_BM to value 0x04"]
impl crate::Resettable for AxiTarg4FnModIssBmSpec {

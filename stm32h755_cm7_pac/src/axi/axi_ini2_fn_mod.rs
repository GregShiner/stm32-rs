#[doc = "Register `AXI_INI2_FN_MOD` reader"]
pub type R = crate::R<AxiIni2FnModSpec>;
#[doc = "Register `AXI_INI2_FN_MOD` writer"]
pub type W = crate::W<AxiIni2FnModSpec>;
...
impl W {
    #[doc = "Bit 0 - Override ASIB read issuing capability"]
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> ReadIssOverrideW<AxiIni2FnModSpec> {
        ReadIssOverrideW::new(self, 0)
    }
    #[doc = "Bit 1 - Override ASIB write issuing capability"]
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WriteIssOverrideW<AxiIni2FnModSpec> {
        WriteIssOverrideW::new(self, 1)
    }
}
#[doc = "AXI interconnect - INI x issuing functionality modification register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_ini2_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_ini2_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AxiIni2FnModSpec;
impl crate::RegisterSpec for AxiIni2FnModSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_ini2_fn_mod::R`](R) reader structure"]
impl crate::Readable for AxiIni2FnModSpec {}
#[doc = "`write(|w| ..)` method takes [`axi_ini2_fn_mod::W`](W) writer structure"]
impl crate::Writable for AxiIni2FnModSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AXI_INI2_FN_MOD to value 0x04"]
impl crate::Resettable for AxiIni2FnModSpec {

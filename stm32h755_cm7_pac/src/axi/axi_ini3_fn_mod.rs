#[doc = "Register `AXI_INI3_FN_MOD` reader"]
pub type R = crate::R<AxiIni3FnModSpec>;
#[doc = "Register `AXI_INI3_FN_MOD` writer"]
pub type W = crate::W<AxiIni3FnModSpec>;
...
impl W {
    #[doc = "Bit 0 - Override ASIB read issuing capability"]
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> ReadIssOverrideW<AxiIni3FnModSpec> {
        ReadIssOverrideW::new(self, 0)
    }
    #[doc = "Bit 1 - Override ASIB write issuing capability"]
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WriteIssOverrideW<AxiIni3FnModSpec> {
        WriteIssOverrideW::new(self, 1)
    }
}
#[doc = "AXI interconnect - INI x issuing functionality modification register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_ini3_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_ini3_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AxiIni3FnModSpec;
impl crate::RegisterSpec for AxiIni3FnModSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_ini3_fn_mod::R`](R) reader structure"]
impl crate::Readable for AxiIni3FnModSpec {}
#[doc = "`write(|w| ..)` method takes [`axi_ini3_fn_mod::W`](W) writer structure"]
impl crate::Writable for AxiIni3FnModSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AXI_INI3_FN_MOD to value 0x04"]
impl crate::Resettable for AxiIni3FnModSpec {

#[doc = "Register `RTC_BKP5R` reader"]
pub type R = crate::R<RtcBkp5rSpec>;
#[doc = "Register `RTC_BKP5R` writer"]
pub type W = crate::W<RtcBkp5rSpec>;
...
impl W {
    #[doc = "Bits 0:31 - The application can write or read data to and from these registers. They are powered-on by VBAT when VDD is switched off, so that they are not reset by System reset, and their contents remain valid when the device operates in low-power mode. This register is reset on a tamper detection event, as long as TAMPxF=1. or when the Flash readout protection is disabled."]
    #[inline(always)]
    pub fn bkp(&mut self) -> BkpW<RtcBkp5rSpec> {
        BkpW::new(self, 0)
    }
}
#[doc = "RTC backup registers\n\nYou can [`read`](crate::Reg::read) this register and get [`rtc_bkp5r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_bkp5r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RtcBkp5rSpec;
impl crate::RegisterSpec for RtcBkp5rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtc_bkp5r::R`](R) reader structure"]
impl crate::Readable for RtcBkp5rSpec {}
#[doc = "`write(|w| ..)` method takes [`rtc_bkp5r::W`](W) writer structure"]
impl crate::Writable for RtcBkp5rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RTC_BKP5R to value 0"]
impl crate::Resettable for RtcBkp5rSpec {}

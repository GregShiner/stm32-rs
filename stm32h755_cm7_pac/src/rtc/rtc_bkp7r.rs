#[doc = "Register `RTC_BKP7R` reader"]
pub type R = crate::R<RtcBkp7rSpec>;
#[doc = "Register `RTC_BKP7R` writer"]
pub type W = crate::W<RtcBkp7rSpec>;
...
impl W {
    #[doc = "Bits 0:31 - The application can write or read data to and from these registers. They are powered-on by VBAT when VDD is switched off, so that they are not reset by System reset, and their contents remain valid when the device operates in low-power mode. This register is reset on a tamper detection event, as long as TAMPxF=1. or when the Flash readout protection is disabled."]
    #[inline(always)]
    pub fn bkp(&mut self) -> BkpW<RtcBkp7rSpec> {
        BkpW::new(self, 0)
    }
}
#[doc = "RTC backup registers\n\nYou can [`read`](crate::Reg::read) this register and get [`rtc_bkp7r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_bkp7r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RtcBkp7rSpec;
impl crate::RegisterSpec for RtcBkp7rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtc_bkp7r::R`](R) reader structure"]
impl crate::Readable for RtcBkp7rSpec {}
#[doc = "`write(|w| ..)` method takes [`rtc_bkp7r::W`](W) writer structure"]
impl crate::Writable for RtcBkp7rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RTC_BKP7R to value 0"]
impl crate::Resettable for RtcBkp7rSpec {}

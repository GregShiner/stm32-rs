...
pub type R = crate::R<MdmaC9esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c9esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC9esrSpec;
impl crate::RegisterSpec for MdmaC9esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c9esr::R`](R) reader structure"]
impl crate::Readable for MdmaC9esrSpec {}
#[doc = "`reset()` method sets MDMA_C9ESR to value 0"]
impl crate::Resettable for MdmaC9esrSpec {}

...
pub type R = crate::R<MdmaC8esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c8esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC8esrSpec;
impl crate::RegisterSpec for MdmaC8esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c8esr::R`](R) reader structure"]
impl crate::Readable for MdmaC8esrSpec {}
#[doc = "`reset()` method sets MDMA_C8ESR to value 0"]
impl crate::Resettable for MdmaC8esrSpec {}

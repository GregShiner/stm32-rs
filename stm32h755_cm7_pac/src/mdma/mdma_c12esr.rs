...
pub type R = crate::R<MdmaC12esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c12esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC12esrSpec;
impl crate::RegisterSpec for MdmaC12esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c12esr::R`](R) reader structure"]
impl crate::Readable for MdmaC12esrSpec {}
#[doc = "`reset()` method sets MDMA_C12ESR to value 0"]
impl crate::Resettable for MdmaC12esrSpec {}

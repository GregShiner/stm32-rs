...
pub type R = crate::R<MdmaC14esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c14esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC14esrSpec;
impl crate::RegisterSpec for MdmaC14esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c14esr::R`](R) reader structure"]
impl crate::Readable for MdmaC14esrSpec {}
#[doc = "`reset()` method sets MDMA_C14ESR to value 0"]
impl crate::Resettable for MdmaC14esrSpec {}

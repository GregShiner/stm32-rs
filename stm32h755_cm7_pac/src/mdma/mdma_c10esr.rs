...
pub type R = crate::R<MdmaC10esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c10esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC10esrSpec;
impl crate::RegisterSpec for MdmaC10esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c10esr::R`](R) reader structure"]
impl crate::Readable for MdmaC10esrSpec {}
#[doc = "`reset()` method sets MDMA_C10ESR to value 0"]
impl crate::Resettable for MdmaC10esrSpec {}

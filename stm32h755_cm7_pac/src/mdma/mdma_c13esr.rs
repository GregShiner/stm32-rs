...
pub type R = crate::R<MdmaC13esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c13esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC13esrSpec;
impl crate::RegisterSpec for MdmaC13esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c13esr::R`](R) reader structure"]
impl crate::Readable for MdmaC13esrSpec {}
#[doc = "`reset()` method sets MDMA_C13ESR to value 0"]
impl crate::Resettable for MdmaC13esrSpec {}

...
pub type R = crate::R<MdmaC4esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c4esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC4esrSpec;
impl crate::RegisterSpec for MdmaC4esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c4esr::R`](R) reader structure"]
impl crate::Readable for MdmaC4esrSpec {}
#[doc = "`reset()` method sets MDMA_C4ESR to value 0"]
impl crate::Resettable for MdmaC4esrSpec {}

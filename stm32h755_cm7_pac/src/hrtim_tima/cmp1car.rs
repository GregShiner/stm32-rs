...
pub type R = crate::R<Cmp1carSpec>;
#[doc = "Register `CMP1CAR` writer"]
pub type W = crate::W<Cmp1carSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Timerx Compare 1 value"]
    #[inline(always)]
    pub fn cmp1x(&mut self) -> Cmp1xW<Cmp1carSpec> {
        Cmp1xW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Timerx Repetition value (aliased from HRTIM_REPx register)"]
    #[inline(always)]
    pub fn repx(&mut self) -> RepxW<Cmp1carSpec> {
        RepxW::new(self, 16)
    }
}
...
pub struct Cmp1carSpec;
impl crate::RegisterSpec for Cmp1carSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1car::R`](R) reader structure"]
impl crate::Readable for Cmp1carSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1car::W`](W) writer structure"]
impl crate::Writable for Cmp1carSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CMP1CAR to value 0"]
impl crate::Resettable for Cmp1carSpec {}

...
pub type R = crate::R<Cmp1arSpec>;
#[doc = "Register `CMP1AR` writer"]
pub type W = crate::W<Cmp1arSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Timerx Compare 1 value"]
    #[inline(always)]
    pub fn cmp1x(&mut self) -> Cmp1xW<Cmp1arSpec> {
        Cmp1xW::new(self, 0)
    }
}
...
pub struct Cmp1arSpec;
impl crate::RegisterSpec for Cmp1arSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1ar::R`](R) reader structure"]
impl crate::Readable for Cmp1arSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1ar::W`](W) writer structure"]
impl crate::Writable for Cmp1arSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CMP1AR to value 0"]
impl crate::Resettable for Cmp1arSpec {}

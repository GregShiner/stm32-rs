...
#[doc = "Field `TI2SEL` reader - TI2\\[0\\] to TI2\\[15\\] input selection"]
pub type Ti2selR = crate::FieldReader;
#[doc = "Field `TI2SEL` writer - TI2\\[0\\] to TI2\\[15\\] input selection"]
pub type Ti2selW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TI3SEL` reader - TI3\\[0\\] to TI3\\[15\\] input selection"]
pub type Ti3selR = crate::FieldReader;
#[doc = "Field `TI3SEL` writer - TI3\\[0\\] to TI3\\[15\\] input selection"]
pub type Ti3selW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TI4SEL` reader - TI4\\[0\\] to TI4\\[15\\] input selection"]
pub type Ti4selR = crate::FieldReader;
#[doc = "Field `TI4SEL` writer - TI4\\[0\\] to TI4\\[15\\] input selection"]

...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tim17_af1(&self) -> &Tim17Af1 {
        &self.tim17_af1
    }
    #[doc = "0x68 - TIM17 input selection register"]
    #[inline(always)]
    pub const fn tim17_tisel(&self) -> &Tim17Tisel {
        &self.tim17_tisel
    }
}
...
#[doc(alias = "TIM17_AF1")]
pub type Tim17Af1 = crate::Reg<tim17_af1::Tim17Af1Spec>;
...
#[doc(alias = "TIM17_TISEL")]
pub type Tim17Tisel = crate::Reg<tim17_tisel::Tim17TiselSpec>;

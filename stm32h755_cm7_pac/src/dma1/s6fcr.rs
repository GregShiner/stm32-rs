...
pub type R = crate::R<S6fcrSpec>;
#[doc = "Register `S6FCR` writer"]
pub type W = crate::W<S6fcrSpec>;
...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fth(&mut self) -> FthW<S6fcrSpec> {
        FthW::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    pub fn dmdis(&mut self) -> DmdisW<S6fcrSpec> {
        DmdisW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn feie(&mut self) -> FeieW<S6fcrSpec> {
        FeieW::new(self, 7)
    }
}
...
pub struct S6fcrSpec;
impl crate::RegisterSpec for S6fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6fcr::R`](R) reader structure"]
impl crate::Readable for S6fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`s6fcr::W`](W) writer structure"]
impl crate::Writable for S6fcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S6FCR to value 0x21"]
impl crate::Resettable for S6fcrSpec {

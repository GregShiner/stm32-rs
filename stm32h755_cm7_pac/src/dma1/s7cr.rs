...
pub type R = crate::R<S7crSpec>;
#[doc = "Register `S7CR` writer"]
pub type W = crate::W<S7crSpec>;
...
impl W {
    #[doc = "Bit 0 - Stream enable / flag stream ready when read low"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<S7crSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    pub fn dmeie(&mut self) -> DmeieW<S7crSpec> {
        DmeieW::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    pub fn teie(&mut self) -> TeieW<S7crSpec> {
        TeieW::new(self, 2)
    }
    #[doc = "Bit 3 - Half transfer interrupt enable"]
    #[inline(always)]
    pub fn htie(&mut self) -> HtieW<S7crSpec> {
        HtieW::new(self, 3)
    }
    #[doc = "Bit 4 - Transfer complete interrupt enable"]
    #[inline(always)]
    pub fn tcie(&mut self) -> TcieW<S7crSpec> {
        TcieW::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    pub fn pfctrl(&mut self) -> PfctrlW<S7crSpec> {
        PfctrlW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    pub fn dir(&mut self) -> DirW<S7crSpec> {
        DirW::new(self, 6)
    }
    #[doc = "Bit 8 - Circular mode"]
    #[inline(always)]
    pub fn circ(&mut self) -> CircW<S7crSpec> {
        CircW::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    pub fn pinc(&mut self) -> PincW<S7crSpec> {
        PincW::new(self, 9)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    pub fn minc(&mut self) -> MincW<S7crSpec> {
        MincW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Peripheral data size"]
    #[inline(always)]
    pub fn psize(&mut self) -> PsizeW<S7crSpec> {
        PsizeW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Memory data size"]
    #[inline(always)]
    pub fn msize(&mut self) -> MsizeW<S7crSpec> {
        MsizeW::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    pub fn pincos(&mut self) -> PincosW<S7crSpec> {
        PincosW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Priority level"]
    #[inline(always)]
    pub fn pl(&mut self) -> PlW<S7crSpec> {
        PlW::new(self, 16)
    }
    #[doc = "Bit 18 - Double buffer mode"]
    #[inline(always)]
    pub fn dbm(&mut self) -> DbmW<S7crSpec> {
        DbmW::new(self, 18)
    }
    #[doc = "Bit 19 - Current target (only in double buffer mode)"]
    #[inline(always)]
    pub fn ct(&mut self) -> CtW<S7crSpec> {
        CtW::new(self, 19)
    }
    #[doc = "Bit 20 - ACK"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<S7crSpec> {
        AckW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Peripheral burst transfer configuration"]
    #[inline(always)]
    pub fn pburst(&mut self) -> PburstW<S7crSpec> {
        PburstW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Memory burst transfer configuration"]
    #[inline(always)]
    pub fn mburst(&mut self) -> MburstW<S7crSpec> {
        MburstW::new(self, 23)
    }
}
#[doc = "stream x configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`s7cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s7cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S7crSpec;
impl crate::RegisterSpec for S7crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s7cr::R`](R) reader structure"]
impl crate::Readable for S7crSpec {}
#[doc = "`write(|w| ..)` method takes [`s7cr::W`](W) writer structure"]
impl crate::Writable for S7crSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S7CR to value 0"]
impl crate::Resettable for S7crSpec {}

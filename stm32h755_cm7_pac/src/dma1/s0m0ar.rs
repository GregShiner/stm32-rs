#[doc = "Register `S0M0AR` reader"]
pub type R = crate::R<S0m0arSpec>;
#[doc = "Register `S0M0AR` writer"]
pub type W = crate::W<S0m0arSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Memory 0 address"]
    #[inline(always)]
    pub fn m0a(&mut self) -> M0aW<S0m0arSpec> {
        M0aW::new(self, 0)
    }
}
...
pub struct S0m0arSpec;
impl crate::RegisterSpec for S0m0arSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s0m0ar::R`](R) reader structure"]
impl crate::Readable for S0m0arSpec {}
#[doc = "`write(|w| ..)` method takes [`s0m0ar::W`](W) writer structure"]
impl crate::Writable for S0m0arSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S0M0AR to value 0"]
impl crate::Resettable for S0m0arSpec {}

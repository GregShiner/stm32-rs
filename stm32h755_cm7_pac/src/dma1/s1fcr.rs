...
pub type R = crate::R<S1fcrSpec>;
#[doc = "Register `S1FCR` writer"]
pub type W = crate::W<S1fcrSpec>;
...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fth(&mut self) -> FthW<S1fcrSpec> {
        FthW::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    pub fn dmdis(&mut self) -> DmdisW<S1fcrSpec> {
        DmdisW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn feie(&mut self) -> FeieW<S1fcrSpec> {
        FeieW::new(self, 7)
    }
}
...
pub struct S1fcrSpec;
impl crate::RegisterSpec for S1fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1fcr::R`](R) reader structure"]
impl crate::Readable for S1fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`s1fcr::W`](W) writer structure"]
impl crate::Writable for S1fcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S1FCR to value 0x21"]
impl crate::Resettable for S1fcrSpec {

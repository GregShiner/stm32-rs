...
pub type R = crate::R<S7m1arSpec>;
#[doc = "Register `S7M1AR` writer"]
pub type W = crate::W<S7m1arSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Memory 1 address (used in case of Double buffer mode)"]
    #[inline(always)]
    pub fn m1a(&mut self) -> M1aW<S7m1arSpec> {
        M1aW::new(self, 0)
    }
}
...
pub struct S7m1arSpec;
impl crate::RegisterSpec for S7m1arSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s7m1ar::R`](R) reader structure"]
impl crate::Readable for S7m1arSpec {}
#[doc = "`write(|w| ..)` method takes [`s7m1ar::W`](W) writer structure"]
impl crate::Writable for S7m1arSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S7M1AR to value 0"]
impl crate::Resettable for S7m1arSpec {}

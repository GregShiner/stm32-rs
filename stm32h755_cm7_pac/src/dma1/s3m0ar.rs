...
pub type R = crate::R<S3m0arSpec>;
#[doc = "Register `S3M0AR` writer"]
pub type W = crate::W<S3m0arSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Memory 0 address"]
    #[inline(always)]
    pub fn m0a(&mut self) -> M0aW<S3m0arSpec> {
        M0aW::new(self, 0)
    }
}
...
pub struct S3m0arSpec;
impl crate::RegisterSpec for S3m0arSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s3m0ar::R`](R) reader structure"]
impl crate::Readable for S3m0arSpec {}
#[doc = "`write(|w| ..)` method takes [`s3m0ar::W`](W) writer structure"]
impl crate::Writable for S3m0arSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S3M0AR to value 0"]
impl crate::Resettable for S3m0arSpec {}

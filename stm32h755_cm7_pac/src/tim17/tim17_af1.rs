...
pub type R = crate::R<Tim17Af1Spec>;
#[doc = "Register `TIM17_AF1` writer"]
pub type W = crate::W<Tim17Af1Spec>;
...
impl W {
    #[doc = "Bit 0 - BRK BKIN input enable"]
    #[inline(always)]
    pub fn bkine(&mut self) -> BkineW<Tim17Af1Spec> {
        BkineW::new(self, 0)
    }
    #[doc = "Bit 1 - BRK COMP1 enable"]
    #[inline(always)]
    pub fn bkcmp1e(&mut self) -> Bkcmp1eW<Tim17Af1Spec> {
        Bkcmp1eW::new(self, 1)
    }
    #[doc = "Bit 2 - BRK COMP2 enable"]
    #[inline(always)]
    pub fn bkcmp2e(&mut self) -> Bkcmp2eW<Tim17Af1Spec> {
        Bkcmp2eW::new(self, 2)
    }
    #[doc = "Bit 8 - BRK dfsdm1_break\\[1\\] enable"]
    #[inline(always)]
    pub fn bkdfbk1e(&mut self) -> Bkdfbk1eW<Tim17Af1Spec> {
        Bkdfbk1eW::new(self, 8)
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
    pub fn bkinp(&mut self) -> BkinpW<Tim17Af1Spec> {
        BkinpW::new(self, 9)
    }
    #[doc = "Bit 10 - BRK COMP1 input polarity"]
    #[inline(always)]
    pub fn bkcmp1p(&mut self) -> Bkcmp1pW<Tim17Af1Spec> {
        Bkcmp1pW::new(self, 10)
    }
    #[doc = "Bit 11 - BRK COMP2 input polarity"]
    #[inline(always)]
    pub fn bkcmp2p(&mut self) -> Bkcmp2pW<Tim17Af1Spec> {
...
pub struct Tim17Af1Spec;
impl crate::RegisterSpec for Tim17Af1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tim17_af1::R`](R) reader structure"]
impl crate::Readable for Tim17Af1Spec {}
#[doc = "`write(|w| ..)` method takes [`tim17_af1::W`](W) writer structure"]
impl crate::Writable for Tim17Af1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIM17_AF1 to value 0"]
impl crate::Resettable for Tim17Af1Spec {}

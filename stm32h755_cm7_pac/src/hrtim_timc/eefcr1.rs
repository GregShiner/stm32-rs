...
pub type R = crate::R<Eefcr1Spec>;
#[doc = "Register `EEFCR1` writer"]
pub type W = crate::W<Eefcr1Spec>;
...
impl W {
    #[doc = "Bit 0 - External Event 1 latch"]
    #[inline(always)]
    pub fn ee1ltch(&mut self) -> Ee1ltchW<Eefcr1Spec> {
        Ee1ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 1 filter"]
    #[inline(always)]
    pub fn ee1fltr(&mut self) -> Ee1fltrW<Eefcr1Spec> {
        Ee1fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 2 latch"]
    #[inline(always)]
    pub fn ee2ltch(&mut self) -> Ee2ltchW<Eefcr1Spec> {
        Ee2ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 2 filter"]
    #[inline(always)]
    pub fn ee2fltr(&mut self) -> Ee2fltrW<Eefcr1Spec> {
        Ee2fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 3 latch"]
    #[inline(always)]
    pub fn ee3ltch(&mut self) -> Ee3ltchW<Eefcr1Spec> {
        Ee3ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 3 filter"]
    #[inline(always)]
    pub fn ee3fltr(&mut self) -> Ee3fltrW<Eefcr1Spec> {
        Ee3fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 4 latch"]
    #[inline(always)]
    pub fn ee4ltch(&mut self) -> Ee4ltchW<Eefcr1Spec> {
        Ee4ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 4 filter"]
    #[inline(always)]
    pub fn ee4fltr(&mut self) -> Ee4fltrW<Eefcr1Spec> {
        Ee4fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 5 latch"]
    #[inline(always)]
    pub fn ee5ltch(&mut self) -> Ee5ltchW<Eefcr1Spec> {
        Ee5ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 5 filter"]
    #[inline(always)]
    pub fn ee5fltr(&mut self) -> Ee5fltrW<Eefcr1Spec> {
...
pub struct Eefcr1Spec;
impl crate::RegisterSpec for Eefcr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eefcr1::R`](R) reader structure"]
impl crate::Readable for Eefcr1Spec {}
#[doc = "`write(|w| ..)` method takes [`eefcr1::W`](W) writer structure"]
impl crate::Writable for Eefcr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EEFCR1 to value 0"]
impl crate::Resettable for Eefcr1Spec {}

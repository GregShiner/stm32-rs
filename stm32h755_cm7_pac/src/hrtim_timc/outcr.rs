...
pub type R = crate::R<OutcrSpec>;
#[doc = "Register `OUTCR` writer"]
pub type W = crate::W<OutcrSpec>;
...
impl W {
    #[doc = "Bit 1 - Output 1 polarity"]
    #[inline(always)]
    pub fn pol1(&mut self) -> Pol1W<OutcrSpec> {
        Pol1W::new(self, 1)
    }
    #[doc = "Bit 2 - Output 1 Idle mode"]
    #[inline(always)]
    pub fn idlem1(&mut self) -> Idlem1W<OutcrSpec> {
        Idlem1W::new(self, 2)
    }
    #[doc = "Bit 3 - Output 1 Idle State"]
    #[inline(always)]
    pub fn idles1(&mut self) -> Idles1W<OutcrSpec> {
        Idles1W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Output 1 Fault state"]
    #[inline(always)]
    pub fn fault1(&mut self) -> Fault1W<OutcrSpec> {
        Fault1W::new(self, 4)
    }
    #[doc = "Bit 6 - Output 1 Chopper enable"]
    #[inline(always)]
    pub fn chp1(&mut self) -> Chp1W<OutcrSpec> {
        Chp1W::new(self, 6)
    }
    #[doc = "Bit 7 - Output 1 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    pub fn didl1(&mut self) -> Didl1W<OutcrSpec> {
        Didl1W::new(self, 7)
    }
    #[doc = "Bit 8 - Deadtime enable"]
    #[inline(always)]
    pub fn dten(&mut self) -> DtenW<OutcrSpec> {
        DtenW::new(self, 8)
    }
    #[doc = "Bit 9 - Delayed Protection Enable"]
    #[inline(always)]
    pub fn dlyprten(&mut self) -> DlyprtenW<OutcrSpec> {
        DlyprtenW::new(self, 9)
    }
    #[doc = "Bits 10:12 - Delayed Protection"]
    #[inline(always)]
    pub fn dlyprt(&mut self) -> DlyprtW<OutcrSpec> {
        DlyprtW::new(self, 10)
    }
    #[doc = "Bit 17 - Output 2 polarity"]
    #[inline(always)]
    pub fn pol2(&mut self) -> Pol2W<OutcrSpec> {
        Pol2W::new(self, 17)
    }
    #[doc = "Bit 18 - Output 2 Idle mode"]
    #[inline(always)]
    pub fn idlem2(&mut self) -> Idlem2W<OutcrSpec> {
        Idlem2W::new(self, 18)
    }
    #[doc = "Bit 19 - Output 2 Idle State"]
    #[inline(always)]
    pub fn idles2(&mut self) -> Idles2W<OutcrSpec> {
        Idles2W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Output 2 Fault state"]
    #[inline(always)]
    pub fn fault2(&mut self) -> Fault2W<OutcrSpec> {
        Fault2W::new(self, 20)
    }
    #[doc = "Bit 22 - Output 2 Chopper enable"]
    #[inline(always)]
    pub fn chp2(&mut self) -> Chp2W<OutcrSpec> {
        Chp2W::new(self, 22)
    }
    #[doc = "Bit 23 - Output 2 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    pub fn didl2(&mut self) -> Didl2W<OutcrSpec> {
        Didl2W::new(self, 23)
    }
}
#[doc = "Timerx Output Register\n\nYou can [`read`](crate::Reg::read) this register and get [`outcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`outcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OutcrSpec;
impl crate::RegisterSpec for OutcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`outcr::R`](R) reader structure"]
impl crate::Readable for OutcrSpec {}
#[doc = "`write(|w| ..)` method takes [`outcr::W`](W) writer structure"]
impl crate::Writable for OutcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OUTCR to value 0"]
impl crate::Resettable for OutcrSpec {}

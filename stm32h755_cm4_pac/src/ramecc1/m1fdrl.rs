...
impl W {
    #[doc = "Bit 2 - ECC single error interrupt enable"]
    #[inline(always)]
    pub fn eccseie(&mut self) -> EccseieW<M1fdrlSpec> {
        EccseieW::new(self, 2)
    }
    #[doc = "Bit 3 - ECC double error interrupt enable"]
    #[inline(always)]
    pub fn eccdeie(&mut self) -> EccdeieW<M1fdrlSpec> {
        EccdeieW::new(self, 3)
    }
    #[doc = "Bit 4 - ECC double error on byte write (BW) interrupt enable"]
    #[inline(always)]
    pub fn eccdebwie(&mut self) -> EccdebwieW<M1fdrlSpec> {
        EccdebwieW::new(self, 4)
    }
    #[doc = "Bit 5 - ECC error latching enable"]
    #[inline(always)]
    pub fn eccelen(&mut self) -> EccelenW<M1fdrlSpec> {
        EccelenW::new(self, 5)
    }
}
...
impl crate::Writable for M1fdrlSpec {

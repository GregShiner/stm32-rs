...
impl W {
    #[doc = "Bit 0 - ECC single error detected and corrected flag"]
    #[inline(always)]
    pub fn sedcf(&mut self) -> SedcfW<M2fdrlSpec> {
        SedcfW::new(self, 0)
    }
    #[doc = "Bit 1 - ECC double error detected flag"]
    #[inline(always)]
    pub fn dedf(&mut self) -> DedfW<M2fdrlSpec> {
        DedfW::new(self, 1)
    }
    #[doc = "Bit 2 - ECC double error on byte write (BW) detected flag"]
    #[inline(always)]
    pub fn debwdf(&mut self) -> DebwdfW<M2fdrlSpec> {
        DebwdfW::new(self, 2)
    }
}
...
impl crate::Writable for M2fdrlSpec {

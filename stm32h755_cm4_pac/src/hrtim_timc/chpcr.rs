...
pub type R = crate::R<ChpcrSpec>;
#[doc = "Register `CHPCR` writer"]
pub type W = crate::W<ChpcrSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Timerx carrier frequency value"]
    #[inline(always)]
    pub fn chpfrq(&mut self) -> ChpfrqW<ChpcrSpec> {
        ChpfrqW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Timerx chopper duty cycle value"]
    #[inline(always)]
    pub fn chpdty(&mut self) -> ChpdtyW<ChpcrSpec> {
        ChpdtyW::new(self, 4)
    }
    #[doc = "Bits 7:10 - STRTPW"]
    #[inline(always)]
    pub fn strtpw(&mut self) -> StrtpwW<ChpcrSpec> {
        StrtpwW::new(self, 7)
    }
}
#[doc = "Timerx Chopper Register\n\nYou can [`read`](crate::Reg::read) this register and get [`chpcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chpcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ChpcrSpec;
impl crate::RegisterSpec for ChpcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`chpcr::R`](R) reader structure"]
impl crate::Readable for ChpcrSpec {}
#[doc = "`write(|w| ..)` method takes [`chpcr::W`](W) writer structure"]
impl crate::Writable for ChpcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CHPCR to value 0"]
impl crate::Resettable for ChpcrSpec {}

...
pub type R = crate::R<Confrn3Spec>;
#[doc = "Register `CONFRN3` writer"]
pub type W = crate::W<Confrn3Spec>;
...
impl W {
    #[doc = "Bit 0 - Huffman DC Selects the Huffman table for encoding the DC coefficients."]
    #[inline(always)]
    pub fn hd(&mut self) -> HdW<Confrn3Spec> {
        HdW::new(self, 0)
    }
    #[doc = "Bit 1 - Huffman AC Selects the Huffman table for encoding the AC coefficients."]
    #[inline(always)]
    pub fn ha(&mut self) -> HaW<Confrn3Spec> {
        HaW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Quantization Table Selects quantization table associated with a color component."]
    #[inline(always)]
    pub fn qt(&mut self) -> QtW<Confrn3Spec> {
        QtW::new(self, 2)
    }
    #[doc = "Bits 4:7 - Number of Block Number of data units minus 1 that belong to a particular color in the MCU."]
    #[inline(always)]
    pub fn nb(&mut self) -> NbW<Confrn3Spec> {
        NbW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Vertical Sampling Factor Vertical sampling factor for component i."]
    #[inline(always)]
    pub fn vsf(&mut self) -> VsfW<Confrn3Spec> {
        VsfW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Horizontal Sampling Factor Horizontal sampling factor for component i."]
    #[inline(always)]
    pub fn hsf(&mut self) -> HsfW<Confrn3Spec> {
        HsfW::new(self, 12)
    }
}
#[doc = "JPEG codec configuration register 4-7\n\nYou can [`read`](crate::Reg::read) this register and get [`confrn3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`confrn3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Confrn3Spec;
impl crate::RegisterSpec for Confrn3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`confrn3::R`](R) reader structure"]
impl crate::Readable for Confrn3Spec {}
#[doc = "`write(|w| ..)` method takes [`confrn3::W`](W) writer structure"]
impl crate::Writable for Confrn3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CONFRN3 to value 0"]
impl crate::Resettable for Confrn3Spec {}

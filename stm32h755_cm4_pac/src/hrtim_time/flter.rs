...
pub type R = crate::R<FlterSpec>;
#[doc = "Register `FLTER` writer"]
pub type W = crate::W<FlterSpec>;
...
impl W {
    #[doc = "Bit 0 - Fault 1 enable"]
    #[inline(always)]
    pub fn flt1en(&mut self) -> Flt1enW<FlterSpec> {
        Flt1enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 2 enable"]
    #[inline(always)]
    pub fn flt2en(&mut self) -> Flt2enW<FlterSpec> {
        Flt2enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 3 enable"]
    #[inline(always)]
    pub fn flt3en(&mut self) -> Flt3enW<FlterSpec> {
        Flt3enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 4 enable"]
    #[inline(always)]
    pub fn flt4en(&mut self) -> Flt4enW<FlterSpec> {
        Flt4enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 5 enable"]
    #[inline(always)]
    pub fn flt5en(&mut self) -> Flt5enW<FlterSpec> {
        Flt5enW::new(self, 4)
    }
    #[doc = "Bit 31 - Fault sources Lock"]
    #[inline(always)]
    pub fn fltlck(&mut self) -> FltlckW<FlterSpec> {
        FltlckW::new(self, 31)
    }
}
...
pub struct FlterSpec;
impl crate::RegisterSpec for FlterSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flter::R`](R) reader structure"]
impl crate::Readable for FlterSpec {}
#[doc = "`write(|w| ..)` method takes [`flter::W`](W) writer structure"]
impl crate::Writable for FlterSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLTER to value 0"]
impl crate::Resettable for FlterSpec {}

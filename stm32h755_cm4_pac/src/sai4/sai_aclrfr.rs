...
pub type W = crate::W<SaiAclrfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn covrudr(&mut self) -> CovrudrW<SaiAclrfrSpec> {
        CovrudrW::new(self, 0)
    }
    ...
    #[inline(always)]
    pub fn cmutedet(&mut self) -> CmutedetW<SaiAclrfrSpec> {
    ...
    #[inline(always)]
    pub fn cwckcfg(&mut self) -> CwckcfgW<SaiAclrfrSpec> {
        CwckcfgW::new(self, 2)
    }
    ...
    #[inline(always)]
    pub fn ccnrdy(&mut self) -> CcnrdyW<SaiAclrfrSpec> {
        CcnrdyW::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn cafsdet(&mut self) -> CafsdetW<SaiAclrfrSpec> {
        CafsdetW::new(self, 5)
    }
    ...
    #[inline(always)]
    pub fn clfsdet(&mut self) -> ClfsdetW<SaiAclrfrSpec> {
        ClfsdetW::new(self, 6)
    }
}
#[doc = "Clear flag register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sai_aclrfr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SaiAclrfrSpec;
impl crate::RegisterSpec for SaiAclrfrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`sai_aclrfr::W`](W) writer structure"]
impl crate::Writable for SaiAclrfrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SAI_ACLRFR to value 0"]
impl crate::Resettable for SaiAclrfrSpec {}

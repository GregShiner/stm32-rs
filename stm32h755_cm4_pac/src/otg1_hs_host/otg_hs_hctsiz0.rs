...
pub type R = crate::R<OtgHsHctsiz0Spec>;
#[doc = "Register `OTG_HS_HCTSIZ0` writer"]
pub type W = crate::W<OtgHsHctsiz0Spec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer size"]
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XfrsizW<OtgHsHctsiz0Spec> {
        XfrsizW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<OtgHsHctsiz0Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    pub fn dpid(&mut self) -> DpidW<OtgHsHctsiz0Spec> {
        DpidW::new(self, 29)
    }
}
#[doc = "OTG_HS host channel-11 transfer size register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hctsiz0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hctsiz0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHctsiz0Spec;
impl crate::RegisterSpec for OtgHsHctsiz0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hctsiz0::R`](R) reader structure"]
impl crate::Readable for OtgHsHctsiz0Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hctsiz0::W`](W) writer structure"]
impl crate::Writable for OtgHsHctsiz0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCTSIZ0 to value 0"]
impl crate::Resettable for OtgHsHctsiz0Spec {}

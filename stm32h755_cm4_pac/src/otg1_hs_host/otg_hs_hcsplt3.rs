#[doc = "Register `OTG_HS_HCSPLT3` reader"]
pub type R = crate::R<OtgHsHcsplt3Spec>;
#[doc = "Register `OTG_HS_HCSPLT3` writer"]
pub type W = crate::W<OtgHsHcsplt3Spec>;
...
impl W {
    #[doc = "Bits 0:6 - Port address"]
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PrtaddrW<OtgHsHcsplt3Spec> {
        PrtaddrW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Hub address"]
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HubaddrW<OtgHsHcsplt3Spec> {
        HubaddrW::new(self, 7)
    }
    #[doc = "Bits 14:15 - XACTPOS"]
    #[inline(always)]
    pub fn xactpos(&mut self) -> XactposW<OtgHsHcsplt3Spec> {
        XactposW::new(self, 14)
    }
    #[doc = "Bit 16 - Do complete split"]
    #[inline(always)]
    pub fn complsplt(&mut self) -> ComplspltW<OtgHsHcsplt3Spec> {
        ComplspltW::new(self, 16)
    }
    #[doc = "Bit 31 - Split enable"]
    #[inline(always)]
    pub fn spliten(&mut self) -> SplitenW<OtgHsHcsplt3Spec> {
        SplitenW::new(self, 31)
    }
}
#[doc = "OTG_HS host channel-3 split control register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcsplt3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcsplt3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcsplt3Spec;
impl crate::RegisterSpec for OtgHsHcsplt3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcsplt3::R`](R) reader structure"]
impl crate::Readable for OtgHsHcsplt3Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcsplt3::W`](W) writer structure"]
impl crate::Writable for OtgHsHcsplt3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCSPLT3 to value 0"]
impl crate::Resettable for OtgHsHcsplt3Spec {}

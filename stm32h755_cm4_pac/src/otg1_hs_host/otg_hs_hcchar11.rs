#[doc = "Register `OTG_HS_HCCHAR11` reader"]
pub type R = crate::R<OtgHsHcchar11Spec>;
#[doc = "Register `OTG_HS_HCCHAR11` writer"]
pub type W = crate::W<OtgHsHcchar11Spec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum packet size"]
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MpsizW<OtgHsHcchar11Spec> {
        MpsizW::new(self, 0)
    }
    #[doc = "Bits 11:14 - Endpoint number"]
    #[inline(always)]
    pub fn epnum(&mut self) -> EpnumW<OtgHsHcchar11Spec> {
        EpnumW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint direction"]
    #[inline(always)]
    pub fn epdir(&mut self) -> EpdirW<OtgHsHcchar11Spec> {
        EpdirW::new(self, 15)
    }
    #[doc = "Bit 17 - Low-speed device"]
    #[inline(always)]
    pub fn lsdev(&mut self) -> LsdevW<OtgHsHcchar11Spec> {
        LsdevW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    pub fn eptyp(&mut self) -> EptypW<OtgHsHcchar11Spec> {
        EptypW::new(self, 18)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count (EC)"]
    #[inline(always)]
    pub fn mc(&mut self) -> McW<OtgHsHcchar11Spec> {
        McW::new(self, 20)
    }
    #[doc = "Bits 22:28 - Device address"]
    #[inline(always)]
    pub fn dad(&mut self) -> DadW<OtgHsHcchar11Spec> {
        DadW::new(self, 22)
    }
    #[doc = "Bit 29 - Odd frame"]
    #[inline(always)]
    pub fn oddfrm(&mut self) -> OddfrmW<OtgHsHcchar11Spec> {
        OddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel disable"]
    #[inline(always)]
    pub fn chdis(&mut self) -> ChdisW<OtgHsHcchar11Spec> {
        ChdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel enable"]
    #[inline(always)]
    pub fn chena(&mut self) -> ChenaW<OtgHsHcchar11Spec> {
        ChenaW::new(self, 31)
    }
}
#[doc = "OTG_HS host channel-11 characteristics register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcchar11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcchar11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcchar11Spec;
impl crate::RegisterSpec for OtgHsHcchar11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcchar11::R`](R) reader structure"]
impl crate::Readable for OtgHsHcchar11Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcchar11::W`](W) writer structure"]
impl crate::Writable for OtgHsHcchar11Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCCHAR11 to value 0"]
impl crate::Resettable for OtgHsHcchar11Spec {}

#[doc = "Register `OTG_HS_HCINTMSK0` reader"]
pub type R = crate::R<OtgHsHcintmsk0Spec>;
#[doc = "Register `OTG_HS_HCINTMSK0` writer"]
pub type W = crate::W<OtgHsHcintmsk0Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed mask"]
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XfrcmW<OtgHsHcintmsk0Spec> {
        XfrcmW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted mask"]
    #[inline(always)]
    pub fn chhm(&mut self) -> ChhmW<OtgHsHcintmsk0Spec> {
        ChhmW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<OtgHsHcintmsk0Spec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    pub fn stallm(&mut self) -> StallmW<OtgHsHcintmsk0Spec> {
        StallmW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt mask"]
    #[inline(always)]
    pub fn nakm(&mut self) -> NakmW<OtgHsHcintmsk0Spec> {
        NakmW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt mask"]
    #[inline(always)]
    pub fn ackm(&mut self) -> AckmW<OtgHsHcintmsk0Spec> {
        AckmW::new(self, 5)
    }
    #[doc = "Bit 6 - response received interrupt mask"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<OtgHsHcintmsk0Spec> {
        NyetW::new(self, 6)
    }
    #[doc = "Bit 7 - Transaction error mask"]
    #[inline(always)]
    pub fn txerrm(&mut self) -> TxerrmW<OtgHsHcintmsk0Spec> {
        TxerrmW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error mask"]
    #[inline(always)]
    pub fn bberrm(&mut self) -> BberrmW<OtgHsHcintmsk0Spec> {
        BberrmW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    pub fn frmorm(&mut self) -> FrmormW<OtgHsHcintmsk0Spec> {
        FrmormW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    pub fn dterrm(&mut self) -> DterrmW<OtgHsHcintmsk0Spec> {
        DterrmW::new(self, 10)
    }
}
#[doc = "OTG_HS host channel-11 interrupt mask register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcintmsk0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcintmsk0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcintmsk0Spec;
impl crate::RegisterSpec for OtgHsHcintmsk0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcintmsk0::R`](R) reader structure"]
impl crate::Readable for OtgHsHcintmsk0Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcintmsk0::W`](W) writer structure"]
impl crate::Writable for OtgHsHcintmsk0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCINTMSK0 to value 0"]
impl crate::Resettable for OtgHsHcintmsk0Spec {}

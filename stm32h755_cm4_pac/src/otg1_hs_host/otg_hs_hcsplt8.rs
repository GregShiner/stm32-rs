#[doc = "Register `OTG_HS_HCSPLT8` reader"]
pub type R = crate::R<OtgHsHcsplt8Spec>;
#[doc = "Register `OTG_HS_HCSPLT8` writer"]
pub type W = crate::W<OtgHsHcsplt8Spec>;
...
impl W {
    #[doc = "Bits 0:6 - Port address"]
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PrtaddrW<OtgHsHcsplt8Spec> {
        PrtaddrW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Hub address"]
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HubaddrW<OtgHsHcsplt8Spec> {
        HubaddrW::new(self, 7)
    }
    #[doc = "Bits 14:15 - XACTPOS"]
    #[inline(always)]
    pub fn xactpos(&mut self) -> XactposW<OtgHsHcsplt8Spec> {
        XactposW::new(self, 14)
    }
    #[doc = "Bit 16 - Do complete split"]
    #[inline(always)]
    pub fn complsplt(&mut self) -> ComplspltW<OtgHsHcsplt8Spec> {
        ComplspltW::new(self, 16)
    }
    #[doc = "Bit 31 - Split enable"]
    #[inline(always)]
    pub fn spliten(&mut self) -> SplitenW<OtgHsHcsplt8Spec> {
        SplitenW::new(self, 31)
    }
}
#[doc = "OTG_HS host channel-8 split control register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_hcsplt8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_hcsplt8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsHcsplt8Spec;
impl crate::RegisterSpec for OtgHsHcsplt8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_hcsplt8::R`](R) reader structure"]
impl crate::Readable for OtgHsHcsplt8Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_hcsplt8::W`](W) writer structure"]
impl crate::Writable for OtgHsHcsplt8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_HCSPLT8 to value 0"]
impl crate::Resettable for OtgHsHcsplt8Spec {}

...
pub type R = crate::R<Cpuemr3Spec>;
...
#[doc = "EXTI event mask register\n\nYou can [`read`](crate::Reg::read) this register and get [`cpuemr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpuemr3Spec;
impl crate::RegisterSpec for Cpuemr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpuemr3::R`](R) reader structure"]
impl crate::Readable for Cpuemr3Spec {}
#[doc = "`reset()` method sets CPUEMR3 to value 0"]
impl crate::Resettable for Cpuemr3Spec {}

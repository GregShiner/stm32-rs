#[doc = "Register `OTG_HS_DIEPTXF6` reader"]
pub type R = crate::R<OtgHsDieptxf6Spec>;
#[doc = "Register `OTG_HS_DIEPTXF6` writer"]
pub type W = crate::W<OtgHsDieptxf6Spec>;
...
impl W {
    #[doc = "Bits 0:15 - IN endpoint FIFOx transmit RAM start address"]
    #[inline(always)]
    pub fn ineptxsa(&mut self) -> IneptxsaW<OtgHsDieptxf6Spec> {
        IneptxsaW::new(self, 0)
    }
    #[doc = "Bits 16:31 - IN endpoint TxFIFO depth"]
    #[inline(always)]
    pub fn ineptxfd(&mut self) -> IneptxfdW<OtgHsDieptxf6Spec> {
        IneptxfdW::new(self, 16)
    }
}
#[doc = "OTG_HS device IN endpoint transmit FIFO size register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_dieptxf6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_dieptxf6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDieptxf6Spec;
impl crate::RegisterSpec for OtgHsDieptxf6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_dieptxf6::R`](R) reader structure"]
impl crate::Readable for OtgHsDieptxf6Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_dieptxf6::W`](W) writer structure"]
impl crate::Writable for OtgHsDieptxf6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPTXF6 to value 0x0200_0e00"]
impl crate::Resettable for OtgHsDieptxf6Spec {

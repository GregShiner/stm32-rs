...
pub type LpmintmR = crate::BitReader;
#[doc = "Field `LPMINTM` writer - LPM interrupt mask"]
pub type LpmintmW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 23 - Reset detected interrupt mask"]
    #[inline(always)]
    pub fn rstde(&mut self) -> RstdeW<OtgHsGintmskSpec> {
        RstdeW::new(self, 23)
    }
    #[doc = "Bit 25 - Host channels interrupt mask"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - LPM interrupt mask"]
    #[inline(always)]
    pub fn lpmintm(&mut self) -> LpmintmW<OtgHsGintmskSpec> {
        LpmintmW::new(self, 27)
    }
    #[doc = "Bit 28 - Connector ID status change mask"]
    #[inline(always)]

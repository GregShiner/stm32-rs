...
pub type R = crate::R<Apb2fz2Spec>;
#[doc = "Register `APB2FZ2` writer"]
pub type W = crate::W<Apb2fz2Spec>;
...
impl W {
    #[doc = "Bit 0 - TIM1 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim1(&mut self) -> DbgTim1W<Apb2fz2Spec> {
        DbgTim1W::new(self, 0)
    }
    #[doc = "Bit 1 - TIM8 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim8(&mut self) -> DbgTim8W<Apb2fz2Spec> {
        DbgTim8W::new(self, 1)
    }
    #[doc = "Bit 16 - TIM15 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim15(&mut self) -> DbgTim15W<Apb2fz2Spec> {
        DbgTim15W::new(self, 16)
    }
    #[doc = "Bit 17 - TIM16 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim16(&mut self) -> DbgTim16W<Apb2fz2Spec> {
        DbgTim16W::new(self, 17)
    }
    #[doc = "Bit 18 - TIM17 stop in debug"]
    #[inline(always)]
    pub fn dbg_tim17(&mut self) -> DbgTim17W<Apb2fz2Spec> {
        DbgTim17W::new(self, 18)
    }
    #[doc = "Bit 29 - HRTIM stop in debug"]
    #[inline(always)]
    pub fn dbg_hrtim(&mut self) -> DbgHrtimW<Apb2fz2Spec> {
...
pub struct Apb2fz2Spec;
impl crate::RegisterSpec for Apb2fz2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2fz2::R`](R) reader structure"]
impl crate::Readable for Apb2fz2Spec {}
#[doc = "`write(|w| ..)` method takes [`apb2fz2::W`](W) writer structure"]
impl crate::Writable for Apb2fz2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB2FZ2 to value 0"]
impl crate::Resettable for Apb2fz2Spec {}

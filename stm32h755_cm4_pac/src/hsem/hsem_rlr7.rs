...
pub type R = crate::R<HsemRlr7Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr7Spec;
impl crate::RegisterSpec for HsemRlr7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr7::R`](R) reader structure"]
impl crate::Readable for HsemRlr7Spec {}
#[doc = "`reset()` method sets HSEM_RLR7 to value 0"]
impl crate::Resettable for HsemRlr7Spec {}

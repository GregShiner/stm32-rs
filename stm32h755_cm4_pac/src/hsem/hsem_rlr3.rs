...
pub type R = crate::R<HsemRlr3Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr3Spec;
impl crate::RegisterSpec for HsemRlr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr3::R`](R) reader structure"]
impl crate::Readable for HsemRlr3Spec {}
#[doc = "`reset()` method sets HSEM_RLR3 to value 0"]
impl crate::Resettable for HsemRlr3Spec {}

...
pub type R = crate::R<HsemRlr26Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr26::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr26Spec;
impl crate::RegisterSpec for HsemRlr26Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr26::R`](R) reader structure"]
impl crate::Readable for HsemRlr26Spec {}
#[doc = "`reset()` method sets HSEM_RLR26 to value 0"]
impl crate::Resettable for HsemRlr26Spec {}

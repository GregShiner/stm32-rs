...
pub type R = crate::R<HsemRlr18Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr18::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr18Spec;
impl crate::RegisterSpec for HsemRlr18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr18::R`](R) reader structure"]
impl crate::Readable for HsemRlr18Spec {}
#[doc = "`reset()` method sets HSEM_RLR18 to value 0"]
impl crate::Resettable for HsemRlr18Spec {}

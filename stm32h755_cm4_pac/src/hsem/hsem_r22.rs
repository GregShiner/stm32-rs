...
pub type R = crate::R<HsemR22Spec>;
#[doc = "Register `HSEM_R22` writer"]
pub type W = crate::W<HsemR22Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Semaphore ProcessID"]
    #[inline(always)]
    pub fn procid(&mut self) -> ProcidW<HsemR22Spec> {
        ProcidW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Semaphore COREID"]
    #[inline(always)]
    pub fn coreid(&mut self) -> CoreidW<HsemR22Spec> {
        CoreidW::new(self, 8)
    }
    #[doc = "Bit 31 - Lock indication"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<HsemR22Spec> {
        LockW::new(self, 31)
    }
}
#[doc = "HSEM register HSEM_R0 HSEM_R31\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_r22::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hsem_r22::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemR22Spec;
impl crate::RegisterSpec for HsemR22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_r22::R`](R) reader structure"]
impl crate::Readable for HsemR22Spec {}
#[doc = "`write(|w| ..)` method takes [`hsem_r22::W`](W) writer structure"]
impl crate::Writable for HsemR22Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HSEM_R22 to value 0"]
impl crate::Resettable for HsemR22Spec {}

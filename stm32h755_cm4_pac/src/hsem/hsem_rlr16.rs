...
pub type R = crate::R<HsemRlr16Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr16::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr16Spec;
impl crate::RegisterSpec for HsemRlr16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr16::R`](R) reader structure"]
impl crate::Readable for HsemRlr16Spec {}
#[doc = "`reset()` method sets HSEM_RLR16 to value 0"]
impl crate::Resettable for HsemRlr16Spec {}

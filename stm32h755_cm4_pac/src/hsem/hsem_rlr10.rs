...
pub type R = crate::R<HsemRlr10Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr10Spec;
impl crate::RegisterSpec for HsemRlr10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr10::R`](R) reader structure"]
impl crate::Readable for HsemRlr10Spec {}
#[doc = "`reset()` method sets HSEM_RLR10 to value 0"]
impl crate::Resettable for HsemRlr10Spec {}

...
pub type R = crate::R<HsemRlr19Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr19::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr19Spec;
impl crate::RegisterSpec for HsemRlr19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr19::R`](R) reader structure"]
impl crate::Readable for HsemRlr19Spec {}
#[doc = "`reset()` method sets HSEM_RLR19 to value 0"]
impl crate::Resettable for HsemRlr19Spec {}

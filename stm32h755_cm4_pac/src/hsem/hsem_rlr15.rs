...
pub type R = crate::R<HsemRlr15Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr15::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr15Spec;
impl crate::RegisterSpec for HsemRlr15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr15::R`](R) reader structure"]
impl crate::Readable for HsemRlr15Spec {}
#[doc = "`reset()` method sets HSEM_RLR15 to value 0"]
impl crate::Resettable for HsemRlr15Spec {}

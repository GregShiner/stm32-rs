...
pub type R = crate::R<HsemRlr20Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr20::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr20Spec;
impl crate::RegisterSpec for HsemRlr20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr20::R`](R) reader structure"]
impl crate::Readable for HsemRlr20Spec {}
#[doc = "`reset()` method sets HSEM_RLR20 to value 0"]
impl crate::Resettable for HsemRlr20Spec {}

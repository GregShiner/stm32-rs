...
pub type R = crate::R<HsemRlr17Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr17::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr17Spec;
impl crate::RegisterSpec for HsemRlr17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr17::R`](R) reader structure"]
impl crate::Readable for HsemRlr17Spec {}
#[doc = "`reset()` method sets HSEM_RLR17 to value 0"]
impl crate::Resettable for HsemRlr17Spec {}

...
pub type R = crate::R<HsemRlr5Spec>;
...
#[doc = "HSEM Read lock register\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_rlr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemRlr5Spec;
impl crate::RegisterSpec for HsemRlr5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_rlr5::R`](R) reader structure"]
impl crate::Readable for HsemRlr5Spec {}
#[doc = "`reset()` method sets HSEM_RLR5 to value 0"]
impl crate::Resettable for HsemRlr5Spec {}

...
pub type R = crate::R<HsemR30Spec>;
#[doc = "Register `HSEM_R30` writer"]
pub type W = crate::W<HsemR30Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Semaphore ProcessID"]
    #[inline(always)]
    pub fn procid(&mut self) -> ProcidW<HsemR30Spec> {
        ProcidW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Semaphore COREID"]
    #[inline(always)]
    pub fn coreid(&mut self) -> CoreidW<HsemR30Spec> {
        CoreidW::new(self, 8)
    }
    #[doc = "Bit 31 - Lock indication"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<HsemR30Spec> {
        LockW::new(self, 31)
    }
}
#[doc = "HSEM register HSEM_R0 HSEM_R31\n\nYou can [`read`](crate::Reg::read) this register and get [`hsem_r30::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hsem_r30::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsemR30Spec;
impl crate::RegisterSpec for HsemR30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_r30::R`](R) reader structure"]
impl crate::Readable for HsemR30Spec {}
#[doc = "`write(|w| ..)` method takes [`hsem_r30::W`](W) writer structure"]
impl crate::Writable for HsemR30Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HSEM_R30 to value 0"]
impl crate::Resettable for HsemR30Spec {}

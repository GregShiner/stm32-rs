...
pub type R = crate::R<AxiIni3FnMod2Spec>;
#[doc = "Register `AXI_INI3_FN_MOD2` writer"]
pub type W = crate::W<AxiIni3FnMod2Spec>;
...
impl W {
    #[doc = "Bit 0 - Disables alteration of transactions by the up-sizer unless required by the protocol"]
    #[inline(always)]
    pub fn bypass_merge(&mut self) -> BypassMergeW<AxiIni3FnMod2Spec> {
        BypassMergeW::new(self, 0)
    }
}
#[doc = "AXI interconnect - INI x functionality modification 2 register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_ini3_fn_mod2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_ini3_fn_mod2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AxiIni3FnMod2Spec;
impl crate::RegisterSpec for AxiIni3FnMod2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_ini3_fn_mod2::R`](R) reader structure"]
impl crate::Readable for AxiIni3FnMod2Spec {}
#[doc = "`write(|w| ..)` method takes [`axi_ini3_fn_mod2::W`](W) writer structure"]
impl crate::Writable for AxiIni3FnMod2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AXI_INI3_FN_MOD2 to value 0x04"]
impl crate::Resettable for AxiIni3FnMod2Spec {

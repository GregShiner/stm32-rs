...
pub type R = crate::R<AxiIni3FnModAhbSpec>;
#[doc = "Register `AXI_INI3_FN_MOD_AHB` writer"]
pub type W = crate::W<AxiIni3FnModAhbSpec>;
...
impl W {
    #[doc = "Bit 0 - Converts all AHB-Lite write transactions to a series of single beat AXI"]
    #[inline(always)]
    pub fn rd_inc_override(&mut self) -> RdIncOverrideW<AxiIni3FnModAhbSpec> {
        RdIncOverrideW::new(self, 0)
    }
    #[doc = "Bit 1 - Converts all AHB-Lite read transactions to a series of single beat AXI"]
    #[inline(always)]
    pub fn wr_inc_override(&mut self) -> WrIncOverrideW<AxiIni3FnModAhbSpec> {
        WrIncOverrideW::new(self, 1)
    }
}
#[doc = "AXI interconnect - INI x AHB functionality modification register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_ini3_fn_mod_ahb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_ini3_fn_mod_ahb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AxiIni3FnModAhbSpec;
impl crate::RegisterSpec for AxiIni3FnModAhbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`axi_ini3_fn_mod_ahb::R`](R) reader structure"]
impl crate::Readable for AxiIni3FnModAhbSpec {}
#[doc = "`write(|w| ..)` method takes [`axi_ini3_fn_mod_ahb::W`](W) writer structure"]
impl crate::Writable for AxiIni3FnModAhbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AXI_INI3_FN_MOD_AHB to value 0x04"]
impl crate::Resettable for AxiIni3FnModAhbSpec {

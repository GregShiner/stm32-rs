...
pub type R = crate::R<Cpt1acrSpec>;
#[doc = "Register `CPT1ACR` writer"]
pub type W = crate::W<Cpt1acrSpec>;
...
impl W {
    #[doc = "Bit 0 - Software Capture"]
    #[inline(always)]
    pub fn swcpt(&mut self) -> SwcptW<Cpt1acrSpec> {
        SwcptW::new(self, 0)
    }
    #[doc = "Bit 1 - Update Capture"]
    #[inline(always)]
    pub fn udpcpt(&mut self) -> UdpcptW<Cpt1acrSpec> {
        UdpcptW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event 1 Capture"]
    #[inline(always)]
    pub fn exev1cpt(&mut self) -> Exev1cptW<Cpt1acrSpec> {
        Exev1cptW::new(self, 2)
    }
    #[doc = "Bit 3 - External Event 2 Capture"]
    #[inline(always)]
    pub fn exev2cpt(&mut self) -> Exev2cptW<Cpt1acrSpec> {
        Exev2cptW::new(self, 3)
    }
    #[doc = "Bit 4 - External Event 3 Capture"]
    #[inline(always)]
    pub fn exev3cpt(&mut self) -> Exev3cptW<Cpt1acrSpec> {
        Exev3cptW::new(self, 4)
    }
    #[doc = "Bit 5 - External Event 4 Capture"]
    #[inline(always)]
    pub fn exev4cpt(&mut self) -> Exev4cptW<Cpt1acrSpec> {
        Exev4cptW::new(self, 5)
    }
    #[doc = "Bit 6 - External Event 5 Capture"]
    #[inline(always)]
    pub fn exev5cpt(&mut self) -> Exev5cptW<Cpt1acrSpec> {
        Exev5cptW::new(self, 6)
    }
    #[doc = "Bit 7 - External Event 6 Capture"]
    #[inline(always)]
    pub fn exev6cpt(&mut self) -> Exev6cptW<Cpt1acrSpec> {
        Exev6cptW::new(self, 7)
    }
    #[doc = "Bit 8 - External Event 7 Capture"]
    #[inline(always)]
    pub fn exev7cpt(&mut self) -> Exev7cptW<Cpt1acrSpec> {
        Exev7cptW::new(self, 8)
    }
    #[doc = "Bit 9 - External Event 8 Capture"]
    #[inline(always)]
    pub fn exev8cpt(&mut self) -> Exev8cptW<Cpt1acrSpec> {
        Exev8cptW::new(self, 9)
    }
    #[doc = "Bit 10 - External Event 9 Capture"]
    #[inline(always)]
    pub fn exev9cpt(&mut self) -> Exev9cptW<Cpt1acrSpec> {
        Exev9cptW::new(self, 10)
    }
    #[doc = "Bit 11 - External Event 10 Capture"]
    #[inline(always)]
    pub fn exev10cpt(&mut self) -> Exev10cptW<Cpt1acrSpec> {
        Exev10cptW::new(self, 11)
    }
    #[doc = "Bit 16 - Timer B output 1 Set"]
    #[inline(always)]
    pub fn tb1set(&mut self) -> Tb1setW<Cpt1acrSpec> {
        Tb1setW::new(self, 16)
    }
    #[doc = "Bit 17 - Timer B output 1 Reset"]
    #[inline(always)]
    pub fn tb1rst(&mut self) -> Tb1rstW<Cpt1acrSpec> {
        Tb1rstW::new(self, 17)
    }
    #[doc = "Bit 18 - Timer B Compare 1"]
    #[inline(always)]
    pub fn tbcmp1(&mut self) -> Tbcmp1W<Cpt1acrSpec> {
        Tbcmp1W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer B Compare 2"]
    #[inline(always)]
    pub fn tbcmp2(&mut self) -> Tbcmp2W<Cpt1acrSpec> {
        Tbcmp2W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer C output 1 Set"]
    #[inline(always)]
    pub fn tc1set(&mut self) -> Tc1setW<Cpt1acrSpec> {
        Tc1setW::new(self, 20)
    }
    #[doc = "Bit 21 - Timer C output 1 Reset"]
    #[inline(always)]
    pub fn tc1rst(&mut self) -> Tc1rstW<Cpt1acrSpec> {
        Tc1rstW::new(self, 21)
    }
    #[doc = "Bit 22 - Timer C Compare 1"]
    #[inline(always)]
    pub fn tccmp1(&mut self) -> Tccmp1W<Cpt1acrSpec> {
        Tccmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer C Compare 2"]
    #[inline(always)]
    pub fn tccmp2(&mut self) -> Tccmp2W<Cpt1acrSpec> {
        Tccmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
    pub fn td1set(&mut self) -> Td1setW<Cpt1acrSpec> {
        Td1setW::new(self, 24)
    }
    #[doc = "Bit 25 - Timer D output 1 Reset"]
    #[inline(always)]
    pub fn td1rst(&mut self) -> Td1rstW<Cpt1acrSpec> {
        Td1rstW::new(self, 25)
    }
    #[doc = "Bit 26 - Timer D Compare 1"]
    #[inline(always)]
    pub fn tdcmp1(&mut self) -> Tdcmp1W<Cpt1acrSpec> {
        Tdcmp1W::new(self, 26)
    }
    #[doc = "Bit 27 - Timer D Compare 2"]
    #[inline(always)]
    pub fn tdcmp2(&mut self) -> Tdcmp2W<Cpt1acrSpec> {
        Tdcmp2W::new(self, 27)
    }
    #[doc = "Bit 28 - Timer E output 1 Set"]
    #[inline(always)]
    pub fn te1set(&mut self) -> Te1setW<Cpt1acrSpec> {
        Te1setW::new(self, 28)
    }
    #[doc = "Bit 29 - Timer E output 1 Reset"]
    #[inline(always)]
    pub fn te1rst(&mut self) -> Te1rstW<Cpt1acrSpec> {
        Te1rstW::new(self, 29)
    }
    #[doc = "Bit 30 - Timer E Compare 1"]
    #[inline(always)]
    pub fn tecmp1(&mut self) -> Tecmp1W<Cpt1acrSpec> {
        Tecmp1W::new(self, 30)
    }
    #[doc = "Bit 31 - Timer E Compare 2"]
    #[inline(always)]
    pub fn tecmp2(&mut self) -> Tecmp2W<Cpt1acrSpec> {
        Tecmp2W::new(self, 31)
    }
}
#[doc = "Timerx Capture 2 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cpt1acr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpt1acr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpt1acrSpec;
impl crate::RegisterSpec for Cpt1acrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpt1acr::R`](R) reader structure"]
impl crate::Readable for Cpt1acrSpec {}
#[doc = "`write(|w| ..)` method takes [`cpt1acr::W`](W) writer structure"]
impl crate::Writable for Cpt1acrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CPT1ACR to value 0"]
impl crate::Resettable for Cpt1acrSpec {}

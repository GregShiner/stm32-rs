...
pub type R = crate::R<Rsta2rSpec>;
#[doc = "Register `RSTA2R` writer"]
pub type W = crate::W<Rsta2rSpec>;
#[doc = "Field `SRT` reader - SRT"]
pub type SrtR = crate::BitReader;
#[doc = "Field `SRT` writer - SRT"]
pub type SrtW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 0 - SRT"]
    #[inline(always)]
    pub fn srt(&mut self) -> SrtW<Rsta2rSpec> {
        SrtW::new(self, 0)
    }
    #[doc = "Bit 1 - RESYNC"]
    #[inline(always)]
    pub fn resync(&mut self) -> ResyncW<Rsta2rSpec> {
        ResyncW::new(self, 1)
    }
    #[doc = "Bit 2 - PER"]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<Rsta2rSpec> {
        PerW::new(self, 2)
    }
    #[doc = "Bit 3 - CMP1"]
    #[inline(always)]
    pub fn cmp1(&mut self) -> Cmp1W<Rsta2rSpec> {
        Cmp1W::new(self, 3)
    }
    #[doc = "Bit 4 - CMP2"]
    #[inline(always)]
    pub fn cmp2(&mut self) -> Cmp2W<Rsta2rSpec> {
        Cmp2W::new(self, 4)
    }
    #[doc = "Bit 5 - CMP3"]
    #[inline(always)]
    pub fn cmp3(&mut self) -> Cmp3W<Rsta2rSpec> {
        Cmp3W::new(self, 5)
    }
    #[doc = "Bit 6 - CMP4"]
    #[inline(always)]
    pub fn cmp4(&mut self) -> Cmp4W<Rsta2rSpec> {
        Cmp4W::new(self, 6)
    }
    #[doc = "Bit 7 - MSTPER"]
    #[inline(always)]
    pub fn mstper(&mut self) -> MstperW<Rsta2rSpec> {
        MstperW::new(self, 7)
    }
    #[doc = "Bit 8 - MSTCMP1"]
    #[inline(always)]
    pub fn mstcmp1(&mut self) -> Mstcmp1W<Rsta2rSpec> {
        Mstcmp1W::new(self, 8)
    }
    #[doc = "Bit 9 - MSTCMP2"]
    #[inline(always)]
    pub fn mstcmp2(&mut self) -> Mstcmp2W<Rsta2rSpec> {
        Mstcmp2W::new(self, 9)
    }
    #[doc = "Bit 10 - MSTCMP3"]
    #[inline(always)]
    pub fn mstcmp3(&mut self) -> Mstcmp3W<Rsta2rSpec> {
        Mstcmp3W::new(self, 10)
    }
    #[doc = "Bit 11 - MSTCMP4"]
    #[inline(always)]
    pub fn mstcmp4(&mut self) -> Mstcmp4W<Rsta2rSpec> {
        Mstcmp4W::new(self, 11)
    }
    #[doc = "Bit 12 - TIMEVNT1"]
    #[inline(always)]
    pub fn timevnt1(&mut self) -> Timevnt1W<Rsta2rSpec> {
        Timevnt1W::new(self, 12)
    }
    #[doc = "Bit 13 - TIMEVNT2"]
    #[inline(always)]
    pub fn timevnt2(&mut self) -> Timevnt2W<Rsta2rSpec> {
        Timevnt2W::new(self, 13)
    }
    #[doc = "Bit 14 - TIMEVNT3"]
    #[inline(always)]
    pub fn timevnt3(&mut self) -> Timevnt3W<Rsta2rSpec> {
        Timevnt3W::new(self, 14)
    }
    #[doc = "Bit 15 - TIMEVNT4"]
    #[inline(always)]
    pub fn timevnt4(&mut self) -> Timevnt4W<Rsta2rSpec> {
        Timevnt4W::new(self, 15)
    }
    #[doc = "Bit 16 - TIMEVNT5"]
    #[inline(always)]
    pub fn timevnt5(&mut self) -> Timevnt5W<Rsta2rSpec> {
        Timevnt5W::new(self, 16)
    }
    #[doc = "Bit 17 - TIMEVNT6"]
    #[inline(always)]
    pub fn timevnt6(&mut self) -> Timevnt6W<Rsta2rSpec> {
        Timevnt6W::new(self, 17)
    }
    #[doc = "Bit 18 - TIMEVNT7"]
    #[inline(always)]
    pub fn timevnt7(&mut self) -> Timevnt7W<Rsta2rSpec> {
        Timevnt7W::new(self, 18)
    }
    #[doc = "Bit 19 - TIMEVNT8"]
    #[inline(always)]
    pub fn timevnt8(&mut self) -> Timevnt8W<Rsta2rSpec> {
        Timevnt8W::new(self, 19)
    }
    #[doc = "Bit 20 - TIMEVNT9"]
    #[inline(always)]
    pub fn timevnt9(&mut self) -> Timevnt9W<Rsta2rSpec> {
        Timevnt9W::new(self, 20)
    }
    #[doc = "Bit 21 - EXTEVNT1"]
    #[inline(always)]
    pub fn extevnt1(&mut self) -> Extevnt1W<Rsta2rSpec> {
        Extevnt1W::new(self, 21)
    }
    #[doc = "Bit 22 - EXTEVNT2"]
    #[inline(always)]
    pub fn extevnt2(&mut self) -> Extevnt2W<Rsta2rSpec> {
        Extevnt2W::new(self, 22)
    }
    #[doc = "Bit 23 - EXTEVNT3"]
    #[inline(always)]
    pub fn extevnt3(&mut self) -> Extevnt3W<Rsta2rSpec> {
        Extevnt3W::new(self, 23)
    }
    #[doc = "Bit 24 - EXTEVNT4"]
    #[inline(always)]
    pub fn extevnt4(&mut self) -> Extevnt4W<Rsta2rSpec> {
        Extevnt4W::new(self, 24)
    }
    #[doc = "Bit 25 - EXTEVNT5"]
    #[inline(always)]
    pub fn extevnt5(&mut self) -> Extevnt5W<Rsta2rSpec> {
        Extevnt5W::new(self, 25)
    }
    #[doc = "Bit 26 - EXTEVNT6"]
    #[inline(always)]
    pub fn extevnt6(&mut self) -> Extevnt6W<Rsta2rSpec> {
        Extevnt6W::new(self, 26)
    }
    #[doc = "Bit 27 - EXTEVNT7"]
    #[inline(always)]
    pub fn extevnt7(&mut self) -> Extevnt7W<Rsta2rSpec> {
        Extevnt7W::new(self, 27)
    }
    #[doc = "Bit 28 - EXTEVNT8"]
    #[inline(always)]
    pub fn extevnt8(&mut self) -> Extevnt8W<Rsta2rSpec> {
        Extevnt8W::new(self, 28)
    }
    #[doc = "Bit 29 - EXTEVNT9"]
    #[inline(always)]
    pub fn extevnt9(&mut self) -> Extevnt9W<Rsta2rSpec> {
        Extevnt9W::new(self, 29)
    }
    #[doc = "Bit 30 - EXTEVNT10"]
    #[inline(always)]
    pub fn extevnt10(&mut self) -> Extevnt10W<Rsta2rSpec> {
        Extevnt10W::new(self, 30)
    }
    #[doc = "Bit 31 - UPDATE"]
    #[inline(always)]
    pub fn update(&mut self) -> UpdateW<Rsta2rSpec> {
        UpdateW::new(self, 31)
    }
}
#[doc = "Timerx Output2 Reset Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rsta2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rsta2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rsta2rSpec;
impl crate::RegisterSpec for Rsta2rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rsta2r::R`](R) reader structure"]
impl crate::Readable for Rsta2rSpec {}
#[doc = "`write(|w| ..)` method takes [`rsta2r::W`](W) writer structure"]
impl crate::Writable for Rsta2rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RSTA2R to value 0"]
impl crate::Resettable for Rsta2rSpec {}

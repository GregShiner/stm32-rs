...
pub type R = crate::R<TimaisrSpec>;
...
pub struct TimaisrSpec;
impl crate::RegisterSpec for TimaisrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timaisr::R`](R) reader structure"]
impl crate::Readable for TimaisrSpec {}
#[doc = "`reset()` method sets TIMAISR to value 0"]
impl crate::Resettable for TimaisrSpec {}

...
pub type R = crate::R<S3fcrSpec>;
#[doc = "Register `S3FCR` writer"]
pub type W = crate::W<S3fcrSpec>;
...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fth(&mut self) -> FthW<S3fcrSpec> {
        FthW::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    pub fn dmdis(&mut self) -> DmdisW<S3fcrSpec> {
        DmdisW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn feie(&mut self) -> FeieW<S3fcrSpec> {
        FeieW::new(self, 7)
    }
}
#[doc = "stream x FIFO control register\n\nYou can [`read`](crate::Reg::read) this register and get [`s3fcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s3fcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S3fcrSpec;
impl crate::RegisterSpec for S3fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s3fcr::R`](R) reader structure"]
impl crate::Readable for S3fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`s3fcr::W`](W) writer structure"]
impl crate::Writable for S3fcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets S3FCR to value 0x21"]
impl crate::Resettable for S3fcrSpec {

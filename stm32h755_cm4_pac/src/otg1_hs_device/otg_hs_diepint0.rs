#[doc = "Register `OTG_HS_DIEPINT0` reader"]
pub type R = crate::R<OtgHsDiepint0Spec>;
#[doc = "Register `OTG_HS_DIEPINT0` writer"]
pub type W = crate::W<OtgHsDiepint0Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDiepint0Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDiepint0Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    pub fn toc(&mut self) -> TocW<OtgHsDiepint0Spec> {
        TocW::new(self, 3)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    pub fn ittxfe(&mut self) -> IttxfeW<OtgHsDiepint0Spec> {
        IttxfeW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    pub fn inepne(&mut self) -> InepneW<OtgHsDiepint0Spec> {
        InepneW::new(self, 6)
    }
    #[doc = "Bit 8 - Transmit Fifo Underrun"]
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TxfifoudrnW<OtgHsDiepint0Spec> {
        TxfifoudrnW::new(self, 8)
    }
    #[doc = "Bit 9 - Buffer not available interrupt"]
    #[inline(always)]
    pub fn bna(&mut self) -> BnaW<OtgHsDiepint0Spec> {
        BnaW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet dropped status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<OtgHsDiepint0Spec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble error interrupt"]
    #[inline(always)]
    pub fn berr(&mut self) -> BerrW<OtgHsDiepint0Spec> {
        BerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<OtgHsDiepint0Spec> {
        NakW::new(self, 13)
    }
}
...
pub struct OtgHsDiepint0Spec;
impl crate::RegisterSpec for OtgHsDiepint0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_diepint0::R`](R) reader structure"]
impl crate::Readable for OtgHsDiepint0Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_diepint0::W`](W) writer structure"]
impl crate::Writable for OtgHsDiepint0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPINT0 to value 0x80"]
impl crate::Resettable for OtgHsDiepint0Spec {

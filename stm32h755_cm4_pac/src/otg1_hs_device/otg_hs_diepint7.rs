#[doc = "Register `OTG_HS_DIEPINT7` reader"]
pub type R = crate::R<OtgHsDiepint7Spec>;
#[doc = "Register `OTG_HS_DIEPINT7` writer"]
pub type W = crate::W<OtgHsDiepint7Spec>;
...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt"]
    #[inline(always)]
    pub fn xfrc(&mut self) -> XfrcW<OtgHsDiepint7Spec> {
        XfrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    pub fn epdisd(&mut self) -> EpdisdW<OtgHsDiepint7Spec> {
        EpdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    pub fn toc(&mut self) -> TocW<OtgHsDiepint7Spec> {
        TocW::new(self, 3)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    pub fn ittxfe(&mut self) -> IttxfeW<OtgHsDiepint7Spec> {
        IttxfeW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    pub fn inepne(&mut self) -> InepneW<OtgHsDiepint7Spec> {
        InepneW::new(self, 6)
    }
    #[doc = "Bit 8 - Transmit Fifo Underrun"]
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TxfifoudrnW<OtgHsDiepint7Spec> {
        TxfifoudrnW::new(self, 8)
    }
    #[doc = "Bit 9 - Buffer not available interrupt"]
    #[inline(always)]
    pub fn bna(&mut self) -> BnaW<OtgHsDiepint7Spec> {
        BnaW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet dropped status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<OtgHsDiepint7Spec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble error interrupt"]
    #[inline(always)]
    pub fn berr(&mut self) -> BerrW<OtgHsDiepint7Spec> {
        BerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<OtgHsDiepint7Spec> {
        NakW::new(self, 13)
    }
}
#[doc = "OTG device endpoint-7 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_diepint7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_diepint7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDiepint7Spec;
impl crate::RegisterSpec for OtgHsDiepint7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_diepint7::R`](R) reader structure"]
impl crate::Readable for OtgHsDiepint7Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_diepint7::W`](W) writer structure"]
impl crate::Writable for OtgHsDiepint7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DIEPINT7 to value 0"]
impl crate::Resettable for OtgHsDiepint7Spec {}

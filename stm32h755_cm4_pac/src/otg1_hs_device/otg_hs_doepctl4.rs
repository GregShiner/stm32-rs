#[doc = "Register `OTG_HS_DOEPCTL4` reader"]
pub type R = crate::R<OtgHsDoepctl4Spec>;
#[doc = "Register `OTG_HS_DOEPCTL4` writer"]
pub type W = crate::W<OtgHsDoepctl4Spec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum packet size"]
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MpsizW<OtgHsDoepctl4Spec> {
        MpsizW::new(self, 0)
    }
    #[doc = "Bit 15 - USB active endpoint"]
    #[inline(always)]
    pub fn usbaep(&mut self) -> UsbaepW<OtgHsDoepctl4Spec> {
        UsbaepW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    pub fn eptyp(&mut self) -> EptypW<OtgHsDoepctl4Spec> {
        EptypW::new(self, 18)
    }
    #[doc = "Bit 20 - Snoop mode"]
    #[inline(always)]
    pub fn snpm(&mut self) -> SnpmW<OtgHsDoepctl4Spec> {
        SnpmW::new(self, 20)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<OtgHsDoepctl4Spec> {
        StallW::new(self, 21)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    pub fn cnak(&mut self) -> CnakW<OtgHsDoepctl4Spec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    pub fn snak(&mut self) -> SnakW<OtgHsDoepctl4Spec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - Set DATA0 PID/Set even frame"]
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> Sd0pidSevnfrmW<OtgHsDoepctl4Spec> {
        Sd0pidSevnfrmW::new(self, 28)
    }
    #[doc = "Bit 29 - Set odd frame"]
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SoddfrmW<OtgHsDoepctl4Spec> {
        SoddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    pub fn epdis(&mut self) -> EpdisW<OtgHsDoepctl4Spec> {
        EpdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    pub fn epena(&mut self) -> EpenaW<OtgHsDoepctl4Spec> {
        EpenaW::new(self, 31)
    }
}
#[doc = "OTG device endpoint-4 control register\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_hs_doepctl4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_doepctl4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtgHsDoepctl4Spec;
impl crate::RegisterSpec for OtgHsDoepctl4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`otg_hs_doepctl4::R`](R) reader structure"]
impl crate::Readable for OtgHsDoepctl4Spec {}
#[doc = "`write(|w| ..)` method takes [`otg_hs_doepctl4::W`](W) writer structure"]
impl crate::Writable for OtgHsDoepctl4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OTG_HS_DOEPCTL4 to value 0"]
impl crate::Resettable for OtgHsDoepctl4Spec {}

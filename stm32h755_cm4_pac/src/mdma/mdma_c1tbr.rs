...
pub type R = crate::R<MdmaC1tbrSpec>;
#[doc = "Register `MDMA_C1TBR` writer"]
pub type W = crate::W<MdmaC1tbrSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Trigger selection"]
    #[inline(always)]
    pub fn tsel(&mut self) -> TselW<MdmaC1tbrSpec> {
        TselW::new(self, 0)
    }
    #[doc = "Bit 16 - Source BUS select This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    pub fn sbus(&mut self) -> SbusW<MdmaC1tbrSpec> {
        SbusW::new(self, 16)
    }
    #[doc = "Bit 17 - Destination BUS slect This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    pub fn dbus(&mut self) -> DbusW<MdmaC1tbrSpec> {
        DbusW::new(self, 17)
    }
}
#[doc = "MDMA channel x Trigger and Bus selection Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c1tbr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c1tbr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC1tbrSpec;
impl crate::RegisterSpec for MdmaC1tbrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c1tbr::R`](R) reader structure"]
impl crate::Readable for MdmaC1tbrSpec {}
#[doc = "`write(|w| ..)` method takes [`mdma_c1tbr::W`](W) writer structure"]
impl crate::Writable for MdmaC1tbrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MDMA_C1TBR to value 0"]
impl crate::Resettable for MdmaC1tbrSpec {}

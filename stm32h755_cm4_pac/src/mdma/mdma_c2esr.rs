...
pub type R = crate::R<MdmaC2esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c2esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC2esrSpec;
impl crate::RegisterSpec for MdmaC2esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c2esr::R`](R) reader structure"]
impl crate::Readable for MdmaC2esrSpec {}
#[doc = "`reset()` method sets MDMA_C2ESR to value 0"]
impl crate::Resettable for MdmaC2esrSpec {}

...
pub type R = crate::R<MdmaC5esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c5esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC5esrSpec;
impl crate::RegisterSpec for MdmaC5esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c5esr::R`](R) reader structure"]
impl crate::Readable for MdmaC5esrSpec {}
#[doc = "`reset()` method sets MDMA_C5ESR to value 0"]
impl crate::Resettable for MdmaC5esrSpec {}

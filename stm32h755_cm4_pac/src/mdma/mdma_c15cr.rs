...
pub type R = crate::R<MdmaC15crSpec>;
#[doc = "Register `MDMA_C15CR` writer"]
pub type W = crate::W<MdmaC15crSpec>;
...
impl W {
    #[doc = "Bit 0 - channel enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<MdmaC15crSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer error interrupt enable This bit is set and cleared by software."]
    #[inline(always)]
    pub fn teie(&mut self) -> TeieW<MdmaC15crSpec> {
        TeieW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel Transfer Complete interrupt enable This bit is set and cleared by software."]
    #[inline(always)]
    pub fn ctcie(&mut self) -> CtcieW<MdmaC15crSpec> {
        CtcieW::new(self, 2)
    }
    #[doc = "Bit 3 - Block Repeat transfer interrupt enable This bit is set and cleared by software."]
    #[inline(always)]
    pub fn brtie(&mut self) -> BrtieW<MdmaC15crSpec> {
        BrtieW::new(self, 3)
    }
    #[doc = "Bit 4 - Block Transfer interrupt enable This bit is set and cleared by software."]
    #[inline(always)]
    pub fn btie(&mut self) -> BtieW<MdmaC15crSpec> {
        BtieW::new(self, 4)
    }
    #[doc = "Bit 5 - buffer Transfer Complete interrupt enable This bit is set and cleared by software."]
    #[inline(always)]
    pub fn tcie(&mut self) -> TcieW<MdmaC15crSpec> {
        TcieW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Priority level These bits are set and cleared by software. These bits are protected and can be written only if EN is 0."]
    #[inline(always)]
    pub fn pl(&mut self) -> PlW<MdmaC15crSpec> {
        PlW::new(self, 6)
    }
    #[doc = "Bit 12 - byte Endianness exchange"]
    #[inline(always)]
    pub fn bex(&mut self) -> BexW<MdmaC15crSpec> {
        BexW::new(self, 12)
    }
    #[doc = "Bit 13 - Half word Endianes exchange"]
    #[inline(always)]
    pub fn hex(&mut self) -> HexW<MdmaC15crSpec> {
        HexW::new(self, 13)
    }
    #[doc = "Bit 14 - Word Endianness exchange"]
    #[inline(always)]
    pub fn wex(&mut self) -> WexW<MdmaC15crSpec> {
        WexW::new(self, 14)
    }
    #[doc = "Bit 16 - SW ReQuest Writing a 1 into this bit sets the CRQAx in MDMA_ISRy register, activating the request on Channel x Note: Either the whole CxCR register or the 8-bit/16-bit register @ Address offset: 0x4E + 0x40 chn may be used for SWRQ activation. In case of a SW request, acknowledge is not generated (neither HW signal, nor CxMAR write access)."]
    #[inline(always)]
    pub fn swrq(&mut self) -> SwrqW<MdmaC15crSpec> {
        SwrqW::new(self, 16)
    }
}
#[doc = "This register is used to control the concerned channel.\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c15cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c15cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC15crSpec;
impl crate::RegisterSpec for MdmaC15crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c15cr::R`](R) reader structure"]
impl crate::Readable for MdmaC15crSpec {}
#[doc = "`write(|w| ..)` method takes [`mdma_c15cr::W`](W) writer structure"]
impl crate::Writable for MdmaC15crSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MDMA_C15CR to value 0"]
impl crate::Resettable for MdmaC15crSpec {}

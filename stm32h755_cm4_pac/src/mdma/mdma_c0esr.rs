...
pub type R = crate::R<MdmaC0esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c0esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC0esrSpec;
impl crate::RegisterSpec for MdmaC0esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c0esr::R`](R) reader structure"]
impl crate::Readable for MdmaC0esrSpec {}
#[doc = "`reset()` method sets MDMA_C0ESR to value 0"]
impl crate::Resettable for MdmaC0esrSpec {}

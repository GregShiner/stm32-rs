...
pub type R = crate::R<MdmaC9tbrSpec>;
#[doc = "Register `MDMA_C9TBR` writer"]
pub type W = crate::W<MdmaC9tbrSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Trigger selection"]
    #[inline(always)]
    pub fn tsel(&mut self) -> TselW<MdmaC9tbrSpec> {
        TselW::new(self, 0)
    }
    #[doc = "Bit 16 - Source BUS select This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    pub fn sbus(&mut self) -> SbusW<MdmaC9tbrSpec> {
        SbusW::new(self, 16)
    }
    #[doc = "Bit 17 - Destination BUS slect This bit is protected and can be written only if EN is 0."]
    #[inline(always)]
    pub fn dbus(&mut self) -> DbusW<MdmaC9tbrSpec> {
        DbusW::new(self, 17)
    }
}
...
pub struct MdmaC9tbrSpec;
impl crate::RegisterSpec for MdmaC9tbrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c9tbr::R`](R) reader structure"]
impl crate::Readable for MdmaC9tbrSpec {}
#[doc = "`write(|w| ..)` method takes [`mdma_c9tbr::W`](W) writer structure"]
impl crate::Writable for MdmaC9tbrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MDMA_C9TBR to value 0"]
impl crate::Resettable for MdmaC9tbrSpec {}

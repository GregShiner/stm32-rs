...
pub type R = crate::R<MdmaC1esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c1esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC1esrSpec;
impl crate::RegisterSpec for MdmaC1esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c1esr::R`](R) reader structure"]
impl crate::Readable for MdmaC1esrSpec {}
#[doc = "`reset()` method sets MDMA_C1ESR to value 0"]
impl crate::Resettable for MdmaC1esrSpec {}

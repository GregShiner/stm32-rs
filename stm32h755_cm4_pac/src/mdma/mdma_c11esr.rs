...
pub type R = crate::R<MdmaC11esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c11esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC11esrSpec;
impl crate::RegisterSpec for MdmaC11esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c11esr::R`](R) reader structure"]
impl crate::Readable for MdmaC11esrSpec {}
#[doc = "`reset()` method sets MDMA_C11ESR to value 0"]
impl crate::Resettable for MdmaC11esrSpec {}

...
pub type R = crate::R<MdmaC7esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c7esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC7esrSpec;
impl crate::RegisterSpec for MdmaC7esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c7esr::R`](R) reader structure"]
impl crate::Readable for MdmaC7esrSpec {}
#[doc = "`reset()` method sets MDMA_C7ESR to value 0"]
impl crate::Resettable for MdmaC7esrSpec {}

...
pub type R = crate::R<MdmaC3esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c3esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC3esrSpec;
impl crate::RegisterSpec for MdmaC3esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c3esr::R`](R) reader structure"]
impl crate::Readable for MdmaC3esrSpec {}
#[doc = "`reset()` method sets MDMA_C3ESR to value 0"]
impl crate::Resettable for MdmaC3esrSpec {}

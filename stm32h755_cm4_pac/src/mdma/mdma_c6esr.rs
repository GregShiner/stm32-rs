...
pub type R = crate::R<MdmaC6esrSpec>;
...
#[doc = "MDMA Channel x error status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c6esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC6esrSpec;
impl crate::RegisterSpec for MdmaC6esrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c6esr::R`](R) reader structure"]
impl crate::Readable for MdmaC6esrSpec {}
#[doc = "`reset()` method sets MDMA_C6ESR to value 0"]
impl crate::Resettable for MdmaC6esrSpec {}

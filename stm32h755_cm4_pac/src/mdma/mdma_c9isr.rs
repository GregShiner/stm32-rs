...
pub type R = crate::R<MdmaC9isrSpec>;
...
pub type Teif9R = crate::BitReader;
...
pub type Ctcif9R = crate::BitReader;
...
pub type Brtif9R = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn teif9(&self) -> Teif9R {
        Teif9R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Channel x Channel Transfer Complete interrupt flag This bit is set by hardware. It is cleared by software writing 1 to the corresponding bit in the DMA_IFCRy register. CTC is set when the last block was transferred and the channel has been automatically disabled. CTC is also set when the channel is suspended, as a result of writing EN bit to 0."]
    #[inline(always)]
    pub fn ctcif9(&self) -> Ctcif9R {
        Ctcif9R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn brtif9(&self) -> Brtif9R {
        Brtif9R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn btif9(&self) -> Btif9R {
        Btif9R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - channel x buffer transfer complete"]
    #[inline(always)]
    pub fn tcif9(&self) -> Tcif9R {
        Tcif9R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 16 - channel x request active flag"]
    #[inline(always)]
    pub fn crqa9(&self) -> Crqa9R {
        Crqa9R::new(((self.bits >> 16) & 1) != 0)
    }
}
#[doc = "MDMA channel x interrupt/status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c9isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC9isrSpec;
impl crate::RegisterSpec for MdmaC9isrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c9isr::R`](R) reader structure"]
impl crate::Readable for MdmaC9isrSpec {}
#[doc = "`reset()` method sets MDMA_C9ISR to value 0"]
impl crate::Resettable for MdmaC9isrSpec {}

...
pub type R = crate::R<MdmaC2brurSpec>;
#[doc = "Register `MDMA_C2BRUR` writer"]
pub type W = crate::W<MdmaC2brurSpec>;
...
impl W {
    #[doc = "Bits 0:15 - source adresse update value"]
    #[inline(always)]
    pub fn suv(&mut self) -> SuvW<MdmaC2brurSpec> {
        SuvW::new(self, 0)
    }
    #[doc = "Bits 16:31 - destination address update"]
    #[inline(always)]
    pub fn duv(&mut self) -> DuvW<MdmaC2brurSpec> {
        DuvW::new(self, 16)
    }
}
#[doc = "MDMA channel x Block Repeat address Update register\n\nYou can [`read`](crate::Reg::read) this register and get [`mdma_c2brur::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c2brur::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MdmaC2brurSpec;
impl crate::RegisterSpec for MdmaC2brurSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c2brur::R`](R) reader structure"]
impl crate::Readable for MdmaC2brurSpec {}
#[doc = "`write(|w| ..)` method takes [`mdma_c2brur::W`](W) writer structure"]
impl crate::Writable for MdmaC2brurSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MDMA_C2BRUR to value 0"]
impl crate::Resettable for MdmaC2brurSpec {}

...
pub type Oc4m4R = crate::BitReader;
#[doc = "Field `OC4M_4` writer - Output Compare 4 mode - bit 3"]
pub type Oc4m4W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn oc4m_4(&self) -> Oc4m4R {
        Oc4m4R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Capture/Compare 3 selection"]
    ...
    #[doc = "Bit 24 - Output Compare 4 mode - bit 3"]
    #[inline(always)]
    pub fn oc4m_4(&mut self) -> Oc4m4W<Ccmr2OutputSpec> {
        Oc4m4W::new(self, 24)
    }
}

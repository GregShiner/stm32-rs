...
#[doc = "Field `TI3SEL` reader - selects TI3\\[0\\] to TI3\\[15\\] input"]
pub type Ti3selR = crate::FieldReader;
#[doc = "Field `TI3SEL` writer - selects TI3\\[0\\] to TI3\\[15\\] input"]
pub type Ti3selW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TI4SEL` reader - selects TI4\\[0\\] to TI4\\[15\\] input"]
pub type Ti4selR = crate::FieldReader;
#[doc = "Field `TI4SEL` writer - selects TI4\\[0\\] to TI4\\[15\\] input"]

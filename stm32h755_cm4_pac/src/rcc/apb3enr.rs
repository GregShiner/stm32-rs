...
pub type R = crate::R<Apb3enrSpec>;
#[doc = "Register `APB3ENR` writer"]
pub type W = crate::W<Apb3enrSpec>;
...
impl W {
    #[doc = "Bit 3 - LTDC peripheral clock enable"]
    #[inline(always)]
    pub fn ltdcen(&mut self) -> LtdcenW<Apb3enrSpec> {
        LtdcenW::new(self, 3)
    }
    #[doc = "Bit 6 - WWDG1 Clock Enable"]
    #[inline(always)]
    pub fn wwdg1en(&mut self) -> Wwdg1enW<Apb3enrSpec> {
        Wwdg1enW::new(self, 6)
    }
}
...
pub struct Apb3enrSpec;
impl crate::RegisterSpec for Apb3enrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb3enr::R`](R) reader structure"]
impl crate::Readable for Apb3enrSpec {}
#[doc = "`write(|w| ..)` method takes [`apb3enr::W`](W) writer structure"]
impl crate::Writable for Apb3enrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB3ENR to value 0"]
impl crate::Resettable for Apb3enrSpec {}

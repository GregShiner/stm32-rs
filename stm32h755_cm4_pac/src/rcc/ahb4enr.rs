...
pub type R = crate::R<Ahb4enrSpec>;
#[doc = "Register `AHB4ENR` writer"]
pub type W = crate::W<Ahb4enrSpec>;
...
impl W {
    #[doc = "Bit 0 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioaen(&mut self) -> GpioaenW<Ahb4enrSpec> {
        GpioaenW::new(self, 0)
    }
    #[doc = "Bit 1 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioben(&mut self) -> GpiobenW<Ahb4enrSpec> {
        GpiobenW::new(self, 1)
    }
    #[doc = "Bit 2 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpiocen(&mut self) -> GpiocenW<Ahb4enrSpec> {
        GpiocenW::new(self, 2)
    }
    #[doc = "Bit 3 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioden(&mut self) -> GpiodenW<Ahb4enrSpec> {
        GpiodenW::new(self, 3)
    }
    #[doc = "Bit 4 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioeen(&mut self) -> GpioeenW<Ahb4enrSpec> {
        GpioeenW::new(self, 4)
    }
    #[doc = "Bit 5 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpiofen(&mut self) -> GpiofenW<Ahb4enrSpec> {
        GpiofenW::new(self, 5)
    }
    #[doc = "Bit 6 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpiogen(&mut self) -> GpiogenW<Ahb4enrSpec> {
        GpiogenW::new(self, 6)
    }
    #[doc = "Bit 7 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpiohen(&mut self) -> GpiohenW<Ahb4enrSpec> {
        GpiohenW::new(self, 7)
    }
    #[doc = "Bit 8 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioien(&mut self) -> GpioienW<Ahb4enrSpec> {
        GpioienW::new(self, 8)
    }
    #[doc = "Bit 9 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpiojen(&mut self) -> GpiojenW<Ahb4enrSpec> {
        GpiojenW::new(self, 9)
    }
    #[doc = "Bit 10 - 0GPIO peripheral clock enable"]
    #[inline(always)]
    pub fn gpioken(&mut self) -> GpiokenW<Ahb4enrSpec> {
        GpiokenW::new(self, 10)
    }
    #[doc = "Bit 19 - CRC peripheral clock enable"]
    #[inline(always)]
    pub fn crcen(&mut self) -> CrcenW<Ahb4enrSpec> {
        CrcenW::new(self, 19)
    }
    #[doc = "Bit 21 - BDMA and DMAMUX2 Clock Enable"]
    #[inline(always)]
    pub fn bdmaen(&mut self) -> BdmaenW<Ahb4enrSpec> {
        BdmaenW::new(self, 21)
    }
    #[doc = "Bit 24 - ADC3 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn adc3en(&mut self) -> Adc3enW<Ahb4enrSpec> {
        Adc3enW::new(self, 24)
    }
    #[doc = "Bit 25 - HSEM peripheral clock enable"]
    #[inline(always)]
    pub fn hsemen(&mut self) -> HsemenW<Ahb4enrSpec> {
        HsemenW::new(self, 25)
    }
    #[doc = "Bit 28 - Backup RAM Clock Enable"]
    #[inline(always)]
    pub fn bkpramen(&mut self) -> BkpramenW<Ahb4enrSpec> {
...
pub struct Ahb4enrSpec;
impl crate::RegisterSpec for Ahb4enrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ahb4enr::R`](R) reader structure"]
impl crate::Readable for Ahb4enrSpec {}
#[doc = "`write(|w| ..)` method takes [`ahb4enr::W`](W) writer structure"]
impl crate::Writable for Ahb4enrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AHB4ENR to value 0"]
impl crate::Resettable for Ahb4enrSpec {}

...
pub type R = crate::R<C1Apb4enrSpec>;
#[doc = "Register `C1_APB4ENR` writer"]
pub type W = crate::W<C1Apb4enrSpec>;
...
impl W {
    #[doc = "Bit 1 - SYSCFG peripheral clock enable"]
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SyscfgenW<C1Apb4enrSpec> {
        SyscfgenW::new(self, 1)
    }
    #[doc = "Bit 3 - LPUART1 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lpuart1en(&mut self) -> Lpuart1enW<C1Apb4enrSpec> {
        Lpuart1enW::new(self, 3)
    }
    #[doc = "Bit 5 - SPI6 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn spi6en(&mut self) -> Spi6enW<C1Apb4enrSpec> {
        Spi6enW::new(self, 5)
    }
    #[doc = "Bit 7 - I2C4 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn i2c4en(&mut self) -> I2c4enW<C1Apb4enrSpec> {
        I2c4enW::new(self, 7)
    }
    #[doc = "Bit 9 - LPTIM2 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lptim2en(&mut self) -> Lptim2enW<C1Apb4enrSpec> {
        Lptim2enW::new(self, 9)
    }
    #[doc = "Bit 10 - LPTIM3 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lptim3en(&mut self) -> Lptim3enW<C1Apb4enrSpec> {
        Lptim3enW::new(self, 10)
    }
    #[doc = "Bit 11 - LPTIM4 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lptim4en(&mut self) -> Lptim4enW<C1Apb4enrSpec> {
        Lptim4enW::new(self, 11)
    }
    #[doc = "Bit 12 - LPTIM5 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lptim5en(&mut self) -> Lptim5enW<C1Apb4enrSpec> {
        Lptim5enW::new(self, 12)
    }
    #[doc = "Bit 14 - COMP1/2 peripheral clock enable"]
    #[inline(always)]
    pub fn comp12en(&mut self) -> Comp12enW<C1Apb4enrSpec> {
        Comp12enW::new(self, 14)
    }
    #[doc = "Bit 15 - VREF peripheral clock enable"]
    #[inline(always)]
    pub fn vrefen(&mut self) -> VrefenW<C1Apb4enrSpec> {
        VrefenW::new(self, 15)
    }
    #[doc = "Bit 16 - RTC APB Clock Enable"]
    #[inline(always)]
    pub fn rtcapben(&mut self) -> RtcapbenW<C1Apb4enrSpec> {
        RtcapbenW::new(self, 16)
    }
    #[doc = "Bit 21 - SAI4 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn sai4en(&mut self) -> Sai4enW<C1Apb4enrSpec> {
        Sai4enW::new(self, 21)
    }
}
...
pub struct C1Apb4enrSpec;
impl crate::RegisterSpec for C1Apb4enrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_apb4enr::R`](R) reader structure"]
impl crate::Readable for C1Apb4enrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_apb4enr::W`](W) writer structure"]
impl crate::Writable for C1Apb4enrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_APB4ENR to value 0"]
impl crate::Resettable for C1Apb4enrSpec {}

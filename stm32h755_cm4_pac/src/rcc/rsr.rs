...
impl W {
    #[doc = "Bit 16 - Remove reset flag"]
    #[inline(always)]
    pub fn rmvf(&mut self) -> RmvfW<RsrSpec> {
        RmvfW::new(self, 16)
    }
    #[doc = "Bit 17 - CPU reset flag"]
    #[inline(always)]
    pub fn cpurstf(&mut self) -> CpurstfW<RsrSpec> {
        CpurstfW::new(self, 17)
    }
    #[doc = "Bit 19 - D1 domain power switch reset flag"]
    #[inline(always)]
    pub fn d1rstf(&mut self) -> D1rstfW<RsrSpec> {
        D1rstfW::new(self, 19)
    }
    #[doc = "Bit 20 - D2 domain power switch reset flag"]
    #[inline(always)]
    pub fn d2rstf(&mut self) -> D2rstfW<RsrSpec> {
        D2rstfW::new(self, 20)
    }
    #[doc = "Bit 21 - BOR reset flag"]
    #[inline(always)]
    pub fn borrstf(&mut self) -> BorrstfW<RsrSpec> {
        BorrstfW::new(self, 21)
    }
    #[doc = "Bit 22 - Pin reset flag (NRST)"]
    #[inline(always)]
    pub fn pinrstf(&mut self) -> PinrstfW<RsrSpec> {
        PinrstfW::new(self, 22)
    }
    #[doc = "Bit 23 - POR/PDR reset flag"]
    #[inline(always)]
    pub fn porrstf(&mut self) -> PorrstfW<RsrSpec> {
        PorrstfW::new(self, 23)
    }
    #[doc = "Bit 24 - System reset from CPU reset flag"]
    #[inline(always)]
    pub fn sftrstf(&mut self) -> SftrstfW<RsrSpec> {
        SftrstfW::new(self, 24)
    }
    #[doc = "Bit 26 - Independent Watchdog reset flag"]
    #[inline(always)]
    pub fn iwdg1rstf(&mut self) -> Iwdg1rstfW<RsrSpec> {
        Iwdg1rstfW::new(self, 26)
    }
    #[doc = "Bit 28 - Window Watchdog reset flag"]
    #[inline(always)]
    pub fn wwdg1rstf(&mut self) -> Wwdg1rstfW<RsrSpec> {
        Wwdg1rstfW::new(self, 28)
    }
    #[doc = "Bit 30 - Reset due to illegal D1 DStandby or CPU CStop flag"]
    #[inline(always)]
    pub fn lpwrrstf(&mut self) -> LpwrrstfW<RsrSpec> {

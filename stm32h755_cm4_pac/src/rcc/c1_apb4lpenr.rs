...
pub type R = crate::R<C1Apb4lpenrSpec>;
#[doc = "Register `C1_APB4LPENR` writer"]
pub type W = crate::W<C1Apb4lpenrSpec>;
...
impl W {
    #[doc = "Bit 1 - SYSCFG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn syscfglpen(&mut self) -> SyscfglpenW<C1Apb4lpenrSpec> {
        SyscfglpenW::new(self, 1)
    }
    #[doc = "Bit 3 - LPUART1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lpuart1lpen(&mut self) -> Lpuart1lpenW<C1Apb4lpenrSpec> {
        Lpuart1lpenW::new(self, 3)
    }
    #[doc = "Bit 5 - SPI6 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi6lpen(&mut self) -> Spi6lpenW<C1Apb4lpenrSpec> {
        Spi6lpenW::new(self, 5)
    }
    #[doc = "Bit 7 - I2C4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn i2c4lpen(&mut self) -> I2c4lpenW<C1Apb4lpenrSpec> {
        I2c4lpenW::new(self, 7)
    }
    #[doc = "Bit 9 - LPTIM2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lptim2lpen(&mut self) -> Lptim2lpenW<C1Apb4lpenrSpec> {
        Lptim2lpenW::new(self, 9)
    }
    #[doc = "Bit 10 - LPTIM3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lptim3lpen(&mut self) -> Lptim3lpenW<C1Apb4lpenrSpec> {
        Lptim3lpenW::new(self, 10)
    }
    #[doc = "Bit 11 - LPTIM4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lptim4lpen(&mut self) -> Lptim4lpenW<C1Apb4lpenrSpec> {
        Lptim4lpenW::new(self, 11)
    }
    #[doc = "Bit 12 - LPTIM5 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn lptim5lpen(&mut self) -> Lptim5lpenW<C1Apb4lpenrSpec> {
        Lptim5lpenW::new(self, 12)
    }
    #[doc = "Bit 14 - COMP1/2 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn comp12lpen(&mut self) -> Comp12lpenW<C1Apb4lpenrSpec> {
        Comp12lpenW::new(self, 14)
    }
    #[doc = "Bit 15 - VREF peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn vreflpen(&mut self) -> VreflpenW<C1Apb4lpenrSpec> {
        VreflpenW::new(self, 15)
    }
    #[doc = "Bit 16 - RTC APB Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn rtcapblpen(&mut self) -> RtcapblpenW<C1Apb4lpenrSpec> {
        RtcapblpenW::new(self, 16)
    }
    #[doc = "Bit 21 - SAI4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sai4lpen(&mut self) -> Sai4lpenW<C1Apb4lpenrSpec> {
...
pub struct C1Apb4lpenrSpec;
impl crate::RegisterSpec for C1Apb4lpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_apb4lpenr::R`](R) reader structure"]
impl crate::Readable for C1Apb4lpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_apb4lpenr::W`](W) writer structure"]
impl crate::Writable for C1Apb4lpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_APB4LPENR to value 0"]
impl crate::Resettable for C1Apb4lpenrSpec {}

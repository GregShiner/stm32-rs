...
impl W {
    ...
    #[doc = "Bit 5 - ADC1/2 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn adc12en(&mut self) -> Adc12enW<Ahb1enrSpec> {
        Adc12enW::new(self, 5)
    }
    #[doc = "Bit 15 - Ethernet MAC bus interface Clock Enable"]
    #[inline(always)]
    pub fn eth1macen(&mut self) -> Eth1macenW<Ahb1enrSpec> {
        Eth1macenW::new(self, 15)
    }
    #[doc = "Bit 16 - Ethernet Transmission Clock Enable"]
    #[inline(always)]
    pub fn eth1txen(&mut self) -> Eth1txenW<Ahb1enrSpec> {
        Eth1txenW::new(self, 16)
    }
    #[doc = "Bit 17 - Ethernet Reception Clock Enable"]
    #[inline(always)]
    pub fn eth1rxen(&mut self) -> Eth1rxenW<Ahb1enrSpec> {
        Eth1rxenW::new(self, 17)
    }
    #[doc = "Bit 25 - USB1OTG Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usb1otgen(&mut self) -> Usb1otgenW<Ahb1enrSpec> {
        Usb1otgenW::new(self, 25)
    }
    #[doc = "Bit 26 - USB_PHY1 Clocks Enable"]
    #[inline(always)]
    pub fn usb1ulpien(&mut self) -> Usb1ulpienW<Ahb1enrSpec> {
        Usb1ulpienW::new(self, 26)
    }
    #[doc = "Bit 27 - USB2OTG Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usb2otgen(&mut self) -> Usb2otgenW<Ahb1enrSpec> {
        Usb2otgenW::new(self, 27)
    }
    #[doc = "Bit 28 - USB_PHY2 Clocks Enable"]
    #[inline(always)]
    pub fn usb2ulpien(&mut self) -> Usb2ulpienW<Ahb1enrSpec> {

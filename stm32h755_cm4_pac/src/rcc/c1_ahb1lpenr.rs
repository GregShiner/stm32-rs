...
pub type R = crate::R<C1Ahb1lpenrSpec>;
#[doc = "Register `C1_AHB1LPENR` writer"]
pub type W = crate::W<C1Ahb1lpenrSpec>;
...
impl W {
    #[doc = "Bit 0 - DMA1 Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn dma1lpen(&mut self) -> Dma1lpenW<C1Ahb1lpenrSpec> {
        Dma1lpenW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA2 Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn dma2lpen(&mut self) -> Dma2lpenW<C1Ahb1lpenrSpec> {
        Dma2lpenW::new(self, 1)
    }
    #[doc = "Bit 5 - ADC1/2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn adc12lpen(&mut self) -> Adc12lpenW<C1Ahb1lpenrSpec> {
        Adc12lpenW::new(self, 5)
    }
    #[doc = "Bit 15 - Ethernet MAC bus interface Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn eth1maclpen(&mut self) -> Eth1maclpenW<C1Ahb1lpenrSpec> {
        Eth1maclpenW::new(self, 15)
    }
    #[doc = "Bit 16 - Ethernet Transmission Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn eth1txlpen(&mut self) -> Eth1txlpenW<C1Ahb1lpenrSpec> {
        Eth1txlpenW::new(self, 16)
    }
    #[doc = "Bit 17 - Ethernet Reception Clock Enable During CSleep Mode"]
    #[inline(always)]
    pub fn eth1rxlpen(&mut self) -> Eth1rxlpenW<C1Ahb1lpenrSpec> {
        Eth1rxlpenW::new(self, 17)
    }
    #[doc = "Bit 25 - USB1OTG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn usb1otglpen(&mut self) -> Usb1otglpenW<C1Ahb1lpenrSpec> {
        Usb1otglpenW::new(self, 25)
    }
    #[doc = "Bit 26 - USB_PHY1 clock enable during CSleep mode"]
    #[inline(always)]
    pub fn usb1ulpilpen(&mut self) -> Usb1ulpilpenW<C1Ahb1lpenrSpec> {
        Usb1ulpilpenW::new(self, 26)
    }
    #[doc = "Bit 27 - USB2OTG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn usb2otglpen(&mut self) -> Usb2otglpenW<C1Ahb1lpenrSpec> {
        Usb2otglpenW::new(self, 27)
    }
    #[doc = "Bit 28 - USB_PHY2 clocks enable during CSleep mode"]
    #[inline(always)]
    pub fn usb2ulpilpen(&mut self) -> Usb2ulpilpenW<C1Ahb1lpenrSpec> {
...
pub struct C1Ahb1lpenrSpec;
impl crate::RegisterSpec for C1Ahb1lpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_ahb1lpenr::R`](R) reader structure"]
impl crate::Readable for C1Ahb1lpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_ahb1lpenr::W`](W) writer structure"]
impl crate::Writable for C1Ahb1lpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_AHB1LPENR to value 0"]
impl crate::Resettable for C1Ahb1lpenrSpec {}

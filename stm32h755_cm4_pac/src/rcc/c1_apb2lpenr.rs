...
pub type R = crate::R<C1Apb2lpenrSpec>;
#[doc = "Register `C1_APB2LPENR` writer"]
pub type W = crate::W<C1Apb2lpenrSpec>;
...
impl W {
    #[doc = "Bit 0 - TIM1 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim1lpen(&mut self) -> Tim1lpenW<C1Apb2lpenrSpec> {
        Tim1lpenW::new(self, 0)
    }
    #[doc = "Bit 1 - TIM8 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim8lpen(&mut self) -> Tim8lpenW<C1Apb2lpenrSpec> {
        Tim8lpenW::new(self, 1)
    }
    #[doc = "Bit 4 - USART1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart1lpen(&mut self) -> Usart1lpenW<C1Apb2lpenrSpec> {
        Usart1lpenW::new(self, 4)
    }
    #[doc = "Bit 5 - USART6 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart6lpen(&mut self) -> Usart6lpenW<C1Apb2lpenrSpec> {
        Usart6lpenW::new(self, 5)
    }
    #[doc = "Bit 12 - SPI1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi1lpen(&mut self) -> Spi1lpenW<C1Apb2lpenrSpec> {
        Spi1lpenW::new(self, 12)
    }
    #[doc = "Bit 13 - SPI4 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi4lpen(&mut self) -> Spi4lpenW<C1Apb2lpenrSpec> {
        Spi4lpenW::new(self, 13)
    }
    #[doc = "Bit 16 - TIM15 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim15lpen(&mut self) -> Tim15lpenW<C1Apb2lpenrSpec> {
        Tim15lpenW::new(self, 16)
    }
    #[doc = "Bit 17 - TIM16 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim16lpen(&mut self) -> Tim16lpenW<C1Apb2lpenrSpec> {
        Tim16lpenW::new(self, 17)
    }
    #[doc = "Bit 18 - TIM17 peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn tim17lpen(&mut self) -> Tim17lpenW<C1Apb2lpenrSpec> {
        Tim17lpenW::new(self, 18)
    }
    #[doc = "Bit 20 - SPI5 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn spi5lpen(&mut self) -> Spi5lpenW<C1Apb2lpenrSpec> {
        Spi5lpenW::new(self, 20)
    }
    #[doc = "Bit 22 - SAI1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sai1lpen(&mut self) -> Sai1lpenW<C1Apb2lpenrSpec> {
        Sai1lpenW::new(self, 22)
    }
    #[doc = "Bit 23 - SAI2 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sai2lpen(&mut self) -> Sai2lpenW<C1Apb2lpenrSpec> {
        Sai2lpenW::new(self, 23)
    }
    #[doc = "Bit 24 - SAI3 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> Sai3lpenW<C1Apb2lpenrSpec> {
        Sai3lpenW::new(self, 24)
    }
    #[doc = "Bit 28 - DFSDM1 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn dfsdm1lpen(&mut self) -> Dfsdm1lpenW<C1Apb2lpenrSpec> {
        Dfsdm1lpenW::new(self, 28)
    }
    #[doc = "Bit 29 - HRTIM peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn hrtimlpen(&mut self) -> HrtimlpenW<C1Apb2lpenrSpec> {
...
pub struct C1Apb2lpenrSpec;
impl crate::RegisterSpec for C1Apb2lpenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1_apb2lpenr::R`](R) reader structure"]
impl crate::Readable for C1Apb2lpenrSpec {}
#[doc = "`write(|w| ..)` method takes [`c1_apb2lpenr::W`](W) writer structure"]
impl crate::Writable for C1Apb2lpenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1_APB2LPENR to value 0"]
impl crate::Resettable for C1Apb2lpenrSpec {}

...
pub type R = crate::R<Apb1lenrSpec>;
#[doc = "Register `APB1LENR` writer"]
pub type W = crate::W<Apb1lenrSpec>;
...
impl W {
    #[doc = "Bit 0 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim2en(&mut self) -> Tim2enW<Apb1lenrSpec> {
        Tim2enW::new(self, 0)
    }
    #[doc = "Bit 1 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim3en(&mut self) -> Tim3enW<Apb1lenrSpec> {
        Tim3enW::new(self, 1)
    }
    #[doc = "Bit 2 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim4en(&mut self) -> Tim4enW<Apb1lenrSpec> {
        Tim4enW::new(self, 2)
    }
    #[doc = "Bit 3 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim5en(&mut self) -> Tim5enW<Apb1lenrSpec> {
        Tim5enW::new(self, 3)
    }
    #[doc = "Bit 4 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim6en(&mut self) -> Tim6enW<Apb1lenrSpec> {
        Tim6enW::new(self, 4)
    }
    #[doc = "Bit 5 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim7en(&mut self) -> Tim7enW<Apb1lenrSpec> {
        Tim7enW::new(self, 5)
    }
    #[doc = "Bit 6 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim12en(&mut self) -> Tim12enW<Apb1lenrSpec> {
        Tim12enW::new(self, 6)
    }
    #[doc = "Bit 7 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim13en(&mut self) -> Tim13enW<Apb1lenrSpec> {
        Tim13enW::new(self, 7)
    }
    #[doc = "Bit 8 - TIM peripheral clock enable"]
    #[inline(always)]
    pub fn tim14en(&mut self) -> Tim14enW<Apb1lenrSpec> {
        Tim14enW::new(self, 8)
    }
    #[doc = "Bit 9 - LPTIM1 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn lptim1en(&mut self) -> Lptim1enW<Apb1lenrSpec> {
        Lptim1enW::new(self, 9)
    }
    #[doc = "Bit 14 - SPI2 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn spi2en(&mut self) -> Spi2enW<Apb1lenrSpec> {
        Spi2enW::new(self, 14)
    }
    #[doc = "Bit 15 - SPI3 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn spi3en(&mut self) -> Spi3enW<Apb1lenrSpec> {
        Spi3enW::new(self, 15)
    }
    #[doc = "Bit 16 - SPDIFRX Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn spdifrxen(&mut self) -> SpdifrxenW<Apb1lenrSpec> {
        SpdifrxenW::new(self, 16)
    }
    #[doc = "Bit 17 - USART2 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usart2en(&mut self) -> Usart2enW<Apb1lenrSpec> {
        Usart2enW::new(self, 17)
    }
    #[doc = "Bit 18 - USART3 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usart3en(&mut self) -> Usart3enW<Apb1lenrSpec> {
        Usart3enW::new(self, 18)
    }
    #[doc = "Bit 19 - UART4 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn uart4en(&mut self) -> Uart4enW<Apb1lenrSpec> {
        Uart4enW::new(self, 19)
    }
    #[doc = "Bit 20 - UART5 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn uart5en(&mut self) -> Uart5enW<Apb1lenrSpec> {
        Uart5enW::new(self, 20)
    }
    #[doc = "Bit 21 - I2C1 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn i2c1en(&mut self) -> I2c1enW<Apb1lenrSpec> {
        I2c1enW::new(self, 21)
    }
    #[doc = "Bit 22 - I2C2 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn i2c2en(&mut self) -> I2c2enW<Apb1lenrSpec> {
        I2c2enW::new(self, 22)
    }
    #[doc = "Bit 23 - I2C3 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn i2c3en(&mut self) -> I2c3enW<Apb1lenrSpec> {
        I2c3enW::new(self, 23)
    }
    #[doc = "Bit 27 - HDMI-CEC peripheral clock enable"]
    #[inline(always)]
    pub fn hdmicecen(&mut self) -> HdmicecenW<Apb1lenrSpec> {
        HdmicecenW::new(self, 27)
    }
    #[doc = "Bit 29 - DAC1&2 peripheral clock enable"]
    #[inline(always)]
    pub fn dac12en(&mut self) -> Dac12enW<Apb1lenrSpec> {
        Dac12enW::new(self, 29)
    }
    #[doc = "Bit 30 - USART7 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usart7en(&mut self) -> Usart7enW<Apb1lenrSpec> {
        Usart7enW::new(self, 30)
    }
    #[doc = "Bit 31 - USART8 Peripheral Clocks Enable"]
    #[inline(always)]
    pub fn usart8en(&mut self) -> Usart8enW<Apb1lenrSpec> {
...
pub struct Apb1lenrSpec;
impl crate::RegisterSpec for Apb1lenrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb1lenr::R`](R) reader structure"]
impl crate::Readable for Apb1lenrSpec {}
#[doc = "`write(|w| ..)` method takes [`apb1lenr::W`](W) writer structure"]
impl crate::Writable for Apb1lenrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets APB1LENR to value 0"]
impl crate::Resettable for Apb1lenrSpec {}

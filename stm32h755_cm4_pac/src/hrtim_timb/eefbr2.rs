...
pub type R = crate::R<Eefbr2Spec>;
#[doc = "Register `EEFBR2` writer"]
pub type W = crate::W<Eefbr2Spec>;
...
impl W {
    #[doc = "Bit 0 - External Event 6 latch"]
    #[inline(always)]
    pub fn ee6ltch(&mut self) -> Ee6ltchW<Eefbr2Spec> {
        Ee6ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 6 filter"]
    #[inline(always)]
    pub fn ee6fltr(&mut self) -> Ee6fltrW<Eefbr2Spec> {
        Ee6fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 7 latch"]
    #[inline(always)]
    pub fn ee7ltch(&mut self) -> Ee7ltchW<Eefbr2Spec> {
        Ee7ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 7 filter"]
    #[inline(always)]
    pub fn ee7fltr(&mut self) -> Ee7fltrW<Eefbr2Spec> {
        Ee7fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 8 latch"]
    #[inline(always)]
    pub fn ee8ltch(&mut self) -> Ee8ltchW<Eefbr2Spec> {
        Ee8ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 8 filter"]
    #[inline(always)]
    pub fn ee8fltr(&mut self) -> Ee8fltrW<Eefbr2Spec> {
        Ee8fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 9 latch"]
    #[inline(always)]
    pub fn ee9ltch(&mut self) -> Ee9ltchW<Eefbr2Spec> {
        Ee9ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 9 filter"]
    #[inline(always)]
    pub fn ee9fltr(&mut self) -> Ee9fltrW<Eefbr2Spec> {
        Ee9fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 10 latch"]
    #[inline(always)]
    pub fn ee10ltch(&mut self) -> Ee10ltchW<Eefbr2Spec> {
        Ee10ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 10 filter"]
    #[inline(always)]
    pub fn ee10fltr(&mut self) -> Ee10fltrW<Eefbr2Spec> {
        Ee10fltrW::new(self, 25)
    }
}
#[doc = "Timerx External Event Filtering Register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`eefbr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eefbr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eefbr2Spec;
impl crate::RegisterSpec for Eefbr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eefbr2::R`](R) reader structure"]
impl crate::Readable for Eefbr2Spec {}
#[doc = "`write(|w| ..)` method takes [`eefbr2::W`](W) writer structure"]
impl crate::Writable for Eefbr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EEFBR2 to value 0"]
impl crate::Resettable for Eefbr2Spec {}

...
pub type W = crate::W<TimdicrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn cmp1c(&mut self) -> Cmp1cW<TimdicrSpec> {
        Cmp1cW::new(self, 0)
    }
    #[doc = "Bit 1 - Compare 2 Interrupt flag Clear"]
    #[inline(always)]
    pub fn cmp2c(&mut self) -> Cmp2cW<TimdicrSpec> {
        Cmp2cW::new(self, 1)
    }
    #[doc = "Bit 2 - Compare 3 Interrupt flag Clear"]
    #[inline(always)]
    pub fn cmp3c(&mut self) -> Cmp3cW<TimdicrSpec> {
        Cmp3cW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare 4 Interrupt flag Clear"]
    #[inline(always)]
    pub fn cmp4c(&mut self) -> Cmp4cW<TimdicrSpec> {
        Cmp4cW::new(self, 3)
    }
    #[doc = "Bit 4 - Repetition Interrupt flag Clear"]
    #[inline(always)]
    pub fn repc(&mut self) -> RepcW<TimdicrSpec> {
        RepcW::new(self, 4)
    }
    #[doc = "Bit 6 - Update Interrupt flag Clear"]
    #[inline(always)]
    pub fn updc(&mut self) -> UpdcW<TimdicrSpec> {
        UpdcW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture1 Interrupt flag Clear"]
    #[inline(always)]
    pub fn cpt1c(&mut self) -> Cpt1cW<TimdicrSpec> {
        Cpt1cW::new(self, 7)
    }
    #[doc = "Bit 8 - Capture2 Interrupt flag Clear"]
    #[inline(always)]
    pub fn cpt2c(&mut self) -> Cpt2cW<TimdicrSpec> {
        Cpt2cW::new(self, 8)
    }
    #[doc = "Bit 9 - Output 1 Set flag Clear"]
    #[inline(always)]
    pub fn set1x_c(&mut self) -> Set1xCW<TimdicrSpec> {
        Set1xCW::new(self, 9)
    }
    #[doc = "Bit 10 - Output 1 Reset flag Clear"]
    #[inline(always)]
    pub fn rstx1c(&mut self) -> Rstx1cW<TimdicrSpec> {
        Rstx1cW::new(self, 10)
    }
    #[doc = "Bit 11 - Output 2 Set flag Clear"]
    #[inline(always)]
    pub fn set2x_c(&mut self) -> Set2xCW<TimdicrSpec> {
        Set2xCW::new(self, 11)
    }
    #[doc = "Bit 12 - Output 2 Reset flag Clear"]
    #[inline(always)]
    pub fn rstx2c(&mut self) -> Rstx2cW<TimdicrSpec> {
        Rstx2cW::new(self, 12)
    }
    #[doc = "Bit 13 - Reset Interrupt flag Clear"]
    #[inline(always)]
    pub fn rstc(&mut self) -> RstcW<TimdicrSpec> {
        RstcW::new(self, 13)
    }
    #[doc = "Bit 14 - Delayed Protection Flag Clear"]
    #[inline(always)]
    pub fn dlyprtc(&mut self) -> DlyprtcW<TimdicrSpec> {
...
pub struct TimdicrSpec;
impl crate::RegisterSpec for TimdicrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timdicr::W`](W) writer structure"]
impl crate::Writable for TimdicrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMDICR to value 0"]
impl crate::Resettable for TimdicrSpec {}

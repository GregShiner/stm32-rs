...
pub type R = crate::R<TimdcrSpec>;
#[doc = "Register `TIMDCR` writer"]
pub type W = crate::W<TimdcrSpec>;
...
impl W {
    #[doc = "Bits 0:2 - HRTIM Timer x Clock prescaler"]
    #[inline(always)]
    pub fn ck_pscx(&mut self) -> CkPscxW<TimdcrSpec> {
        CkPscxW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    pub fn cont(&mut self) -> ContW<TimdcrSpec> {
        ContW::new(self, 3)
    }
    #[doc = "Bit 4 - Re-triggerable mode"]
    #[inline(always)]
    pub fn retrig(&mut self) -> RetrigW<TimdcrSpec> {
        RetrigW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode enable"]
    #[inline(always)]
    pub fn half(&mut self) -> HalfW<TimdcrSpec> {
        HalfW::new(self, 5)
    }
    #[doc = "Bit 6 - Push-Pull mode enable"]
    #[inline(always)]
    pub fn pshpll(&mut self) -> PshpllW<TimdcrSpec> {
        PshpllW::new(self, 6)
    }
    #[doc = "Bit 10 - Synchronization Resets Timer x"]
    #[inline(always)]
    pub fn syncrstx(&mut self) -> SyncrstxW<TimdcrSpec> {
        SyncrstxW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization Starts Timer x"]
    #[inline(always)]
    pub fn syncstrtx(&mut self) -> SyncstrtxW<TimdcrSpec> {
        SyncstrtxW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Delayed CMP2 mode"]
    #[inline(always)]
    pub fn delcmp2(&mut self) -> Delcmp2W<TimdcrSpec> {
        Delcmp2W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Delayed CMP4 mode"]
    #[inline(always)]
    pub fn delcmp4(&mut self) -> Delcmp4W<TimdcrSpec> {
        Delcmp4W::new(self, 14)
    }
    #[doc = "Bit 17 - Timer x Repetition update"]
    #[inline(always)]
    pub fn tx_repu(&mut self) -> TxRepuW<TimdcrSpec> {
        TxRepuW::new(self, 17)
    }
    #[doc = "Bit 18 - Timerx reset update"]
    #[inline(always)]
    pub fn tx_rstu(&mut self) -> TxRstuW<TimdcrSpec> {
        TxRstuW::new(self, 18)
    }
    #[doc = "Bit 20 - TBU"]
    #[inline(always)]
    pub fn tbu(&mut self) -> TbuW<TimdcrSpec> {
        TbuW::new(self, 20)
    }
    #[doc = "Bit 21 - TCU"]
    #[inline(always)]
    pub fn tcu(&mut self) -> TcuW<TimdcrSpec> {
        TcuW::new(self, 21)
    }
    #[doc = "Bit 22 - TDU"]
    #[inline(always)]
    pub fn tdu(&mut self) -> TduW<TimdcrSpec> {
        TduW::new(self, 22)
    }
    #[doc = "Bit 23 - TEU"]
    #[inline(always)]
    pub fn teu(&mut self) -> TeuW<TimdcrSpec> {
        TeuW::new(self, 23)
    }
    #[doc = "Bit 24 - Master Timer update"]
    #[inline(always)]
    pub fn mstu(&mut self) -> MstuW<TimdcrSpec> {
        MstuW::new(self, 24)
    }
    #[doc = "Bits 25:26 - AC Synchronization"]
    #[inline(always)]
    pub fn dacsync(&mut self) -> DacsyncW<TimdcrSpec> {
        DacsyncW::new(self, 25)
    }
    #[doc = "Bit 27 - Preload enable"]
    #[inline(always)]
    pub fn preen(&mut self) -> PreenW<TimdcrSpec> {
        PreenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update Gating"]
    #[inline(always)]
    pub fn updgat(&mut self) -> UpdgatW<TimdcrSpec> {
        UpdgatW::new(self, 28)
    }
}
#[doc = "Timerx Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timdcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timdcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TimdcrSpec;
impl crate::RegisterSpec for TimdcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timdcr::R`](R) reader structure"]
impl crate::Readable for TimdcrSpec {}
#[doc = "`write(|w| ..)` method takes [`timdcr::W`](W) writer structure"]
impl crate::Writable for TimdcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMDCR to value 0"]
impl crate::Resettable for TimdcrSpec {}

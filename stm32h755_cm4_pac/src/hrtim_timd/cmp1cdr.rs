...
pub type R = crate::R<Cmp1cdrSpec>;
#[doc = "Register `CMP1CDR` writer"]
pub type W = crate::W<Cmp1cdrSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Timerx Compare 1 value"]
    #[inline(always)]
    pub fn cmp1x(&mut self) -> Cmp1xW<Cmp1cdrSpec> {
        Cmp1xW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Timerx Repetition value (aliased from HRTIM_REPx register)"]
    #[inline(always)]
    pub fn repx(&mut self) -> RepxW<Cmp1cdrSpec> {
        RepxW::new(self, 16)
    }
}
#[doc = "Timerx Compare 1 Compound Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmp1cdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmp1cdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmp1cdrSpec;
impl crate::RegisterSpec for Cmp1cdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1cdr::R`](R) reader structure"]
impl crate::Readable for Cmp1cdrSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1cdr::W`](W) writer structure"]
impl crate::Writable for Cmp1cdrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CMP1CDR to value 0"]
impl crate::Resettable for Cmp1cdrSpec {}

...
pub type R = crate::R<FltdrSpec>;
#[doc = "Register `FLTDR` writer"]
pub type W = crate::W<FltdrSpec>;
...
impl W {
    #[doc = "Bit 0 - Fault 1 enable"]
    #[inline(always)]
    pub fn flt1en(&mut self) -> Flt1enW<FltdrSpec> {
        Flt1enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 2 enable"]
    #[inline(always)]
    pub fn flt2en(&mut self) -> Flt2enW<FltdrSpec> {
        Flt2enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 3 enable"]
    #[inline(always)]
    pub fn flt3en(&mut self) -> Flt3enW<FltdrSpec> {
        Flt3enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 4 enable"]
    #[inline(always)]
    pub fn flt4en(&mut self) -> Flt4enW<FltdrSpec> {
        Flt4enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 5 enable"]
    #[inline(always)]
    pub fn flt5en(&mut self) -> Flt5enW<FltdrSpec> {
        Flt5enW::new(self, 4)
    }
    #[doc = "Bit 31 - Fault sources Lock"]
    #[inline(always)]
    pub fn fltlck(&mut self) -> FltlckW<FltdrSpec> {
        FltlckW::new(self, 31)
    }
}
...
pub struct FltdrSpec;
impl crate::RegisterSpec for FltdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fltdr::R`](R) reader structure"]
impl crate::Readable for FltdrSpec {}
#[doc = "`write(|w| ..)` method takes [`fltdr::W`](W) writer structure"]
impl crate::Writable for FltdrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLTDR to value 0"]
impl crate::Resettable for FltdrSpec {}

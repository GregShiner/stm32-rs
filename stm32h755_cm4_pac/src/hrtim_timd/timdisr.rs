...
pub type R = crate::R<TimdisrSpec>;
...
#[doc = "Timerx Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timdisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TimdisrSpec;
impl crate::RegisterSpec for TimdisrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timdisr::R`](R) reader structure"]
impl crate::Readable for TimdisrSpec {}
#[doc = "`reset()` method sets TIMDISR to value 0"]
impl crate::Resettable for TimdisrSpec {}

...
impl W {
    #[doc = "Bit 0 - COMP channel 1 enable bit"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Cfgr2Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Scaler bridge enable"]
    #[inline(always)]
    pub fn brgen(&mut self) -> BrgenW<Cfgr2Spec> {
        BrgenW::new(self, 1)
    }
    #[doc = "Bit 2 - Voltage scaler enable bit"]
    #[inline(always)]
    pub fn scalen(&mut self) -> ScalenW<Cfgr2Spec> {
        ScalenW::new(self, 2)
    }
    #[doc = "Bit 3 - COMP channel 1 polarity selection bit"]
    #[inline(always)]
    pub fn polarity(&mut self) -> PolarityW<Cfgr2Spec> {
        PolarityW::new(self, 3)
    }
    #[doc = "Bit 4 - Window comparator mode selection bit"]
    #[inline(always)]
    pub fn winmode(&mut self) -> WinmodeW<Cfgr2Spec> {
        WinmodeW::new(self, 4)
    }
    #[doc = "Bit 6 - COMP channel 1 interrupt enable"]
    #[inline(always)]
    pub fn iten(&mut self) -> ItenW<Cfgr2Spec> {
        ItenW::new(self, 6)
    }
    #[doc = "Bits 8:9 - COMP channel 1 hysteresis selection bits"]
    #[inline(always)]
    pub fn hyst(&mut self) -> HystW<Cfgr2Spec> {
        HystW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Power Mode of the COMP channel 1"]
    #[inline(always)]
    pub fn pwrmode(&mut self) -> PwrmodeW<Cfgr2Spec> {
        PwrmodeW::new(self, 12)
    }
    #[doc = "Bits 16:18 - COMP channel 1 inverting input selection field"]
    #[inline(always)]
    pub fn inmsel(&mut self) -> InmselW<Cfgr2Spec> {
        InmselW::new(self, 16)
    }
    #[doc = "Bit 20 - COMP channel 1 non-inverting input selection bit"]
    #[inline(always)]
    pub fn inpsel(&mut self) -> InpselW<Cfgr2Spec> {
        InpselW::new(self, 20)
    }
    #[doc = "Bits 24:27 - COMP channel 1 blanking source selection bits"]
    #[inline(always)]
    pub fn blanking(&mut self) -> BlankingW<Cfgr2Spec> {
        BlankingW::new(self, 24)
    }
    #[doc = "Bit 31 - Lock bit"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<Cfgr2Spec> {
        LockW::new(self, 31)
    }
}
